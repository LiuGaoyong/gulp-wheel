program main
!
!  This is a simple program that illustrates the calling of GULP as an energy/gradient engine in parallel
!
...
!  Get processor ID
!
  call MPI_comm_rank(MPI_comm_world,iprocid,ierr)
  lprocio = (iprocid.eq.0)
!
!  Initialise MPI communicator for GULP based on global one
!
  call init_gulp_mpi(MPI_comm_world)
!
!  Control parameters
!
