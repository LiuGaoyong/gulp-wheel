  subroutine reaxFF_bomd(i,j,nspeci,nspecj,ni,nj,deltapi,deltapj,mneigh,nneigh,BOp,BOp_pi,BOp_pipi, &
                         d1BOp,d1BOp_pi,d1BOp_pipi,BOij_s,BOij_pi,BOij_pipi,d1BOi_s,d1BOi_pi,d1BOi_pipi,lgrad1)
!
...
!
!   4/23 Created from reaxff_bo after sparsity change
!
!  Conditions of use:
!
