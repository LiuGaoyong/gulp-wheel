...
!  12/19 Separate time for site potentials added
!   3/20 Polarisation time output added
!   7/20 Time for diagonalisation output
!   8/21 Bond valence added
!  12/21 pGFNFF modifications added
!   5/23 Time for EHT added
!
!  Conditions of use:
!
...
!***************************
  ...
  if (tval.gt.1d-4) then
    write(ioout,'(''  Calculation of Valence Bond energy and derivatives    '',f16.4)') tval
  endif
  if (tgfnffsetup.gt.1d-4) then
    write(ioout,'(''  Generation of GFNFF parameters                        '',f16.4)') tgfnffsetup
  endif
  if (tgfnff.gt.1d-4) then
    write(ioout,'(''  Calculation of GFNFF energy and derivatives           '',f16.4)') tgfnff
  endif
  if (tpolar.gt.1d-4) then
    write(ioout,'(''  Calculation of polarisation energy and derivatives    '',f16.4)') tpolar
  endif
  ...
  if (tspot.gt.1d-4) then
    write(ioout,'(''  Calculation of site potentials                        '',f16.4)') tspot
  endif
  ...
  if (tdiag.gt.1d-4) then
    write(ioout,'(''  Calculation of matrix diagonalisation                 '',f16.4)') tdiag
  endif
  ...
  if (teht.gt.1d-4) then
    write(ioout,'(''  Extended Huckel Theory charge calculation             '',f16.4)') teht
  endif
  if (td2charge.gt.1d-4) then
    write(ioout,'(''  Calculation of variable charge 2nd derivatives        '',f16.4)') td2charge
  endif
