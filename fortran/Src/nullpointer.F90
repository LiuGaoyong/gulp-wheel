...
!   9/18 Particle energies added for OpenKIM
!   9/18 rpds renamed and d2r2ds2, d2r2dx2 and d2r2dsdx added
...
!   5/19 Extra strain derivatives added
!   6/19 Spin added
...
!   9/19 ReaxFF charge arrays added
!  10/19 nmola2f added
...
!   4/20 derv3c and d2r2dsdc added
...
!  12/20 nmolconnect and nmolconnectptr added
...
!
    ...
    nullify(lopf)
    nullify(rmode)
    nullify(aaclp_b_spec)
    nullify(aaclp_h_spec)
    nullify(aaclp_ip_spec)
    nullify(aaclp_pol_spec)
    nullify(natpolspec)
    nullify(ntyppolspec)
    nullify(noptatptr)
    nullify(noptatrptr)
...
!
!  Rigid molecule restart info
!
    nullify(molcomcfg)
    nullify(molQcfg)
    nullify(molQxyzcfg)
!
!  GFNFF related arrays
!
