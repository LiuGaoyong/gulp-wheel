...
!   1/22 Phase removed from E and H terms as they are only used at gamma
...
!**********************************
            if (lDoQDeriv2) then
              ...
              d1jy    = d1j*y
              d1jz    = d1j*z
              call d2chargepd(iloc,i,j,1_i4,ix,iy,iz,jx,jy,jz,xkv,0.0_dp,0.0_dp,d0i,d0j,d1ix,d1iy,d1iz, &
...
!  m > 0
!
          call d2chargepd(iloc,i,i,1_i4,ix,iy,iz,ix,iy,iz,xkv,0.0_dp,0.0_dp,d0i,d0i,d1ix,0.0_dp,0.0_dp, &
