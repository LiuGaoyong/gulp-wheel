...
!
        call d1addfc(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,maxlhs,d1cell,matom,nREBOatomRptr, &
                     d1j,.true.,.false.)
!
...
!
    call d1addfc(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,maxlhs,d1cell,matom,nREBOatomRptr, &
                 d1i,.true.,.false.)
  enddo
!
!  Free local memory
