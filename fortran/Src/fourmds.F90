  subroutine fourmds(efor,eoop,eimp,esregion12,esregion2,eattach,lgrad1)
!
...
!
                                  ...
                                  if (lmolok) then
                                    if (ndim.eq.0) then
                                      ...
                                      klcx = lcx - kcx + icosxsp(l) - icosxsp(k)
                                      klcy = lcy - kcy + icosysp(l) - icosysp(k)
                                      klcz = lcz - kcz + icoszsp(l) - icoszsp(k)
!
                                      if (lbtyp) then
...
!  Improper potentials  *
!************************
  if (nimproper.gt.0) call fourimpmds(eimp,esregion12limp,esregion2limp,eattach,lgrad1,xderv,yderv,zderv,rstrd)
!   
...
!   
  if (lmarvreg2) then
    ...
    esregion2 = esregion2 + esregion2l + esregion2loop + esregion2limp
  endif
!
