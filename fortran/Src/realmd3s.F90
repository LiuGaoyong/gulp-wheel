...
!   3/21 Calls qeqbody/smbody replaced with corresponding calls to 1 version
...
!*************************************************
                    ...
                    call twobody1(eatom2,ereal2,ec62,lgrad1p,.false.,.false.,1_i4,1_i4,dist,xji,yji,zji, &
                                  ...
                                  rtrm2,rtrm3,rtrm32,sctrm1,sctrm2,qli,qlj,nspeci,nspecj,lcspair,lewaldtype, &
                                  .false.,lbonded,l2bonds,l3bonds,nbtypeij,nbtypeij2,.false.,lQMMMelectro, &
...
!
                    ...
                    if (leem.or.lgfnff) then
                      eqeq2 = 0.0_dp
                      if (lqeq) then
                        call qeqbody1(eqeq,lgrad1,.false.,1_i4,1_i4,dist,deriv, &
                          deriv2,fct,qli,qlj,nati,natj,nqri,nqrj,d1i,d1j,d2i2,d2ij,d2j2)
                      elseif (lSandM) then
                        call smbody1(eqeq,lgrad1,.false.,1_i4,1_i4,dist,deriv, &
                          deriv2,fct,qli,qlj,nati,natj,nqri,nqrj,d1i,d1j,d2i2,d2ij,d2j2)
                      elseif (lgfnff) then
                        zetaij = 1.0_dp/sqrt(gfnff_eeq_alp(i)+gfnff_eeq_alp(j))
                        call gfnffbody1(eqeq,zetaij,lgrad1,.false.,1_i4,1_i4,dist,deriv,deriv2, &
