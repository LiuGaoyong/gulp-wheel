  subroutine rsearch1D(xcrd,ycrd,zcrd,lmolok,lcspair,i,j,nmi,ixj,iyj,izj,nor,nmolonly,lself,cut2,cut2e)
!
...
!  cut2e   = cut-off distance squared for electrostatics for this pair of atoms
!
!  On exit :
!
