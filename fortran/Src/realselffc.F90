...
!
  ...
  if (status/=0) call outofmemory('realselffc','npotl')
!
  if (.not.lnoreal) then
!***************************************************************
...
!
  ...
  if (status/=0) call deallocate_error('realselffc','npotl')
!
!  Timing
!
  time2 = g_cpu_time()
