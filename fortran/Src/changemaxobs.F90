...
!
  ...
  call realloc(finfo,maxobs,ierror)
  if (ierror.ne.0) call outofmemory('changemaxobs','finfo')
  ...
  call realloc(nobstyle,maxobs,ierror)
  if (ierror.ne.0) call outofmemory('changemaxobs','nobstyle')
