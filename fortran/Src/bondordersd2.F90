...
!   7/21 Correction to parallel call - lilocal added
...
!
    if (lgrad1) then
      ...
      if (lgrad2) then
        call d2adds(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nfreeatomau,nboatomRptr,nauatom, &
                    neqv,d1i,d2i,.false.)
      endif
    endif
  enddo
