...
!  Species data
!
  call realloc_ch(16_i4,symspec,maxspec,ierror)
  ...
  call realloc(lspininspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','lspininspec')
  ...
  call realloc(ltibqspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','ltibqspec')
  call realloc(ltifqspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','ltifqspec')
  ...
  call realloc(spinspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','spinspec')
  call realloc(vdwspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','vdwspec')
!
!  Library data
!
  call realloc_ch(16_i4,libspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','libspec')
  call realloc_ch(16_i4,lib2ndspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','lib2ndspec')
  call realloc(llib2ndspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','llib2ndspec')
!
!  GCMC related data
!
...
!  Polarisability data
!
  call realloc(dpolmaxspec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','dpolmaxspec')
...
!
!  AA-CLP force field data
!
  call realloc(aaclp_b_spec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','aaclp_b_spec')
  call realloc(aaclp_h_spec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','aaclp_h_spec')
  call realloc(aaclp_ip_spec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','aaclp_ip_spec')
  call realloc(aaclp_pol_spec,maxspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxspec','aaclp_pol_spec')
!
