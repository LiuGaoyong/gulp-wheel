...
!   8/18 Allocations for KIM modified
!   9/18 Change for multiple OpenKIM models
...
!  12/21 pGFNFF modificiations added
...
!
  ...
  use ksample
  use moldyn
  use molecule,       only : maxmol, nmolcfg, nmolatomcfg, nmolatomtotcfg, nmollistcfg
  use molecule,       only : nmolcorecfg
  use molecule,       only : molQcfg, molcomcfg, molQxyzcfg
  use m_pr
...
!
  ...
  call realloc(dielectriccfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','dielectriccfg')
  ...
  call realloc_ch(1_i4,hmssg,16_i4,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','hmssg')
  call realloc_ch(1_i4,hmssgio,16_i4,maxcfg,ierror)
  ...
  call realloc(lkptgammaonlycfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lkptgammaonlycfg')
  call realloc(lksorigin,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lksorigin')
  ...
  call realloc(lpotsitecartcfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lpotsitecartcfg')
  ...
  call realloc(lsumcoreshell,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lsumcoreshell')
  ...
  call realloc(lvecpin,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lvecpin')
  ...
  if (ierror.ne.0) call outofmemory('changemaxcfg','molcomcfg')
  call realloc(molQcfg,3_i4,maxmol,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','molQcfg')
  call realloc(molQxyzcfg,3_i4,maxat,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','molQxyzcfg')
  ...
  call realloc(nmolcfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','nmolcfg')
  call realloc(nmolatomcfg,maxmol,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','nmolatomcfg')
  call realloc(nmolatomtotcfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','nmolatomtotcfg')
  call realloc(nmolcorecfg,maxmol,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','nmolcorecfg')
  call realloc(nmollistcfg,maxat,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','nmollistcfg')
  ...
  call realloc_ch(maxwordlength,names,maxcfg,ierror)
  ...
  call realloc(npotsitescfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','npotsitescfg')
  ...
  call realloc(ntempramp,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','ntempramp')
  ...
  call realloc(ordersuper,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','ordersuper')
...
!
  call realloc(lshearforcecfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lshearforcecfg')
  call realloc(shearforcecfg,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','shearforcecfg')
  call realloc(shearforcedircfg,3_i4,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','shearforcedircfg')
  call realloc(shearforcenormcfg,3_i4,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','shearforcenormcfg')
!
...
!
!  GFNFF reference arrays
!
  call realloc(gfnff_ref_crd,3_i4,maxat,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','gfnff_ref_crd')
  call realloc(gfnff_ref_q,maxat,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','gfnff_ref_q')
  call realloc(gfnff_ref_rv,3_i4,3_i4,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','gfnff_ref_rv')
  call realloc(lgfnff_ref_crd,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','lgfnff_ref_crd')
  call realloc(lgfnff_ref_rv,maxcfg,ierror)
