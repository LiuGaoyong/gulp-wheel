...
!
              ...
              elseif (nBOtapertype(npki).eq.3) then
                call murtytaper(rik,rBOmin(npki),rBOmax(npki),fik,dfikdr,d2fikdr2,d3fikdr3,.true.,.false.,.false.)
              else
...
!
    call d2addfc(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,nboatomRptr,d1i,d2i,.false.)
  enddo
  if (nboZ.gt.0) then
!
