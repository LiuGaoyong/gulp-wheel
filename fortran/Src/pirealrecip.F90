...
!   4/19 Polarisation check added before skipping pair
!   4/19 Handling of lnoreal and lnorecip added
!   5/19 Use of strain module added
!   7/19 dpolar now referenced to allow for symmetry
...
!   3/20 Use of charge pointer added for j loop
...
!   6/23 Referencing of nspecptr corrected to use asymmetric unit
...
!
  ...
  if (lgrad2) then
    ...
    if (status/=0) call outofmemory('pirealrecip','ld2ok')
    allocate(d2a(3,3,numat),stat=status)
    if (status/=0) call outofmemory('pirealrecip','d2a')
    if (lstr) then
      allocate(d2as(3,nstrains,numat),stat=status)
      if (status/=0) call outofmemory('pirealrecip','d2as')
    endif
  endif
!
...
!
    if (dpolar(nrelf2a(i)).eq.0.0_dp) cycle iloop
!
...
!
!  Start of second atom loop over sites with a charge
!
...
!
      if (abs(poli).lt.1.0d-12) cycle jloop
!***********************
!  Find valid vectors  *
!***********************
      if (ndim.eq.3) then
        call rsearch3D(xcrd,ycrd,zcrd,lmolok,lcspair,i,j,nmi,ixj,iyj,izj,nor,nmolonly,lself,cut2,cut2q)
      elseif (ndim.eq.2) then
        call rsearch2D(xcrd,ycrd,zcrd,lmolok,lcspair,i,j,nmi,ixj,iyj,izj,nor,nmolonly,lself,cut2,cut2q)
      elseif (ndim.eq.1) then
        call rsearch1D(xcrd,ycrd,zcrd,lmolok,lcspair,i,j,nmi,ixj,iyj,izj,nor,nmolonly,lself,cut2,cut2q)
      endif
...
!
        call twobody(eatom,ereal,ec6,.true.,.true.,lgrad2,nor,1,npots,npotl,cut2,cut2q,cut2s, &
                     nmolonly,factor,ofct,ospfct,0.0_dp,sctrm1,sctrm2,qli,qlj,nspeci,nspecj, &
...
!
        if (lopi.and.lopj) then
          if (j.lt.i) then
            ...
            derv2(ix,jx) = derv2(ix,jx) - poli*(vxi*d3(1,1,1) + vyi*d3(1,1,2) + vzi*d3(1,1,3) - &
                                                qlj*(d2(1,1)*d2(1,1) + d2(1,2)*d2(1,2) + d2(1,3)*d2(1,3)))
            derv2(iy,jx) = derv2(iy,jx) - poli*(vxi*d3(2,1,1) + vyi*d3(2,1,2) + vzi*d3(2,1,3) - &
                                                qlj*(d2(2,1)*d2(1,1) + d2(2,2)*d2(1,2) + d2(2,3)*d2(1,3)))
            derv2(iz,jx) = derv2(iz,jx) - poli*(vxi*d3(3,1,1) + vyi*d3(3,1,2) + vzi*d3(3,1,3) - &
                                                qlj*(d2(3,1)*d2(1,1) + d2(3,2)*d2(1,2) + d2(3,3)*d2(1,3)))
            derv2(ix,jy) = derv2(ix,jy) - poli*(vxi*d3(1,2,1) + vyi*d3(1,2,2) + vzi*d3(1,2,3) - &
                                                qlj*(d2(1,1)*d2(2,1) + d2(1,2)*d2(2,2) + d2(1,3)*d2(2,3)))
            derv2(iy,jy) = derv2(iy,jy) - poli*(vxi*d3(2,2,1) + vyi*d3(2,2,2) + vzi*d3(2,2,3) - &
                                                qlj*(d2(2,1)*d2(2,1) + d2(2,2)*d2(2,2) + d2(2,3)*d2(2,3)))
            derv2(iz,jy) = derv2(iz,jy) - poli*(vxi*d3(3,2,1) + vyi*d3(3,2,2) + vzi*d3(3,2,3) - &
                                                qlj*(d2(3,1)*d2(2,1) + d2(3,2)*d2(2,2) + d2(3,3)*d2(2,3)))
            derv2(ix,jz) = derv2(ix,jz) - poli*(vxi*d3(1,3,1) + vyi*d3(1,3,2) + vzi*d3(1,3,3) - &
                                                qlj*(d2(1,1)*d2(3,1) + d2(1,2)*d2(3,2) + d2(1,3)*d2(3,3)))
            derv2(iy,jz) = derv2(iy,jz) - poli*(vxi*d3(2,3,1) + vyi*d3(2,3,2) + vzi*d3(2,3,3) - &
                                                qlj*(d2(2,1)*d2(3,1) + d2(2,2)*d2(3,2) + d2(2,3)*d2(3,3)))
            derv2(iz,jz) = derv2(iz,jz) - poli*(vxi*d3(3,3,1) + vyi*d3(3,3,2) + vzi*d3(3,3,3) - &
                                                qlj*(d2(3,1)*d2(3,1) + d2(3,2)*d2(3,2) + d2(3,3)*d2(3,3)))
            if (lpollangevin) then
              derv2(ix,jx) = derv2(ix,jx) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                  (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
              derv2(iy,jx) = derv2(iy,jx) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                  (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
              derv2(iz,jx) = derv2(iz,jx) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                  (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
              derv2(ix,jy) = derv2(ix,jy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                  (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
              derv2(iy,jy) = derv2(iy,jy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                  (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
              derv2(iz,jy) = derv2(iz,jy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                  (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
              derv2(ix,jz) = derv2(ix,jz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                  (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
              derv2(iy,jz) = derv2(iy,jz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                  (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
              derv2(iz,jz) = derv2(iz,jz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                  (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
            endif
          endif
        elseif (lopi) then
          derv2(ix,ix) = derv2(ix,ix) - poli*(vxi*d3(1,1,1) + vyi*d3(1,1,2) + vzi*d3(1,1,3) + &
                                              qlj*(d2(1,1)*d2(1,1) + d2(1,2)*d2(1,2) + d2(1,3)*d2(1,3)))
          derv2(iy,ix) = derv2(iy,ix) - poli*(vxi*d3(2,1,1) + vyi*d3(2,1,2) + vzi*d3(2,1,3) + &
                                              qlj*(d2(2,1)*d2(1,1) + d2(2,2)*d2(1,2) + d2(2,3)*d2(1,3)))
          derv2(iz,ix) = derv2(iz,ix) - poli*(vxi*d3(3,1,1) + vyi*d3(3,1,2) + vzi*d3(3,1,3) + &
                                              qlj*(d2(3,1)*d2(1,1) + d2(3,2)*d2(1,2) + d2(3,3)*d2(1,3)))
          derv2(ix,iy) = derv2(ix,iy) - poli*(vxi*d3(1,2,1) + vyi*d3(1,2,2) + vzi*d3(1,2,3) + &
                                              qlj*(d2(1,1)*d2(2,1) + d2(1,2)*d2(2,2) + d2(1,3)*d2(2,3)))
          derv2(iy,iy) = derv2(iy,iy) - poli*(vxi*d3(2,2,1) + vyi*d3(2,2,2) + vzi*d3(2,2,3) + &
                                              qlj*(d2(2,1)*d2(2,1) + d2(2,2)*d2(2,2) + d2(2,3)*d2(2,3)))
          derv2(iz,iy) = derv2(iz,iy) - poli*(vxi*d3(3,2,1) + vyi*d3(3,2,2) + vzi*d3(3,2,3) + &
                                              qlj*(d2(3,1)*d2(2,1) + d2(3,2)*d2(2,2) + d2(3,3)*d2(2,3)))
          derv2(ix,iz) = derv2(ix,iz) - poli*(vxi*d3(1,3,1) + vyi*d3(1,3,2) + vzi*d3(1,3,3) + &
                                              qlj*(d2(1,1)*d2(3,1) + d2(1,2)*d2(3,2) + d2(1,3)*d2(3,3)))
          derv2(iy,iz) = derv2(iy,iz) - poli*(vxi*d3(2,3,1) + vyi*d3(2,3,2) + vzi*d3(2,3,3) + &
                                              qlj*(d2(2,1)*d2(3,1) + d2(2,2)*d2(3,2) + d2(2,3)*d2(3,3)))
          derv2(iz,iz) = derv2(iz,iz) - poli*(vxi*d3(3,3,1) + vyi*d3(3,3,2) + vzi*d3(3,3,3) + &
                                              qlj*(d2(3,1)*d2(3,1) + d2(3,2)*d2(3,2) + d2(3,3)*d2(3,3)))
          if (lpollangevin) then
            derv2(ix,ix) = derv2(ix,ix) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
            derv2(iy,ix) = derv2(iy,ix) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
            derv2(iz,ix) = derv2(iz,ix) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
            derv2(ix,iy) = derv2(ix,iy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
            derv2(iy,iy) = derv2(iy,iy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
            derv2(iz,iy) = derv2(iz,iy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
            derv2(ix,iz) = derv2(ix,iz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
            derv2(iy,iz) = derv2(iy,iz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
            derv2(iz,iz) = derv2(iz,iz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
          endif
        elseif (lopj) then
          derv2(jx,jx) = derv2(jx,jx) - poli*(vxi*d3(1,1,1) + vyi*d3(1,1,2) + vzi*d3(1,1,3) + &
                                              qlj*(d2(1,1)*d2(1,1) + d2(1,2)*d2(1,2) + d2(1,3)*d2(1,3)))
          derv2(jy,jx) = derv2(jy,jx) - poli*(vxi*d3(2,1,1) + vyi*d3(2,1,2) + vzi*d3(2,1,3) + &
                                              qlj*(d2(2,1)*d2(1,1) + d2(2,2)*d2(1,2) + d2(2,3)*d2(1,3)))
          derv2(jz,jx) = derv2(jz,jx) - poli*(vxi*d3(3,1,1) + vyi*d3(3,1,2) + vzi*d3(3,1,3) + &
                                              qlj*(d2(3,1)*d2(1,1) + d2(3,2)*d2(1,2) + d2(3,3)*d2(1,3)))
          derv2(jx,jy) = derv2(jx,jy) - poli*(vxi*d3(1,2,1) + vyi*d3(1,2,2) + vzi*d3(1,2,3) + &
                                              qlj*(d2(1,1)*d2(2,1) + d2(1,2)*d2(2,2) + d2(1,3)*d2(2,3)))
          derv2(jy,jy) = derv2(jy,jy) - poli*(vxi*d3(2,2,1) + vyi*d3(2,2,2) + vzi*d3(2,2,3) + &
                                              qlj*(d2(2,1)*d2(2,1) + d2(2,2)*d2(2,2) + d2(2,3)*d2(2,3)))
          derv2(jz,jy) = derv2(jz,jy) - poli*(vxi*d3(3,2,1) + vyi*d3(3,2,2) + vzi*d3(3,2,3) + &
                                              qlj*(d2(3,1)*d2(2,1) + d2(3,2)*d2(2,2) + d2(3,3)*d2(2,3)))
          derv2(jx,jz) = derv2(jx,jz) - poli*(vxi*d3(1,3,1) + vyi*d3(1,3,2) + vzi*d3(1,3,3) + &
                                              qlj*(d2(1,1)*d2(3,1) + d2(1,2)*d2(3,2) + d2(1,3)*d2(3,3)))
          derv2(jy,jz) = derv2(jy,jz) - poli*(vxi*d3(2,3,1) + vyi*d3(2,3,2) + vzi*d3(2,3,3) + &
                                              qlj*(d2(2,1)*d2(3,1) + d2(2,2)*d2(3,2) + d2(2,3)*d2(3,3)))
          derv2(jz,jz) = derv2(jz,jz) - poli*(vxi*d3(3,3,1) + vyi*d3(3,3,2) + vzi*d3(3,3,3) + &
                                              qlj*(d2(3,1)*d2(3,1) + d2(3,2)*d2(3,2) + d2(3,3)*d2(3,3)))
          if (lpollangevin) then
            derv2(jx,jx) = derv2(jx,jx) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
            derv2(jy,jx) = derv2(jy,jx) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
            derv2(jz,jx) = derv2(jz,jx) + pol2i*(vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))* &
                                                (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
            derv2(jx,jy) = derv2(jx,jy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
            derv2(jy,jy) = derv2(jy,jy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
            derv2(jz,jy) = derv2(jz,jy) + pol2i*(vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))* &
                                                (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
            derv2(jx,jz) = derv2(jx,jz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                (vxi*d2(1,1) + vyi*d2(2,1) + vzi*d2(3,1))
            derv2(jy,jz) = derv2(jy,jz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                (vxi*d2(1,2) + vyi*d2(2,2) + vzi*d2(3,2))
            derv2(jz,jz) = derv2(jz,jz) + pol2i*(vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))* &
                                                (vxi*d2(1,3) + vyi*d2(2,3) + vzi*d2(3,3))
          endif
        endif
        if (lstr) then
...
!
          ...
          if (lopj) then
            do ks = 1,nstrains
              derv3(jx,ks) = derv3(jx,ks) - poli*(vxi*d3s(1,ks,1) + vyi*d3s(2,ks,1) + vzi*d3s(3,ks,1) - &
                                                  qlj*(d2(1,1)*d2s(1,ks) + d2(1,2)*d2s(2,ks) + d2(1,3)*d2s(3,ks)))
              derv3(jy,ks) = derv3(jy,ks) - poli*(vxi*d3s(1,ks,2) + vyi*d3s(2,ks,2) + vzi*d3s(3,ks,2) - &
                                                  qlj*(d2(2,1)*d2s(1,ks) + d2(2,2)*d2s(2,ks) + d2(2,3)*d2s(3,ks)))
              derv3(jz,ks) = derv3(jz,ks) - poli*(vxi*d3s(1,ks,3) + vyi*d3s(2,ks,3) + vzi*d3s(3,ks,3) - &
                                                  qlj*(d2(3,1)*d2s(1,ks) + d2(3,2)*d2s(2,ks) + d2(3,3)*d2s(3,ks)))
            enddo
!
            if (lpollangevin) then
              do ks = 1,nstrains
                derv3(jx,ks) = derv3(jx,ks) + pol2i*(vxi*d2s(1,ks) + vyi*d2s(2,ks) + vzi*d2s(3,ks))* &
                                                    (vxi*d2(1,1)   + vyi*d2(2,1)   + vzi*d2(3,1))
                derv3(jy,ks) = derv3(jy,ks) + pol2i*(vxi*d2s(1,ks) + vyi*d2s(2,ks) + vzi*d2s(3,ks))* &
                                                    (vxi*d2(1,2)   + vyi*d2(2,2)   + vzi*d2(3,2))
                derv3(jz,ks) = derv3(jz,ks) + pol2i*(vxi*d2s(1,ks) + vyi*d2s(2,ks) + vzi*d2s(3,ks))* &
                                                    (vxi*d2(1,3)   + vyi*d2(2,3)   + vzi*d2(3,3))
              enddo
            endif
          endif
...
!
        kloop: do kk = 1,jj-1
          ...
          if (.not.lopj.and..not.lopk) cycle kloop
!
          if (lopk) then
...
!
          ...
          elseif (lopi) then
            derv2(ix,ix) = derv2(ix,ix) + polk*(d2a(1,1,j)*d2a(1,1,k) + d2a(1,2,j)*d2a(1,2,k) + d2a(1,3,j)*d2a(1,3,k))
            derv2(iy,ix) = derv2(iy,ix) + polk*(d2a(2,1,j)*d2a(1,1,k) + d2a(2,2,j)*d2a(1,2,k) + d2a(2,3,j)*d2a(1,3,k))
            derv2(iz,ix) = derv2(iz,ix) + polk*(d2a(3,1,j)*d2a(1,1,k) + d2a(3,2,j)*d2a(1,2,k) + d2a(3,3,j)*d2a(1,3,k))
            derv2(ix,iy) = derv2(ix,iy) + polk*(d2a(1,1,j)*d2a(2,1,k) + d2a(1,2,j)*d2a(2,2,k) + d2a(1,3,j)*d2a(2,3,k))
            derv2(iy,iy) = derv2(iy,iy) + polk*(d2a(2,1,j)*d2a(2,1,k) + d2a(2,2,j)*d2a(2,2,k) + d2a(2,3,j)*d2a(2,3,k))
            derv2(iz,iy) = derv2(iz,iy) + polk*(d2a(3,1,j)*d2a(2,1,k) + d2a(3,2,j)*d2a(2,2,k) + d2a(3,3,j)*d2a(2,3,k))
            derv2(ix,iz) = derv2(ix,iz) + polk*(d2a(1,1,j)*d2a(3,1,k) + d2a(1,2,j)*d2a(3,2,k) + d2a(1,3,j)*d2a(3,3,k))
            derv2(iy,iz) = derv2(iy,iz) + polk*(d2a(2,1,j)*d2a(3,1,k) + d2a(2,2,j)*d2a(3,2,k) + d2a(2,3,j)*d2a(3,3,k))
            derv2(iz,iz) = derv2(iz,iz) + polk*(d2a(3,1,j)*d2a(3,1,k) + d2a(3,2,j)*d2a(3,2,k) + d2a(3,3,j)*d2a(3,3,k))
!
            if (lpollangevin) then
              derv2(ix,ix) = derv2(ix,ix) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(ix,iy) = derv2(ix,iy) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(ix,iz) = derv2(ix,iz) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              derv2(iy,ix) = derv2(iy,ix) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(iy,iy) = derv2(iy,iy) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(iy,iz) = derv2(iy,iz) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              derv2(iz,ix) = derv2(iz,ix) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(iz,iy) = derv2(iz,iy) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(iz,iz) = derv2(iz,iz) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
            endif
          elseif (lopj) then
            derv2(jx,jx) = derv2(jx,jx) + polk*(d2a(1,1,j)*d2a(1,1,k) + d2a(1,2,j)*d2a(1,2,k) + d2a(1,3,j)*d2a(1,3,k))
            derv2(jy,jx) = derv2(jy,jx) + polk*(d2a(2,1,j)*d2a(1,1,k) + d2a(2,2,j)*d2a(1,2,k) + d2a(2,3,j)*d2a(1,3,k))
            derv2(jz,jx) = derv2(jz,jx) + polk*(d2a(3,1,j)*d2a(1,1,k) + d2a(3,2,j)*d2a(1,2,k) + d2a(3,3,j)*d2a(1,3,k))
            derv2(jx,jy) = derv2(jx,jy) + polk*(d2a(1,1,j)*d2a(2,1,k) + d2a(1,2,j)*d2a(2,2,k) + d2a(1,3,j)*d2a(2,3,k))
            derv2(jy,jy) = derv2(jy,jy) + polk*(d2a(2,1,j)*d2a(2,1,k) + d2a(2,2,j)*d2a(2,2,k) + d2a(2,3,j)*d2a(2,3,k))
            derv2(jz,jy) = derv2(jz,jy) + polk*(d2a(3,1,j)*d2a(2,1,k) + d2a(3,2,j)*d2a(2,2,k) + d2a(3,3,j)*d2a(2,3,k))
            derv2(jx,jz) = derv2(jx,jz) + polk*(d2a(1,1,j)*d2a(3,1,k) + d2a(1,2,j)*d2a(3,2,k) + d2a(1,3,j)*d2a(3,3,k))
            derv2(jy,jz) = derv2(jy,jz) + polk*(d2a(2,1,j)*d2a(3,1,k) + d2a(2,2,j)*d2a(3,2,k) + d2a(2,3,j)*d2a(3,3,k))
            derv2(jz,jz) = derv2(jz,jz) + polk*(d2a(3,1,j)*d2a(3,1,k) + d2a(3,2,j)*d2a(3,2,k) + d2a(3,3,j)*d2a(3,3,k))
!
            if (lpollangevin) then
              derv2(jx,jx) = derv2(jx,jx) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(jx,jy) = derv2(jx,jy) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(jx,jz) = derv2(jx,jz) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              derv2(jy,jx) = derv2(jy,jx) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(jy,jy) = derv2(jy,jy) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(jy,jz) = derv2(jy,jz) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              derv2(jz,jx) = derv2(jz,jx) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(jz,jy) = derv2(jz,jy) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(jz,jz) = derv2(jz,jz) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
            endif
          endif
!
...
!
              ...
              derv2(ix,kx) = derv2(ix,kx) + polk*(d2a(1,1,j)*d2a(1,1,k) + d2a(1,2,j)*d2a(1,2,k) + d2a(1,3,j)*d2a(1,3,k))
              derv2(iy,kx) = derv2(iy,kx) + polk*(d2a(2,1,j)*d2a(1,1,k) + d2a(2,2,j)*d2a(1,2,k) + d2a(2,3,j)*d2a(1,3,k))
              derv2(iz,kx) = derv2(iz,kx) + polk*(d2a(3,1,j)*d2a(1,1,k) + d2a(3,2,j)*d2a(1,2,k) + d2a(3,3,j)*d2a(1,3,k))
              derv2(ix,ky) = derv2(ix,ky) + polk*(d2a(1,1,j)*d2a(2,1,k) + d2a(1,2,j)*d2a(2,2,k) + d2a(1,3,j)*d2a(2,3,k))
              derv2(iy,ky) = derv2(iy,ky) + polk*(d2a(2,1,j)*d2a(2,1,k) + d2a(2,2,j)*d2a(2,2,k) + d2a(2,3,j)*d2a(2,3,k))
              derv2(iz,ky) = derv2(iz,ky) + polk*(d2a(3,1,j)*d2a(2,1,k) + d2a(3,2,j)*d2a(2,2,k) + d2a(3,3,j)*d2a(2,3,k))
              derv2(ix,kz) = derv2(ix,kz) + polk*(d2a(1,1,j)*d2a(3,1,k) + d2a(1,2,j)*d2a(3,2,k) + d2a(1,3,j)*d2a(3,3,k))
              derv2(iy,kz) = derv2(iy,kz) + polk*(d2a(2,1,j)*d2a(3,1,k) + d2a(2,2,j)*d2a(3,2,k) + d2a(2,3,j)*d2a(3,3,k))
              derv2(iz,kz) = derv2(iz,kz) + polk*(d2a(3,1,j)*d2a(3,1,k) + d2a(3,2,j)*d2a(3,2,k) + d2a(3,3,j)*d2a(3,3,k))
!
              if (lpollangevin) then
                derv2(ix,kx) = derv2(ix,kx) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                    (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
                derv2(ix,ky) = derv2(ix,ky) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                    (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
                derv2(ix,kz) = derv2(ix,kz) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                    (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
                derv2(iy,kx) = derv2(iy,kx) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                    (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
                derv2(iy,ky) = derv2(iy,ky) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                    (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
                derv2(iy,kz) = derv2(iy,kz) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                    (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
                derv2(iz,kx) = derv2(iz,kx) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                    (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
                derv2(iz,ky) = derv2(iz,ky) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                    (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
                derv2(iz,kz) = derv2(iz,kz) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                    (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              endif
            endif
          elseif (lopi) then
...
!
          ...
          elseif (lopk) then
            derv2(kx,kx) = derv2(kx,kx) + polk*(d2a(1,1,j)*d2a(1,1,k) + d2a(1,2,j)*d2a(1,2,k) + d2a(1,3,j)*d2a(1,3,k))
            derv2(ky,kx) = derv2(ky,kx) + polk*(d2a(2,1,j)*d2a(1,1,k) + d2a(2,2,j)*d2a(1,2,k) + d2a(2,3,j)*d2a(1,3,k))
            derv2(kz,kx) = derv2(kz,kx) + polk*(d2a(3,1,j)*d2a(1,1,k) + d2a(3,2,j)*d2a(1,2,k) + d2a(3,3,j)*d2a(1,3,k))
            derv2(kx,ky) = derv2(kx,ky) + polk*(d2a(1,1,j)*d2a(2,1,k) + d2a(1,2,j)*d2a(2,2,k) + d2a(1,3,j)*d2a(2,3,k))
            derv2(ky,ky) = derv2(ky,ky) + polk*(d2a(2,1,j)*d2a(2,1,k) + d2a(2,2,j)*d2a(2,2,k) + d2a(2,3,j)*d2a(2,3,k))
            derv2(kz,ky) = derv2(kz,ky) + polk*(d2a(3,1,j)*d2a(2,1,k) + d2a(3,2,j)*d2a(2,2,k) + d2a(3,3,j)*d2a(2,3,k))
            derv2(kx,kz) = derv2(kx,kz) + polk*(d2a(1,1,j)*d2a(3,1,k) + d2a(1,2,j)*d2a(3,2,k) + d2a(1,3,j)*d2a(3,3,k))
            derv2(ky,kz) = derv2(ky,kz) + polk*(d2a(2,1,j)*d2a(3,1,k) + d2a(2,2,j)*d2a(3,2,k) + d2a(2,3,j)*d2a(3,3,k))
            derv2(kz,kz) = derv2(kz,kz) + polk*(d2a(3,1,j)*d2a(3,1,k) + d2a(3,2,j)*d2a(3,2,k) + d2a(3,3,j)*d2a(3,3,k))
!
            if (lpollangevin) then
              derv2(kx,kx) = derv2(kx,kx) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(kx,ky) = derv2(kx,ky) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(kx,kz) = derv2(kx,kz) + pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              derv2(ky,kx) = derv2(ky,kx) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(ky,ky) = derv2(ky,ky) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(ky,kz) = derv2(ky,kz) + pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              derv2(kz,kx) = derv2(kz,kx) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
              derv2(kz,ky) = derv2(kz,ky) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
              derv2(kz,kz) = derv2(kz,kz) + pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                  (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
            endif
          endif
!
...
!
              ...
              derv2(jx,kx) = derv2(jx,kx) - polk*(d2a(1,1,j)*d2a(1,1,k) + d2a(1,2,j)*d2a(1,2,k) + d2a(1,3,j)*d2a(1,3,k))
              derv2(jy,kx) = derv2(jy,kx) - polk*(d2a(2,1,j)*d2a(1,1,k) + d2a(2,2,j)*d2a(1,2,k) + d2a(2,3,j)*d2a(1,3,k))
              derv2(jz,kx) = derv2(jz,kx) - polk*(d2a(3,1,j)*d2a(1,1,k) + d2a(3,2,j)*d2a(1,2,k) + d2a(3,3,j)*d2a(1,3,k))
              derv2(jx,ky) = derv2(jx,ky) - polk*(d2a(1,1,j)*d2a(2,1,k) + d2a(1,2,j)*d2a(2,2,k) + d2a(1,3,j)*d2a(2,3,k))
              derv2(jy,ky) = derv2(jy,ky) - polk*(d2a(2,1,j)*d2a(2,1,k) + d2a(2,2,j)*d2a(2,2,k) + d2a(2,3,j)*d2a(2,3,k))
              derv2(jz,ky) = derv2(jz,ky) - polk*(d2a(3,1,j)*d2a(2,1,k) + d2a(3,2,j)*d2a(2,2,k) + d2a(3,3,j)*d2a(2,3,k))
              derv2(jx,kz) = derv2(jx,kz) - polk*(d2a(1,1,j)*d2a(3,1,k) + d2a(1,2,j)*d2a(3,2,k) + d2a(1,3,j)*d2a(3,3,k))
              derv2(jy,kz) = derv2(jy,kz) - polk*(d2a(2,1,j)*d2a(3,1,k) + d2a(2,2,j)*d2a(3,2,k) + d2a(2,3,j)*d2a(3,3,k))
              derv2(jz,kz) = derv2(jz,kz) - polk*(d2a(3,1,j)*d2a(3,1,k) + d2a(3,2,j)*d2a(3,2,k) + d2a(3,3,j)*d2a(3,3,k))
!
              if (lpollangevin) then
                derv2(jx,kx) = derv2(jx,kx) - pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                    (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
                derv2(jx,ky) = derv2(jx,ky) - pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                    (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
                derv2(jx,kz) = derv2(jx,kz) - pol2k*(vx(i)*d2a(1,1,j) + vy(i)*d2a(2,1,j) + vz(i)*d2a(3,1,j))* &
                                                    (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
                derv2(jy,kx) = derv2(jy,kx) - pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                    (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
                derv2(jy,ky) = derv2(jy,ky) - pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                    (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
                derv2(jy,kz) = derv2(jy,kz) - pol2k*(vx(i)*d2a(1,2,j) + vy(i)*d2a(2,2,j) + vz(i)*d2a(3,2,j))* &
                                                    (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
                derv2(jz,kx) = derv2(jz,kx) - pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                    (vx(i)*d2a(1,1,k) + vy(i)*d2a(2,1,k) + vz(i)*d2a(3,1,k))
                derv2(jz,ky) = derv2(jz,ky) - pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                    (vx(i)*d2a(1,2,k) + vy(i)*d2a(2,2,k) + vz(i)*d2a(3,2,k))
                derv2(jz,kz) = derv2(jz,kz) - pol2k*(vx(i)*d2a(1,3,j) + vy(i)*d2a(2,3,j) + vz(i)*d2a(3,3,j))* &
                                                    (vx(i)*d2a(1,3,k) + vy(i)*d2a(2,3,k) + vz(i)*d2a(3,3,k))
              endif
            endif
          elseif (lopj) then
...
!
            ...
            if (lopk) then
              do ks = 1,nstrains
                derv3(kx,ks) = derv3(kx,ks) + polk*(d2as(1,ks,j)*d2a(1,1,k) + d2as(2,ks,j)*d2a(1,2,k) + d2as(3,ks,j)*d2a(1,3,k))
                derv3(ky,ks) = derv3(ky,ks) + polk*(d2as(1,ks,j)*d2a(2,1,k) + d2as(2,ks,j)*d2a(2,2,k) + d2as(3,ks,j)*d2a(2,3,k))
                derv3(kz,ks) = derv3(kz,ks) + polk*(d2as(1,ks,j)*d2a(3,1,k) + d2as(2,ks,j)*d2a(3,2,k) + d2as(3,ks,j)*d2a(3,3,k))
              enddo
!
              if (lpollangevin) then
                do ks = 1,nstrains
                  derv3(kx,ks) = derv3(kx,ks) + pol2k*(vx(i)*d2as(1,ks,j) + vy(i)*d2as(2,ks,j) + vz(i)*d2as(3,ks,j))* &
                                                      (vx(i)*d2a(1,1,k)   + vy(i)*d2a(2,1,k)   + vz(i)*d2a(3,1,k))
                  derv3(ky,ks) = derv3(ky,ks) + pol2k*(vx(i)*d2as(1,ks,j) + vy(i)*d2as(2,ks,j) + vz(i)*d2as(3,ks,j))* &
                                                      (vx(i)*d2a(1,2,k)   + vy(i)*d2a(2,2,k)   + vz(i)*d2a(3,2,k))
                  derv3(kz,ks) = derv3(kz,ks) + pol2k*(vx(i)*d2as(1,ks,j) + vy(i)*d2as(2,ks,j) + vz(i)*d2as(3,ks,j))* &
                                                      (vx(i)*d2a(1,3,k)   + vy(i)*d2a(2,3,k)   + vz(i)*d2a(3,3,k))
                enddo
              endif
            endif
...
!
  if (lgrad2) then
    if (lstr) then
      ...
      if (status/=0) call deallocate_error('pirealrecip','d2as')
    endif
    deallocate(d2a,stat=status)
    if (status/=0) call deallocate_error('pirealrecip','d2a')
