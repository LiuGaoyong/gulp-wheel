...
!
                  ...
                  derv2dk(1:3,n11,n31) = derv2dk(1:3,n11,n31) - conjg(cdk13(1:3))
                  derv2dk(1:3,n31,n11) = derv2dk(1:3,n31,n11) - cdk13(1:3)
                  derv2dk(1:3,n21,n31) = derv2dk(1:3,n21,n31) - conjg(cdk23(1:3))
...
!
                    ...
                    cdk13(3) = dcmplx(d2k*z31c,d2ks*z31c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n11,n32) = derv2dk(1:3,n11,n32) + conjg(cdk13(1:3))
...
!
                    ...
                    cdk23(3) = dcmplx(d2k*z32c,d2ks*z32c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n21,n32) = derv2dk(1:3,n21,n32) + conjg(cdk23(1:3))
...
!
                    ...
                    cdk23(3) = dcmplx(d2k*z32c,d2ks*z32c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n22,n31) = derv2dk(1:3,n22,n31) - conjg(cdk23(1:3))
