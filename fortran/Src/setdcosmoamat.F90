  subroutine setdcosmoamat(ldqneeded,lcosmicd2,lgrad2,dcosmoA,dcosmoAA,fullA,ldA, &
                           d2qfct,dsegweight,d2segweight,nvec,nmid,nearsas,nearsasptr, &
...
!   4/17 Extra argument added to specify the lower dimension of fullA
...
!
            if (dists2 .lt. cosmormax2) then
              if (dists2 .gt. cosmormax2s) then
                lrweight = .true.
                dists = sqrt(dists2)
                call sasswitch2(cosmormax-dists,dwt,.true.,lgrad2,dwdr,d2wdr2)
!
