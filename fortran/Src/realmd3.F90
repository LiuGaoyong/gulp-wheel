...
!
      lreg2pair = .false.
      if (lseok.and.nregions(ncf).ge.2) then
        lreg2pair = (nregionno(nrelf2a(i)).eq.2)
      endif
!
...
!
      ldog1 = (lmdl.or.lsg1.or.lbsmat(nrelf2a(i)).or.(leem.or.lgfnff))
      ldog2 = (lbsmat(nrelf2a(i)).or.(leem.or.lgfnff))
!
!  Sqrt distances
!
      do k = 1,nor
...
!
      ...
      if ((leem.or.lgfnff).and.ldog1) then
        if (lqeq.or.lSandM.or.lgfnff) then
          eqeq2 = 0.0_dp
          if (lqeq) then
          ...
          elseif (lgfnff) then
            ...
            call gfnffbody(eqeq2,zetaij,ldog1,ldog2,nor,1_i4,fct,qli,qli)
          endif
          if (lreg2pair) then
            esregion2 = esregion2 + eqeq2
          else
...
1210  if (lbsmat(nrelf2a(i)).and.lopi) then
!***********************
!  Radial derivatives  *
!***********************
!
