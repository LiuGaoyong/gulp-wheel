...
!   1/17 nptr replaced with noptatrptr
...
!
!  Set j looping indices as lower half triangular
!
      jmin = 1
      jmax = i
!********************************
...
!
                                      derv3(isxyz(1,ia),kk) = derv3(isxyz(1,ia),kk) + d2r2dsdx(ks,1,indvec)*e1d(indvec)
                                      derv3(isxyz(2,ia),kk) = derv3(isxyz(2,ia),kk) + d2r2dsdx(ks,2,indvec)*e1d(indvec)
                                      derv3(isxyz(3,ia),kk) = derv3(isxyz(3,ia),kk) + d2r2dsdx(ks,3,indvec)*e1d(indvec)
                                    endif
                                    if (lopis(ja)) then
...
!
                                      derv3(isxyz(1,ja),kk) = derv3(isxyz(1,ja),kk) - d2r2dsdx(ks,1,indvec)*e1d(indvec)
                                      derv3(isxyz(2,ja),kk) = derv3(isxyz(2,ja),kk) - d2r2dsdx(ks,2,indvec)*e1d(indvec)
                                      derv3(isxyz(3,ja),kk) = derv3(isxyz(3,ja),kk) - d2r2dsdx(ks,3,indvec)*e1d(indvec)
                                    endif
                                  enddo
                                enddo
                              enddo
