  subroutine fourmd(efor,eoop,eimp,esregion12,esregion2,eattach,lgrad1)
!
...
!  Improper potentials  *
!************************
  if (nimproper.gt.0) call fourimpmd(eimp,esregion12limp,esregion2limp,eattach,lgrad1,xderv,yderv,zderv,rstrd)
!   
