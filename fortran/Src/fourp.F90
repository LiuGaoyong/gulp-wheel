...
!
              ...
              derv2dk(1:3,n11,n31) = derv2dk(1:3,n11,n31) - cdk(1:3)
!
              d2k  = e1d(3)*cos41
              d2ks = e1d(3)*sin41
...
!
              derv2dk(1:3,n11,n41) = derv2dk(1:3,n11,n41) - conjg(cdk(1:3))
...
!
              derv2dk(1:3,n21,n31) = derv2dk(1:3,n21,n31) - conjg(cdk(1:3))
...
!
              derv2dk(1:3,n21,n41) = derv2dk(1:3,n21,n41) - conjg(cdk(1:3))
              derv2dk(1:3,n41,n21) = derv2dk(1:3,n41,n21) - cdk(1:3)
!
              d2k  = e1d(6)*cos43
              d2ks = e1d(6)*sin43
              cdk(1) = dcmplx(d2k*x43,d2ks*x43)*dcmplx(0.0_dp,1.0_dp)
              cdk(2) = dcmplx(d2k*y43,d2ks*y43)*dcmplx(0.0_dp,1.0_dp)
              cdk(3) = dcmplx(d2k*z43,d2ks*z43)*dcmplx(0.0_dp,1.0_dp)
!
              derv2dk(1:3,n31,n41) = derv2dk(1:3,n31,n41) - conjg(cdk(1:3))
              derv2dk(1:3,n41,n31) = derv2dk(1:3,n41,n31) - cdk(1:3)
            endif
!
...
!
                ...
                cdk(3) = dcmplx(d2k*z32,d2ks*z32)*dcmplx(0.0_dp,1.0_dp)
!
                derv2dk(1:3,n21,n32) = derv2dk(1:3,n21,n32) + conjg(cdk(1:3))
...
!
                ...
                cdk(3) = dcmplx(d2k*z42,d2ks*z42)*dcmplx(0.0_dp,1.0_dp)
!
                derv2dk(1:3,n21,n42) = derv2dk(1:3,n21,n42) + conjg(cdk(1:3))
...
!
                ...
                derv2dk(1:3,n11,n32) = derv2dk(1:3,n11,n32) + cdk(1:3)
!
                d2k  = t34*cos43
                d2ks = t34*sin43
                cdk(1) = dcmplx(d2k*x43,d2ks*x43)*dcmplx(0.0_dp,1.0_dp)
                ...
                cdk(3) = dcmplx(d2k*z43,d2ks*z43)*dcmplx(0.0_dp,1.0_dp)
!
                derv2dk(1:3,n31,n42) = derv2dk(1:3,n31,n42) + conjg(cdk(1:3))
                derv2dk(1:3,n42,n31) = derv2dk(1:3,n42,n31) + cdk(1:3)
!
                d2k  = t14*cos41
                d2ks = t14*sin41
                cdk(1) = dcmplx(d2k*x41,d2ks*x41)*dcmplx(0.0_dp,1.0_dp)
                ...
                cdk(3) = dcmplx(d2k*z41,d2ks*z41)*dcmplx(0.0_dp,1.0_dp)
!
                derv2dk(1:3,n11,n42) = derv2dk(1:3,n11,n42) + conjg(cdk(1:3))
...
!  Improper potentials  *
!************************
  if (nimproper.gt.0) call fourimpp(xkv,ykv,zkv)
!
!  Free local memory
!
  deallocate(zvec,stat=status)
