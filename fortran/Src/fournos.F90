  subroutine fournos(efor,eoop,eimp,esregion12,esregion2,eattach,lgrad1,lgrad2)
!
...
!  10/13 Bug in derv3 fixed. Derivatives needed to be in the strain loop for temp.
...
!   4/20 Rigid molecule modifications added for call to realstrterm
...
!  Improper potentials  *
!************************
  if (nimproper.gt.0) call fourimp(eimp,esregion12limp,esregion2,eattach,lgrad1,lgrad2,xderv,yderv,zderv)
!   
