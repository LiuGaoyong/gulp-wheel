...
!   9/13 Extra argument added to setktrmd3
!   3/14 lorder12loc removed twobody argument list
!   3/14 Output of third order derivatives for ShengBTE added
!   4/14 Format of temporary file for ShengBTE changed since only lower
!        half triangular values are available at the time of writing. 
...
!
!  Output for ShengBTE - cores only
!
          if (lshengBTE) then
