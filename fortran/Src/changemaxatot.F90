...
!
  call realloc(lbsmatcfg,maxatot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxatot','lbsmatcfg')
  ...
  call realloc(nregionnocfg,maxatot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxatot','nregionnocfg')
