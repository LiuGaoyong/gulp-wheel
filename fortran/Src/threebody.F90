...
!   3/15 MM3angle added
!   8/15 Third derivatives of exponential threebody corrected
!   8/15 Garofalini form of sw3 added
!   8/15 Handling of ipivot added for modified sw3
!   8/16 Third derivatives added for bagcross potential
!   8/16 Third derivatives added for balcross potential
!  10/16 Calculation of inverse sine terms prevented for non-first derivative runs
!  10/16 Asymptotic series used for case where theta -> pi
!   2/18 Trace added
!   6/19 j3 potential added
!  11/19 ppp3body added
!   3/20 Location of angstoev changed to current
!  11/21 Modifications for TI added
!   8/23 Correction to linear three-body potential for TI
!
...
!***************************************
  if (.not.l180) then
    if (n3ty.ne.3.and.n3ty.ne.4.and.n3ty.ne.6.and.n3ty.ne.7.and.n3ty.ne.10.and.n3ty.ne.12.and.n3ty.ne.13 &
        .and.n3ty.ne.19.and.n3ty.ne.20.and.n3ty.ne.21.and.n3ty.ne.23.and.n3ty.ne.26.and.n3ty.ne.27) then
!
!  Calculate inverse sin(theta) as this forms part of d(theta)/dr
!
      sinth2 = 1.0_dp - costh**2
!
!  Only need inverse sine terms for forces and beyond
!
      if (lgrad1) then
  ...
  if (n3ty.eq.1.or.n3ty.eq.2.or.n3ty.eq.3.or.n3ty.eq.5.or.n3ty.eq.8.or.n3ty.eq.9.or.n3ty.eq.11.or. &
      n3ty.eq.12.or.n3ty.eq.13.or.n3ty.eq.14.or.n3ty.eq.15.or.n3ty.eq.16.or.n3ty.eq.17.or.n3ty.eq.18.or. &
      n3ty.eq.22.or.n3ty.eq.23.or.n3ty.eq.24.or.n3ty.eq.25) then
!****************************************
...
!
    ...
    if (n3ty.eq.25) then
!****************************************
!  Calculate derivatives of sin(theta)  *
!****************************************
      sinth = sqrt(sinth2)
      if (lgrad1) then
!
...
!  3 = r23
!
        dsindcos = - costh*rsinth
        sin1d1 = cos1d1*dsindcos
        sin1d2 = cos1d2*dsindcos
        sin1d3 = cos1d3*dsindcos
        if (lgrad2) then
!
!  Second
!
...
!  6 = 33
!
          d2sindcos2 = - rsinth*rsinth2
          sin2d(1) = d2sindcos2*cos1d1*cos1d1 + dsindcos*cos2d(1)
          sin2d(2) = d2sindcos2*cos1d1*cos1d2 + dsindcos*cos2d(2)
          sin2d(3) = d2sindcos2*cos1d1*cos1d3 + dsindcos*cos2d(3)
          sin2d(4) = d2sindcos2*cos1d2*cos1d2 + dsindcos*cos2d(4)
          sin2d(5) = d2sindcos2*cos1d2*cos1d3 + dsindcos*cos2d(5)
          sin2d(6) = d2sindcos2*cos1d3*cos1d3 + dsindcos*cos2d(6)
          if (lgrad3) then
!
!  Third
!
...
! 10 = 333
!
            d3sindcos3 = - 3.0_dp*costh*rsinth*rsinth2*rsinth2
            sin3d(1)  = d3sindcos3*cos1d1*cos1d1*cos1d1 + dsindcos*cos3d(1) + &
                        d2sindcos2*(3.0_dp*cos1d1*cos2d(1))
            sin3d(2)  = d3sindcos3*cos1d1*cos1d1*cos1d2 + dsindcos*cos3d(2) + &
                        d2sindcos2*(2.0_dp*cos1d1*cos2d(2)+cos1d2*cos2d(1))
            sin3d(3)  = d3sindcos3*cos1d1*cos1d1*cos1d3 + dsindcos*cos3d(3) + &
                        d2sindcos2*(2.0_dp*cos1d1*cos2d(3)+cos1d3*cos2d(1))
            sin3d(4)  = d3sindcos3*cos1d1*cos1d2*cos1d2 + dsindcos*cos3d(4) + &
                        d2sindcos2*(2.0_dp*cos1d2*cos2d(2)+cos1d1*cos2d(4))
            sin3d(5)  = d3sindcos3*cos1d1*cos1d2*cos1d3 + dsindcos*cos3d(5) + &
                        d2sindcos2*(cos1d1*cos2d(5)+cos1d2*cos2d(3)+cos1d3*cos2d(2))
            sin3d(6)  = d3sindcos3*cos1d1*cos1d3*cos1d3 + dsindcos*cos3d(6) + &
                        d2sindcos2*(2.0_dp*cos1d3*cos2d(3)+cos1d1*cos2d(6))
            sin3d(7)  = d3sindcos3*cos1d2*cos1d2*cos1d2 + dsindcos*cos3d(7) + &
                        d2sindcos2*(3.0_dp*cos1d2*cos2d(4))
            sin3d(8)  = d3sindcos3*cos1d2*cos1d2*cos1d3 + dsindcos*cos3d(8) + &
                        d2sindcos2*(2.0_dp*cos1d2*cos2d(5)+cos1d3*cos2d(4))
            sin3d(9)  = d3sindcos3*cos1d2*cos1d3*cos1d3 + dsindcos*cos3d(9) + &
                        d2sindcos2*(2.0_dp*cos1d3*cos2d(5)+cos1d2*cos2d(6))
            sin3d(10) = d3sindcos3*cos1d3*cos1d3*cos1d3 + dsindcos*cos3d(10) + &
                        d2sindcos2*(3.0_dp*cos1d3*cos2d(6))
          endif
        endif
      endif
    endif
  endif
  if ((n3ty.eq.1.or.n3ty.eq.2.or.n3ty.eq.8.or.n3ty.eq.11.or.n3ty.eq.22.or.n3ty.eq.24).and..not.l180) then
!***********************************
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    delth2 = delth*delth
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + 0.5_dp*rkthb*delth2*rtistep
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - 0.5_dp*rkthb*delth2*rtistep
        rkthbl = rkthb*(1.0_dp - lambda)
      else
        rkthbl = rkthb
      endif
    else
    ...
    ethb = 0.5_dp*rkthbl*delth2
    if (rkthb3.ne.0.0_dp) then
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb3*delth2*delth*rtistep
          rkthb3l = rkthb3*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb3*delth2*delth*rtistep
          rkthb3l = rkthb3*(1.0_dp - lambda)
        else
          rkthb3l = rkthb3
        endif
      else
    ...
    if (rkthb4.ne.0.0_dp) then
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb4*delth2*delth2*rtistep
          rkthb4l = rkthb4*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb4*delth2*delth2*rtistep
          rkthb4l = rkthb4*(1.0_dp - lambda)
        else
          rkthb4l = rkthb4
        endif
      else
      ...
      ethb = ethb + rkthb4l*delth2*delth2
    endif
    if (lgrad1) then
      if (l180) then
!
!  For angles approaching 180 degrees take series expansion of 
!  angle terms as an approximation to get asymptotic limit of
!  derivatives
!
        e1 = rkthbl
        e2 = 0.0_dp
        if (rkthb3.ne.0.0_dp) then
          e1 = e1 + 3.0_dp*rkthb3l*delth
          e2 = 0.0_dp
        endif
        if (rkthb4.ne.0.0_dp) then
          e1 = e1 + 4.0_dp*rkthb4l*delth2
          e2 = e2 + 8.0_dp*rkthb4l
        endif
!
...
!
          e2d(1) = e1*cos2d(1) + e2*cos1d1*cos1d1
          e2d(2) = e1*cos2d(2) + e2*cos1d1*cos1d2
          e2d(3) = e1*cos2d(3) + e2*cos1d1*cos1d3
          e2d(4) = e1*cos2d(4) + e2*cos1d2*cos1d2
          e2d(5) = e1*cos2d(5) + e2*cos1d2*cos1d3
          e2d(6) = e1*cos2d(6) + e2*cos1d3*cos1d3
          if (lgrad3) then
!
...
!
            ...
            e3d(10) = e1*cos3d(10)
!
            e3d(1) = e3d(1) + 3.0_dp*e2*cos2d(1)*cos1d1
            e3d(2) = e3d(2) + e2*(2.0_dp*cos2d(2)*cos1d1 + cos2d(1)*cos1d2)
            e3d(3) = e3d(3) + e2*(2.0_dp*cos2d(3)*cos1d1 + cos2d(1)*cos1d3)
            e3d(4) = e3d(4) + e2*(2.0_dp*cos2d(2)*cos1d2 + cos2d(4)*cos1d1)
            e3d(5) = e3d(5) + e2*(cos2d(2)*cos1d3 + cos2d(3)*cos1d2 + cos2d(5)*cos1d1)
            e3d(6) = e3d(6) + e2*(2.0_dp*cos2d(3)*cos1d3 + cos2d(6)*cos1d1)
            e3d(7) = e3d(7) + 3.0_dp*e2*cos2d(4)*cos1d2
            e3d(8) = e3d(8) + e2*(2.0_dp*cos2d(5)*cos1d2 + cos2d(4)*cos1d3)
            e3d(9) = e3d(9) + e2*(2.0_dp*cos2d(5)*cos1d3 + cos2d(6)*cos1d2)
            e3d(10) = e3d(10) + 3.0_dp*e2*cos2d(6)*cos1d3
          endif
        endif
      else
        e1 = rkthbl*delth
        ...
        e3 = 0.0_dp
        if (rkthb3.ne.0.0_dp) then
          e1 = e1 + 3.0_dp*rkthb3l*delth2
          e2 = e2 + 6.0_dp*rkthb3l*delth
          e3 = e3 + 6.0_dp*rkthb3l
        endif
        if (rkthb4.ne.0.0_dp) then
          e1 = e1 + 4.0_dp*rkthb4l*delth2*delth
          e2 = e2 + 12.0_dp*rkthb4l*delth2
          e3 = e3 + 24.0_dp*rkthb4l*delth
        endif
!
!  First derivatives of energy
!
...
!
    ...
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + e0*et1
        et1 = et1*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - e0*et1
        et1 = et1*(1.0_dp - lambda)
      endif
    endif
    ethb = e0*et1
    if (lgrad1) then
...
!$$$$$$$$$$$$$$$$$$$
    ...
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + e0
        rk8 = rk8*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - e0
        rk8 = rk8*(1.0_dp - lambda)
      endif
      e0 = rk8*(8.0_dp*r122*r132*r232 + 3.0_dp*p1*p2*p3)
    endif
    ethb = e0
...
!
          ...
          e3d(2) =  - t12*t12*t13*e0 - t12*t13*rr12*rr12*e0
          e3d(3) =  - t12*t12*t23*e0 - t12*t23*rr12*rr12*e0
          e3d(4) =  - t12*t13*t13*e0 - t12*t13*rr13*rr13*e0
          e3d(5) =  - t12*t13*t23*e0
          e3d(6) =  - t12*t23*t23*e0 - t12*t23*rr23*rr23*e0
          e3d(7) =  - t13*t13*t13*e0 - 3.0_dp*rr13*rr13*e2d(4)
          e3d(8) =  - t13*t13*t23*e0 - t13*t23*rr13*rr13*e0
          e3d(9) =  - t13*t23*t23*e0 - t13*t23*rr23*rr23*e0
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!
!  Is this the modified form?
!
    if (ipivot.eq.1) then
      lmodified = (abs(rho3).gt.0.0_dp)
    elseif (ipivot.eq.2) then
      lmodified = (abs(rho2).gt.0.0_dp)
    elseif (ipivot.eq.3) then
      lmodified = (abs(rho1).gt.0.0_dp)
    endif
!
!  Construct angle based terms
!
    if (lmodified) then
      rcostrm = 1.0_dp/(1.0_dp + rho3*(dot - theta0)*(dot - theta0))
      e0 = rkthb*(dot - theta0)*(dot - theta0)*rcostrm
      if (lgrad1) then
        e1 = 2.0_dp*rkthb*(dot - theta0)*rcostrm - e0*rcostrm*2.0_dp*rho3*(dot - theta0)
!
!  First derivatives of energy w.r.t. to angle
!
        a1d1 = e1*cos1d1
        ...
        a1d3 = e1*cos1d3
        if (lgrad2) then
          e2 = 2.0_dp*rkthb*rcostrm &
               - 10.0_dp*rkthb*rho3*((dot - theta0)**2)*rcostrm**2 &
               + 8.0_dp*rkthb*rho3*rho3*((dot - theta0)**4)*rcostrm**3
!
!  Second derivatives of energy w.r.t. to angle
!
          ...
          if (lgrad3) then
            e3 = - 24.0_dp*rkthb*rho3*(dot - theta0)*rcostrm**2 &
                 + 72.0_dp*rkthb*rho3*rho3*((dot - theta0)**3)*rcostrm**3 &
                 - 48.0_dp*rkthb*rho3*rho3*rho3*((dot - theta0)**5)*rcostrm**4
!
!  Third derivatives of energy w.r.t. to angle
!
...
!
            a3d(1) = a3d(1) + e3*cos1d1*cos1d1*cos1d1
            a3d(2) = a3d(2) + e3*cos1d1*cos1d1*cos1d2
            a3d(3) = a3d(3) + e3*cos1d1*cos1d1*cos1d3
            a3d(4) = a3d(4) + e3*cos1d1*cos1d2*cos1d2
            a3d(5) = a3d(5) + e3*cos1d1*cos1d2*cos1d3
            a3d(6) = a3d(6) + e3*cos1d1*cos1d3*cos1d3
            a3d(7) = a3d(7) + e3*cos1d2*cos1d2*cos1d2
            a3d(8) = a3d(8) + e3*cos1d2*cos1d2*cos1d3
            a3d(9) = a3d(9) + e3*cos1d2*cos1d3*cos1d3
            a3d(10) = a3d(10) + e3*cos1d3*cos1d3*cos1d3
          endif
        endif
      endif
    else
...
!$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    if (ipivot.eq.1) then
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*rd1*rd2
          rkthbl = rkthb*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*rd1*rd2
          rkthbl = rkthb*(1.0_dp - lambda)
    ...
    elseif (ipivot.eq.2) then
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*rd1*rd3
          rkthbl = rkthb*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*rd1*rd3
          rkthbl = rkthb*(1.0_dp - lambda)
      ...
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*rd2*rd3
          rkthbl = rkthb*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*rd2*rd3
          rkthbl = rkthb*(1.0_dp - lambda)
...
!
      if (ipivot.eq.1) then
        e1d1 = rkthbl*rd2*rr12
        e1d2 = rkthbl*rd1*rr13
        e1d3 = 0.0_dp
      elseif (ipivot.eq.2) then
        e1d1 = rkthbl*rd3*rr12
        e1d2 = 0.0_dp
        e1d3 = rkthbl*rd1*rr23
      else
        e1d1 = 0.0_dp
        e1d2 = rkthbl*rd3*rr13
        e1d3 = rkthbl*rd2*rr23
      endif
      if (lgrad2) then
!
!  Second derivatives
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    if (ipivot.eq.1) then
      e0 = 0.5_dp*(r23 - theta0)*(r23 - theta0)
    elseif (ipivot.eq.2) then
      e0 = 0.5_dp*(r13 - theta0)*(r13 - theta0)
    else
      e0 = 0.5_dp*(r12 - theta0)*(r12 - theta0)
    endif
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*e0
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*e0
        rkthbl = rkthb*(1.0_dp - lambda)
...
!
      ...
      e1d3 = 0.0_dp
      if (ipivot.eq.1) then
        e1d3 = rkthbl*(r23 - theta0)*rr23
      elseif (ipivot.eq.2) then
        e1d2 = rkthbl*(r13 - theta0)*rr13
      else
        e1d1 = rkthbl*(r12 - theta0)*rr12
      endif
      if (lgrad2) then
!
!  Second derivatives
!
        ...
        enddo
        if (ipivot.eq.1) then
          e2d(6) = rr23*rr23*(rkthbl - e1d3)
        elseif (ipivot.eq.2) then
          e2d(4) = rr13*rr13*(rkthbl - e1d2)
        else
          e2d(1) = rr12*rr12*(rkthbl - e1d1)
        endif
        if (lgrad3) then
!
!  Third derivatives 
...
!
    ...
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + 0.5_dp*rkthb*thetrm**2
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - 0.5_dp*rkthb*thetrm**2
        rkthbl = rkthb*(1.0_dp - lambda)
...
!
        ...
        e1 =  - 2.0_dp*rkthbl*thetrm*delth
        e2 =  - 2.0_dp*rkthbl*(theta0 - 3.0_dp*delth2)
        e3 = 12.0_dp*rkthbl*delth
!
!  First derivatives of energy w.r.t. to angle
!
        a1d1 = e1*the1d1
...
!$$$$$$$$$$$$$$$$$$$$$$$$
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + 0.5_dp*rkthb*(costh - theta0)**2
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - 0.5_dp*rkthb*(costh - theta0)**2
        rkthbl = rkthb*(1.0_dp - lambda)
    ...
    ethb = 0.5_dp*rkthbl*(costh - theta0)**2
    if (rkthb3.ne.0.0_dp) then 
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb3*(costh - theta0)**3
          rkthb3l = rkthb3*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb3*(costh - theta0)**3
          rkthb3l = rkthb3*(1.0_dp - lambda)
      ...
      ethb = ethb + rkthb3l*(costh - theta0)**3
    endif
    if (rkthb4.ne.0.0_dp) then 
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb4*(costh - theta0)**4
          rkthb4l = rkthb4*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb4*(costh - theta0)**4
          rkthb4l = rkthb4*(1.0_dp - lambda)
      ...
      ethb = ethb + rkthb4l*(costh - theta0)**4
    endif
    if (lgrad1) then
!
!  First derivatives
!
      e1 = rkthbl*(costh - theta0)
      if (rkthb3.ne.0.0_dp) then 
        e1 = e1 + 3.0_dp*rkthb3l*(costh - theta0)**2
      endif
      if (rkthb4.ne.0.0_dp) then 
        e1 = e1 + 4.0_dp*rkthb4l*(costh - theta0)**3
      endif
      e1d1 = e1*cos1d1
      e1d2 = e1*cos1d2
      e1d3 = e1*cos1d3
      if (lgrad2) then
        e2 = rkthbl
        if (rkthb3.ne.0.0_dp) then 
          e2 = e2 + 6.0_dp*rkthb3l*(costh - theta0)
        endif
        if (rkthb4.ne.0.0_dp) then 
          e2 = e2 + 12.0_dp*rkthb4l*(costh - theta0)**2
        endif
!
!  Second derivatives
!
        e2d(1) = e2*cos1d1*cos1d1 + e1*cos2d(1)
        e2d(2) = e2*cos1d1*cos1d2 + e1*cos2d(2)
        e2d(3) = e2*cos1d1*cos1d3 + e1*cos2d(3)
        e2d(4) = e2*cos1d2*cos1d2 + e1*cos2d(4)
        e2d(5) = e2*cos1d2*cos1d3 + e1*cos2d(5)
        e2d(6) = e2*cos1d3*cos1d3 + e1*cos2d(6)
        if (lgrad3) then
          e3 = 0.0_dp
          if (rkthb3.ne.0.0_dp) then 
            e3 = e3 + 6.0_dp*rkthb3l
          ...
          if (rkthb4.ne.0.0_dp) then 
            e3 = e3 + 24.0_dp*rkthb4l*(costh - theta0)
          endif
!
!  Third derivatives
!
          e3d(1) = 3.0_dp*e2*cos1d1*cos2d(1) + e1*cos3d(1)
          e3d(2) = e2*(cos1d2*cos2d(1) + 2.0_dp*cos1d1*cos2d(2)) + e1*cos3d(2)
          e3d(3) = e2*(cos1d3*cos2d(1) + 2.0_dp*cos1d1*cos2d(3)) + e1*cos3d(3)
          e3d(4) = e2*(cos1d1*cos2d(4) + 2.0_dp*cos1d2*cos2d(2)) + e1*cos3d(4)
          e3d(5) = e2*(cos1d1*cos2d(5) + cos1d2*cos2d(3)+cos1d3*cos2d(2)) + e1*cos3d(5)
          e3d(6) = e2*(cos1d1*cos2d(6) + 2.0_dp*cos1d3*cos2d(3)) + e1*cos3d(6)
          e3d(7) = 3.0_dp*e2*cos1d2*cos2d(4) + e1*cos3d(7)
          e3d(8) = e2*(cos1d3*cos2d(4) + 2.0_dp*cos1d2*cos2d(5)) + e1*cos3d(8)
          e3d(9) = e2*(cos1d2*cos2d(6) + 2.0_dp*cos1d3*cos2d(5)) + e1*cos3d(9)
          e3d(10) = 3.0_dp*e2*cos1d3*cos2d(6) + e1*cos3d(10)
!
          e3d(1) = e3d(1) + e3*cos1d1*cos1d1*cos1d1
          e3d(2) = e3d(2) + e3*cos1d1*cos1d1*cos1d2
          e3d(3) = e3d(3) + e3*cos1d1*cos1d1*cos1d3
          e3d(4) = e3d(4) + e3*cos1d1*cos1d2*cos1d2
          e3d(5) = e3d(5) + e3*cos1d1*cos1d2*cos1d3
          e3d(6) = e3d(6) + e3*cos1d1*cos1d3*cos1d3
          e3d(7) = e3d(7) + e3*cos1d2*cos1d2*cos1d2
          e3d(8) = e3d(8) + e3*cos1d2*cos1d2*cos1d3
          e3d(9) = e3d(9) + e3*cos1d2*cos1d3*cos1d3
          e3d(10) = e3d(10) + e3*cos1d3*cos1d3*cos1d3
        endif
      endif
    endif
...
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*p
        rktrm = rktrm*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*p
        rktrm = rktrm*(1.0_dp - lambda)
      endif
    endif
    ethb = rktrm*p
    if (lgrad1) then
...
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*delth
        rktrm = rktrm*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*delth
        rktrm = rktrm*(1.0_dp - lambda)
...
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*(1.0_dp + theta0*cosntheta)
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*(1.0_dp + theta0*cosntheta)
        rkthbl = rkthb*(1.0_dp - lambda)
...
!
    ethb = rkthbl*(1.0_dp + theta0*cosntheta)
    if (lgrad1) then
!
!  First derivatives of energy
!
...
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + e0*rtrm
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - e0*rtrm
        rkthbl = rkthb*(1.0_dp - lambda)
      ...
      e0 = rkthbl*(1.0_dp + theta0*cosnthetam)
    else
      rkthbl = rkthb
    endif
!
...
!
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + e0*(atrm - btrm)
          atrm = atrm*lambda
          btrm = btrm*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - e0*(atrm - btrm)
          atrm = atrm*(1.0_dp - lambda)
          btrm = btrm*(1.0_dp - lambda)
        endif
      endif
!
      et1 = atrm - btrm
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rk1*(1.0_dp - cosntheta) + rk2
        rk1 = rk1*lambda
        rk2 = rk2*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rk1*(1.0_dp - cosntheta) + rk2
        rk1 = rk1*(1.0_dp - lambda)
        rk2 = rk2*(1.0_dp - lambda)
      endif
    endif
...
!
    ...
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*(theta0 + rkthb3*costh + rkthb4*cosntheta)
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*(theta0 + rkthb3*costh + rkthb4*cosntheta)
        rkthbl = rkthb*(1.0_dp - lambda)
    ...
    ethb = rkthbl*(theta0 + rkthb3*costh + rkthb4*cosntheta)
    if (lgrad1) then
!
!  First derivatives of energy
!
...
!
      ...
      e1 = rkthbl*(rkthb3 + 2.0_dp*rkthb4*cosd1)
      e1d1 = e1*cos1d1
      e1d2 = e1*cos1d2
      e1d3 = e1*cos1d3
      if (lgrad2) then
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    if (ipivot.eq.1) then
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*rr23
          rktrm = rktrm*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*rr23
          rktrm = rktrm*(1.0_dp - lambda)
    ...
    elseif (ipivot.eq.2) then
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*rr13
          rktrm = rktrm*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*rr13
          rktrm = rktrm*(1.0_dp - lambda)
      ...
      if (lti) then
        if (ltif3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*rr12
          rktrm = rktrm*lambda
        elseif (ltib3body(nptr3)) then
          dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*rr12
          rktrm = rktrm*(1.0_dp - lambda)
...
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*(trm0**third)
        rktrm = rktrm*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*(trm0**third)
        rktrm = rktrm*(1.0_dp - lambda)
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!  Bond - angle general cross potential  $
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    pr1 = nint(threepoly(1,nptr3))            ! Power of distance 1
    pr2 = nint(threepoly(2,nptr3))            ! Power of distance 2
    pt  = nint(threepoly(3,nptr3))            ! Power of theta
    if (ipivot.eq.1) then
      rd1 = r12 - rho1
      rd2 = r13 - rho2
    elseif (ipivot.eq.2) then
    ...
    prd1 = rd1**pr1
    prd2 = rd2**pr2
    rktrm = rkthb*prd1*prd2
    delth = thet - theta0
    ptdelth = delth**pt
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*ptdelth
        rktrm = rktrm*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rktrm*ptdelth
        rktrm = rktrm*(1.0_dp - lambda)
...
!
      ...
      if (ipivot.eq.1) then
        if (pr1.ge.1) then
          prd1m1 = rr12*dble(pr1)*rd1**(pr1-1)
        else
          prd1m1 = 0.0_dp
        endif
        if (pr2.ge.1) then
          prd2m1 = rr13*dble(pr2)*rd2**(pr2-1)
        else
          prd2m1 = 0.0_dp
        endif
        prd11d(1) = prd1m1
      ...
      elseif (ipivot.eq.2) then
        ...
        if (pr2.ge.1) then
          prd2m1 = rr23*dble(pr2)*rd2**(pr2-1)
        else
          prd2m1 = 0.0_dp
        endif
        prd11d(1) = prd1m1
        ...
        if (pr1.ge.1) then
          prd1m1 = rr13*dble(pr1)*rd1**(pr1-1)
        else
          prd1m1 = 0.0_dp
        endif
        if (pr2.ge.1) then
      ...
      e1d1 = rkthb*(prd11d(1)*prd2 + prd1*prd21d(1))*ptdelth
      e1d2 = rkthb*(prd11d(2)*prd2 + prd1*prd21d(2))*ptdelth
      e1d3 = rkthb*(prd11d(3)*prd2 + prd1*prd21d(3))*ptdelth
      if (pt.ge.2) then
        delthm1 = dble(pt)*delth**(pt-1)
      elseif (pt.eq.1) then
        delthm1 = 1.0_dp
      else
        delthm1 = 0.0_dp
      endif
      e1d1 = e1d1 + delthm1*rktrm*the1d1
      e1d2 = e1d2 + delthm1*rktrm*the1d2
      e1d3 = e1d3 + delthm1*rktrm*the1d3
      if (lgrad2) then
!
!  Second derivatives
!
        if (pt.ge.2) then
          delthm2 = dble(pt*(pt-1))*delth**(pt-2)
        else
          delthm2 = 0.0_dp
        endif
        e2d(1) = rktrm*(delthm1*the2d(1) + delthm2*the1d1*the1d1)
        e2d(2) = rktrm*(delthm1*the2d(2) + delthm2*the1d1*the1d2)
        e2d(3) = rktrm*(delthm1*the2d(3) + delthm2*the1d1*the1d3)
        e2d(4) = rktrm*(delthm1*the2d(4) + delthm2*the1d2*the1d2)
        e2d(5) = rktrm*(delthm1*the2d(5) + delthm2*the1d2*the1d3)
        e2d(6) = rktrm*(delthm1*the2d(6) + delthm2*the1d3*the1d3)
!
        prd12d(1:6) = 0.0_dp
        prd22d(1:6) = 0.0_dp
!
        if (ipivot.eq.1) then
          if (pr1.ge.2) then
            prd1m2 = rr122*(dble(pr1*(pr1-1))*rd1**(pr1-2) - prd1m1)
          elseif (pr1.eq.1) then
            prd1m2 = - rr122*prd1m1
          else
            prd1m2 = 0.0_dp
          endif
          if (pr2.ge.2) then
            prd2m2 = rr132*(dble(pr2*(pr2-1))*rd2**(pr2-2) - prd2m1)
          elseif (pr2.eq.1) then
            prd2m2 = - rr132*prd2m1
          else
            prd2m2 = 0.0_dp
          endif
!
        ...
        elseif (ipivot.eq.2) then
          ...
          if (pr2.ge.2) then
            prd2m2 = rr232*(dble(pr2*(pr2-1))*rd2**(pr2-2) - prd2m1)
          elseif (pr2.eq.1) then
            prd2m2 = - rr232*prd2m1
          else
            prd2m2 = 0.0_dp
...
!
          ...
          if (pr1.ge.2) then
            prd1m2 = rr132*(dble(pr1*(pr1-1))*rd1**(pr1-2) - prd1m1)
          elseif (pr1.eq.1) then
            prd1m2 = - rr132*prd1m1
          else
            prd1m2 = 0.0_dp
...
!
        ...
        e2d(1) = e2d(1) + rkthb*((prd12d(1)*prd2 + prd1*prd22d(1) + &
                                 2.0_dp*prd11d(1)*prd21d(1))*ptdelth + &
                                 2.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*delthm1*the1d1)
        e2d(2) = e2d(2) + rkthb*((prd12d(2)*prd2 + prd1*prd22d(2) + &
                                 prd11d(1)*prd21d(2) + prd11d(2)*prd21d(1))*ptdelth + &
                                 (prd11d(1)*prd2 + prd1*prd21d(1))*delthm1*the1d2 + &
                                 (prd11d(2)*prd2 + prd1*prd21d(2))*delthm1*the1d1)
        e2d(3) = e2d(3) + rkthb*((prd12d(3)*prd2 + prd1*prd22d(3) + &
                                 prd11d(1)*prd21d(3) + prd11d(3)*prd21d(1))*ptdelth + &
                                 (prd11d(1)*prd2 + prd1*prd21d(1))*delthm1*the1d3 + &
                                 (prd11d(3)*prd2 + prd1*prd21d(3))*delthm1*the1d1)
        e2d(4) = e2d(4) + rkthb*((prd12d(4)*prd2 + prd1*prd22d(4) + &
                                 2.0_dp*prd11d(2)*prd21d(2))*ptdelth + &
                                 2.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*delthm1*the1d2)
        e2d(5) = e2d(5) + rkthb*((prd12d(5)*prd2 + prd1*prd22d(5) + &
                                 prd11d(2)*prd21d(3) + prd11d(3)*prd21d(2))*ptdelth + &
                                 (prd11d(2)*prd2 + prd1*prd21d(2))*delthm1*the1d3 + &
                                 (prd11d(3)*prd2 + prd1*prd21d(3))*delthm1*the1d2)
        e2d(6) = e2d(6) + rkthb*((prd12d(6)*prd2 + prd1*prd22d(6) + &
                                 2.0_dp*prd11d(3)*prd21d(3))*ptdelth + &
                                 2.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*delthm1*the1d3)
        if (lgrad3) then
!
!  Third derivatives
!
          if (pt.ge.3) then
            delthm3 = dble(pt*(pt-1)*(pt-2))*delth**(pt-3)
          else
            delthm3 = 0.0_dp
          endif
          e3d(1)  = rktrm*(delthm1*the3d(1)  + &
            delthm2*3.0_dp*the2d(1)*the1d1 + delthm3*the1d1*the1d1*the1d1)
          e3d(2)  = rktrm*(delthm1*the3d(2)  + &
            delthm2*(2.0_dp*the2d(2)*the1d1 + the2d(1)*the1d2) + delthm3*the1d1*the1d1*the1d2)
          e3d(3)  = rktrm*(delthm1*the3d(3)  + &
            delthm2*(2.0_dp*the2d(3)*the1d1 + the2d(1)*the1d3) + delthm3*the1d1*the1d1*the1d3)
          e3d(4)  = rktrm*(delthm1*the3d(4)  + &
            delthm2*(2.0_dp*the2d(2)*the1d2 + the2d(4)*the1d1) + delthm3*the1d1*the1d2*the1d2)
          e3d(5)  = rktrm*(delthm1*the3d(5)  + &
            delthm2*(the2d(5)*the1d1+the2d(3)*the1d2+the2d(2)*the1d3) + delthm3*the1d1*the1d2*the1d3)
          e3d(6)  = rktrm*(delthm1*the3d(6)  + &
            delthm2*(2.0_dp*the2d(3)*the1d3 + the2d(6)*the1d1) + delthm3*the1d1*the1d3*the1d3)
          e3d(7)  = rktrm*(delthm1*the3d(7) + &
            delthm2*3.0_dp*the2d(4)*the1d2 + delthm3*the1d2*the1d2*the1d2)
          e3d(8)  = rktrm*(delthm1*the3d(8) + &
            delthm2*(2.0_dp*the2d(5)*the1d2 + the2d(4)*the1d3) + delthm3*the1d2*the1d2*the1d3)
          e3d(9)  = rktrm*(delthm1*the3d(9) + &
            delthm2*(2.0_dp*the2d(5)*the1d3 + the2d(6)*the1d2) + delthm3*the1d2*the1d3*the1d3)
          e3d(10) = rktrm*(delthm1*the3d(10) + &
            delthm2*3.0_dp*the2d(6)*the1d3 + delthm3*the1d3*the1d3*the1d3)
!
          prd13d(1:10) = 0.0_dp
          prd23d(1:10) = 0.0_dp
          if (ipivot.eq.1) then
            if (pr1.ge.3) then
              prd1m3 = rr122*(dble(pr1*(pr1-1)*(pr1-2))*rr12*rd1**(pr1-3) - 3.0_dp*prd1m2)
            elseif (pr1.eq.2) then
              prd1m3 = - 3.0_dp*rr122*prd1m2
            elseif (pr1.eq.1) then
              prd1m3 = - 3.0_dp*rr122*prd1m2
            else
              prd1m3 = 0.0_dp
            ...
            if (pr2.ge.3) then
              prd2m3 = rr132*(dble(pr2*(pr2-1)*(pr2-2))*rr13*rd2**(pr2-3) - 3.0_dp*prd2m2)
            elseif (pr2.eq.2) then
              prd2m3 = - 3.0_dp*rr132*prd2m2
            elseif (pr2.eq.1) then
              prd2m3 = - 3.0_dp*rr132*prd2m2
            else
              prd2m3 = 0.0_dp
          ...
          elseif (ipivot.eq.2) then
            ...
            if (pr2.ge.3) then
              prd2m3 = rr232*(dble(pr2*(pr2-1)*(pr2-2))*rr23*rd2**(pr2-3) - 3.0_dp*prd2m2)
            elseif (pr2.eq.2) then
              prd2m3 = - 3.0_dp*rr232*prd2m2
            elseif (pr2.eq.1) then
              prd2m3 = - 3.0_dp*rr232*prd2m2
            else
              prd2m3 = 0.0_dp
            ...
            if (pr1.ge.3) then
              prd1m3 = rr132*(dble(pr1*(pr1-1)*(pr1-2))*rr13*rd1**(pr1-3) - 3.0_dp*prd1m2)
            elseif (pr1.eq.2) then
              prd1m3 = - 3.0_dp*rr132*prd1m2
            elseif (pr1.eq.1) then
              prd1m3 = - 3.0_dp*rr132*prd1m2
            else
              prd1m3 = 0.0_dp
          ...
          e3d(1) = e3d(1) + rkthb*((prd13d(1)*prd2 + prd1*prd23d(1) + &
                                    3.0_dp*(prd12d(1)*prd21d(1) + prd11d(1)*prd22d(1)))*ptdelth + &
                                   3.0_dp*(prd12d(1)*prd2 + prd1*prd22d(1) + &
                                    2.0_dp*prd11d(1)*prd21d(1))*delthm1*the1d1 + &
                                   3.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*the1d1*the1d1 + delthm1*the2d(1)))
          e3d(2) = e3d(2) + rkthb*((prd13d(2)*prd2 + prd1*prd23d(2) + &
                                    prd12d(1)*prd21d(2) + prd11d(2)*prd22d(1) + &
                                    2.0_dp*(prd12d(2)*prd21d(1) + prd11d(1)*prd22d(2)))*ptdelth + &
                                   (prd12d(1)*prd2 + prd1*prd22d(1) + &
                                    2.0_dp*prd11d(1)*prd21d(1))*delthm1*the1d2 + &
                                   2.0_dp*(prd12d(2)*prd2 + prd11d(1)*prd21d(2) + &
                                           prd1*prd22d(2) + prd11d(2)*prd21d(1))*delthm1*the1d1 + &
                                   2.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*the1d1*the1d2 + delthm1*the2d(2)) + &
                                   (prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*the1d1*the1d1 + delthm1*the2d(1)))
          e3d(3) = e3d(3) + rkthb*((prd13d(3)*prd2 + prd1*prd23d(3) + &
                                    prd12d(1)*prd21d(3) + prd11d(3)*prd22d(1) + &
                                    2.0_dp*(prd12d(3)*prd21d(1) + prd11d(1)*prd22d(3)))*ptdelth + &
                                   (prd12d(1)*prd2 + prd1*prd22d(1) + &
                                    2.0_dp*prd11d(1)*prd21d(1))*delthm1*the1d3 + &
                                   2.0_dp*(prd12d(3)*prd2 + prd11d(1)*prd21d(3) + &
                                           prd1*prd22d(3) + prd11d(3)*prd21d(1))*delthm1*the1d1 + &
                                   2.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*the1d1*the1d3 + delthm1*the2d(3)) + &
                                   (prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*the1d1*the1d1 + delthm1*the2d(1)))
          e3d(4) = e3d(4) + rkthb*((prd13d(4)*prd2 + prd1*prd23d(4) + &
                                    prd12d(4)*prd21d(1) + prd11d(1)*prd22d(4) + &
                                    2.0_dp*(prd12d(2)*prd21d(2) + prd11d(2)*prd22d(2)))*ptdelth + &
                                   (prd12d(4)*prd2 + prd1*prd22d(4) + &
                                    2.0_dp*prd11d(2)*prd21d(2))*delthm1*the1d1 + &
                                   2.0_dp*(prd12d(2)*prd2 + prd11d(2)*prd21d(1) + &
                                           prd1*prd22d(2) + prd11d(1)*prd21d(2))*delthm1*the1d2 + &
                                   2.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*the1d1*the1d2 + delthm1*the2d(2)) + &
                                   (prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*the1d2*the1d2 + delthm1*the2d(4)))
          e3d(5) = e3d(5) + rkthb*((prd13d(5)*prd2 + prd1*prd23d(5) + &
                                    prd12d(5)*prd21d(1) + prd11d(1)*prd22d(5) + &
                                    prd12d(3)*prd21d(2) + prd11d(2)*prd22d(3) + &
                                    prd12d(2)*prd21d(3) + prd11d(3)*prd22d(2))*ptdelth + &
                                   (prd12d(2)*prd2 + prd1*prd22d(2) + &
                                    prd11d(1)*prd21d(2) + prd11d(2)*prd21d(1))*delthm1*the1d3 + &
                                   (prd12d(3)*prd2 + prd1*prd22d(3) + &
                                    prd11d(1)*prd21d(3) + prd11d(3)*prd21d(1))*delthm1*the1d2 + &
                                   (prd12d(5)*prd2 + prd1*prd22d(5) + &
                                    prd11d(2)*prd21d(3) + prd11d(3)*prd21d(2))*delthm1*the1d1 + &
                                   (prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*the1d1*the1d3 + delthm1*the2d(3)) + &
                                   (prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*the1d2*the1d3 + delthm1*the2d(5)) + &
                                   (prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*the1d1*the1d2 + delthm1*the2d(2)))
          e3d(6) = e3d(6) + rkthb*((prd13d(6)*prd2 + prd1*prd23d(6) + &
                                    prd12d(6)*prd21d(1) + prd11d(1)*prd22d(6) + &
                                    2.0_dp*(prd12d(3)*prd21d(3) + prd11d(3)*prd22d(3)))*ptdelth + &
                                   (prd12d(6)*prd2 + prd1*prd22d(6) + &
                                    2.0_dp*prd11d(3)*prd21d(3))*delthm1*the1d1 + &
                                   2.0_dp*(prd12d(3)*prd2 + prd11d(1)*prd21d(3) + &
                                           prd1*prd22d(3) + prd11d(3)*prd21d(1))*delthm1*the1d3 + &
                                   2.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*the1d1*the1d3 + delthm1*the2d(3)) + &
                                   (prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*the1d3*the1d3 + delthm1*the2d(6)))
          e3d(7) = e3d(7) + rkthb*((prd13d(7)*prd2 + prd1*prd23d(7) + &
                                    3.0_dp*(prd12d(4)*prd21d(2) + prd11d(2)*prd22d(4)))*ptdelth + &
                                   3.0_dp*(prd12d(4)*prd2 + prd1*prd22d(4) + &
                                    2.0_dp*prd11d(2)*prd21d(2))*delthm1*the1d2 + &
                                   3.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*the1d2*the1d2 + delthm1*the2d(4)))
          e3d(8) = e3d(8) + rkthb*((prd13d(8)*prd2 + prd1*prd23d(8) + &
                                    prd12d(4)*prd21d(3) + prd11d(3)*prd22d(4) + &
                                    2.0_dp*(prd12d(5)*prd21d(2) + prd11d(2)*prd22d(5)))*ptdelth + &
                                   (prd12d(4)*prd2 + prd1*prd22d(4) + &
                                    2.0_dp*prd11d(2)*prd21d(2))*delthm1*the1d3 + &
                                   2.0_dp*(prd12d(5)*prd2 + prd11d(2)*prd21d(3) + &
                                           prd1*prd22d(5) + prd11d(3)*prd21d(2))*delthm1*the1d2 + &
                                   2.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*the1d2*the1d3 + delthm1*the2d(5)) + &
                                   (prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*the1d2*the1d2 + delthm1*the2d(4)))
          e3d(9) = e3d(9) + rkthb*((prd13d(9)*prd2 + prd1*prd23d(9) + &
                                    prd12d(6)*prd21d(2) + prd11d(2)*prd22d(6) + &
                                    2.0_dp*(prd12d(5)*prd21d(3) + prd11d(3)*prd22d(5)))*ptdelth + &
                                   (prd12d(6)*prd2 + prd1*prd22d(6) + &
                                    2.0_dp*prd11d(3)*prd21d(3))*delthm1*the1d2 + &
                                   2.0_dp*(prd12d(5)*prd2 + prd11d(2)*prd21d(3) + &
                                           prd1*prd22d(5) + prd11d(3)*prd21d(2))*delthm1*the1d3 + &
                                   2.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*the1d2*the1d3 + delthm1*the2d(5)) + &
                                   (prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*the1d3*the1d3 + delthm1*the2d(6)))
          e3d(10) = e3d(10) + rkthb*((prd13d(10)*prd2 + prd1*prd23d(10) + &
                                    3.0_dp*(prd12d(6)*prd21d(3) + prd11d(3)*prd22d(6)))*ptdelth + &
                                   3.0_dp*(prd12d(6)*prd2 + prd1*prd22d(6) + &
                                    2.0_dp*prd11d(3)*prd21d(3))*delthm1*the1d3 + &
                                   3.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*the1d3*the1d3 + delthm1*the2d(6)))
        endif
      endif
    endif
  elseif (n3ty.eq.23) then
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!  Bond - angle linear cross potential  $
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    pt  = nint(threepoly(3,nptr3))            ! Coefficient for theta
    pr1 = nint(threepoly(1,nptr3))            ! Power of distance 1
    pr2 = nint(threepoly(2,nptr3))            ! Power of distance 2
    if (ipivot.eq.1) then
      rd1 = r12 - rho1
    ...
    prd2 = rd2**pr2
    rktrm = rkthb*prd1*prd2
    cosntheta = cos(pt*thet)
    ptdelth = 1.0_dp + theta0*cosntheta
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rktrm*ptdelth
...
!  d(cosntheta)/dcostheta = sinntheta/sintheta
!
!  to avoid divide by zero error when sintheta = 0 we use a series expansion in costheta
!
      delthm1 = theta0*dble(pt)*sinratio(pt,thet)
!
      e1d1 = e1d1 + delthm1*rktrm*cos1d1
      e1d2 = e1d2 + delthm1*rktrm*cos1d2
      e1d3 = e1d3 + delthm1*rktrm*cos1d3
      if (lgrad2) then
!
!  Second derivatives
!
        delthm2 = theta0*dble(pt)*dsinratio(pt,thet)
!
        e2d(1) = rktrm*(delthm1*cos2d(1) + delthm2*cos1d1*cos1d1)
        e2d(2) = rktrm*(delthm1*cos2d(2) + delthm2*cos1d1*cos1d2)
        e2d(3) = rktrm*(delthm1*cos2d(3) + delthm2*cos1d1*cos1d3)
        e2d(4) = rktrm*(delthm1*cos2d(4) + delthm2*cos1d2*cos1d2)
        e2d(5) = rktrm*(delthm1*cos2d(5) + delthm2*cos1d2*cos1d3)
        e2d(6) = rktrm*(delthm1*cos2d(6) + delthm2*cos1d3*cos1d3)
!
        prd12d(1:6) = 0.0_dp
        prd22d(1:6) = 0.0_dp
        if (ipivot.eq.1) then
...
!
        ...
        e2d(1) = e2d(1) + rkthb*((prd12d(1)*prd2 + prd1*prd22d(1) + &
                                 2.0_dp*prd11d(1)*prd21d(1))*ptdelth + &
                                 2.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*delthm1*cos1d1)
        e2d(2) = e2d(2) + rkthb*((prd12d(2)*prd2 + prd1*prd22d(2) + &
                                 prd11d(1)*prd21d(2) + prd11d(2)*prd21d(1))*ptdelth + &
                                 (prd11d(1)*prd2 + prd1*prd21d(1))*delthm1*cos1d2 + &
                                 (prd11d(2)*prd2 + prd1*prd21d(2))*delthm1*cos1d1)
        e2d(3) = e2d(3) + rkthb*((prd12d(3)*prd2 + prd1*prd22d(3) + &
                                 prd11d(1)*prd21d(3) + prd11d(3)*prd21d(1))*ptdelth + &
                                 (prd11d(1)*prd2 + prd1*prd21d(1))*delthm1*cos1d3 + &
                                 (prd11d(3)*prd2 + prd1*prd21d(3))*delthm1*cos1d1)
        e2d(4) = e2d(4) + rkthb*((prd12d(4)*prd2 + prd1*prd22d(4) + &
                                 2.0_dp*prd11d(2)*prd21d(2))*ptdelth + &
                                 2.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*delthm1*cos1d2)
        e2d(5) = e2d(5) + rkthb*((prd12d(5)*prd2 + prd1*prd22d(5) + &
                                 prd11d(2)*prd21d(3) + prd11d(3)*prd21d(2))*ptdelth + &
                                 (prd11d(2)*prd2 + prd1*prd21d(2))*delthm1*cos1d3 + &
                                 (prd11d(3)*prd2 + prd1*prd21d(3))*delthm1*cos1d2)
        e2d(6) = e2d(6) + rkthb*((prd12d(6)*prd2 + prd1*prd22d(6) + &
                                 2.0_dp*prd11d(3)*prd21d(3))*ptdelth + &
                                 2.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*delthm1*cos1d3)
        if (lgrad3) then
!
!  Third derivatives
!
          delthm3 = theta0*dble(pt)*dsinratio2(pt,thet)
          e3d(1)  = rktrm*(delthm1*cos3d(1)  + &
            delthm2*3.0_dp*cos2d(1)*cos1d1 + delthm3*cos1d1*cos1d1*cos1d1)
          e3d(2)  = rktrm*(delthm1*cos3d(2)  + &
            delthm2*(2.0_dp*cos2d(2)*cos1d1 + cos2d(1)*cos1d2) + delthm3*cos1d1*cos1d1*cos1d2)
          e3d(3)  = rktrm*(delthm1*cos3d(3)  + &
            delthm2*(2.0_dp*cos2d(3)*cos1d1 + cos2d(1)*cos1d3) + delthm3*cos1d1*cos1d1*cos1d3)
          e3d(4)  = rktrm*(delthm1*cos3d(4)  + &
            delthm2*(2.0_dp*cos2d(2)*cos1d2 + cos2d(4)*cos1d1) + delthm3*cos1d1*cos1d2*cos1d2)
          e3d(5)  = rktrm*(delthm1*cos3d(5)  + &
            delthm2*(cos2d(5)*cos1d1+cos2d(3)*cos1d2+cos2d(2)*cos1d3) + delthm3*cos1d1*cos1d2*cos1d3)
          e3d(6)  = rktrm*(delthm1*cos3d(6)  + &
            delthm2*(2.0_dp*cos2d(3)*cos1d3 + cos2d(6)*cos1d1) + delthm3*cos1d1*cos1d3*cos1d3)
          e3d(7)  = rktrm*(delthm1*cos3d(7) + &
            delthm2*3.0_dp*cos2d(4)*cos1d2 + delthm3*cos1d2*cos1d2*cos1d2)
          e3d(8)  = rktrm*(delthm1*cos3d(8) + &
            delthm2*(2.0_dp*cos2d(5)*cos1d2 + cos2d(4)*cos1d3) + delthm3*cos1d2*cos1d2*cos1d3)
          e3d(9)  = rktrm*(delthm1*cos3d(9) + &
            delthm2*(2.0_dp*cos2d(5)*cos1d3 + cos2d(6)*cos1d2) + delthm3*cos1d2*cos1d3*cos1d3)
          e3d(10) = rktrm*(delthm1*cos3d(10) + &
            delthm2*3.0_dp*cos2d(6)*cos1d3 + delthm3*cos1d3*cos1d3*cos1d3)
!
          prd13d(1:10) = 0.0_dp
          prd23d(1:10) = 0.0_dp
          if (ipivot.eq.1) then
          ...
          e3d(1) = e3d(1) + rkthb*((prd13d(1)*prd2 + prd1*prd23d(1) + &
                                    3.0_dp*(prd12d(1)*prd21d(1) + prd11d(1)*prd22d(1)))*ptdelth + &
                                   3.0_dp*(prd12d(1)*prd2 + prd1*prd22d(1) + &
                                    2.0_dp*prd11d(1)*prd21d(1))*delthm1*cos1d1 + &
                                   3.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*cos1d1*cos1d1 + delthm1*cos2d(1)))
          e3d(2) = e3d(2) + rkthb*((prd13d(2)*prd2 + prd1*prd23d(2) + &
                                    prd12d(1)*prd21d(2) + prd11d(2)*prd22d(1) + &
                                    2.0_dp*(prd12d(2)*prd21d(1) + prd11d(1)*prd22d(2)))*ptdelth + &
                                   (prd12d(1)*prd2 + prd1*prd22d(1) + &
                                    2.0_dp*prd11d(1)*prd21d(1))*delthm1*cos1d2 + &
                                   2.0_dp*(prd12d(2)*prd2 + prd11d(1)*prd21d(2) + &
                                           prd1*prd22d(2) + prd11d(2)*prd21d(1))*delthm1*cos1d1 + &
                                   2.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*cos1d1*cos1d2 + delthm1*cos2d(2)) + &
                                   (prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*cos1d1*cos1d1 + delthm1*cos2d(1)))
          e3d(3) = e3d(3) + rkthb*((prd13d(3)*prd2 + prd1*prd23d(3) + &
                                    prd12d(1)*prd21d(3) + prd11d(3)*prd22d(1) + &
                                    2.0_dp*(prd12d(3)*prd21d(1) + prd11d(1)*prd22d(3)))*ptdelth + &
                                   (prd12d(1)*prd2 + prd1*prd22d(1) + &
                                    2.0_dp*prd11d(1)*prd21d(1))*delthm1*cos1d3 + &
                                   2.0_dp*(prd12d(3)*prd2 + prd11d(1)*prd21d(3) + &
                                           prd1*prd22d(3) + prd11d(3)*prd21d(1))*delthm1*cos1d1 + &
                                   2.0_dp*(prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*cos1d1*cos1d3 + delthm1*cos2d(3)) + &
                                   (prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*cos1d1*cos1d1 + delthm1*cos2d(1)))
          e3d(4) = e3d(4) + rkthb*((prd13d(4)*prd2 + prd1*prd23d(4) + &
                                    prd12d(4)*prd21d(1) + prd11d(1)*prd22d(4) + &
                                    2.0_dp*(prd12d(2)*prd21d(2) + prd11d(2)*prd22d(2)))*ptdelth + &
                                   (prd12d(4)*prd2 + prd1*prd22d(4) + &
                                    2.0_dp*prd11d(2)*prd21d(2))*delthm1*cos1d1 + &
                                   2.0_dp*(prd12d(2)*prd2 + prd11d(2)*prd21d(1) + &
                                           prd1*prd22d(2) + prd11d(1)*prd21d(2))*delthm1*cos1d2 + &
                                   2.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*cos1d1*cos1d2 + delthm1*cos2d(2)) + &
                                   (prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*cos1d2*cos1d2 + delthm1*cos2d(4)))
          e3d(5) = e3d(5) + rkthb*((prd13d(5)*prd2 + prd1*prd23d(5) + &
                                    prd12d(5)*prd21d(1) + prd11d(1)*prd22d(5) + &
                                    prd12d(3)*prd21d(2) + prd11d(2)*prd22d(3) + &
                                    prd12d(2)*prd21d(3) + prd11d(3)*prd22d(2))*ptdelth + &
                                   (prd12d(2)*prd2 + prd1*prd22d(2) + &
                                    prd11d(1)*prd21d(2) + prd11d(2)*prd21d(1))*delthm1*cos1d3 + &
                                   (prd12d(3)*prd2 + prd1*prd22d(3) + &
                                    prd11d(1)*prd21d(3) + prd11d(3)*prd21d(1))*delthm1*cos1d2 + &
                                   (prd12d(5)*prd2 + prd1*prd22d(5) + &
                                    prd11d(2)*prd21d(3) + prd11d(3)*prd21d(2))*delthm1*cos1d1 + &
                                   (prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*cos1d1*cos1d3 + delthm1*cos2d(3)) + &
                                   (prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*cos1d2*cos1d3 + delthm1*cos2d(5)) + &
                                   (prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*cos1d1*cos1d2 + delthm1*cos2d(2)))
          e3d(6) = e3d(6) + rkthb*((prd13d(6)*prd2 + prd1*prd23d(6) + &
                                    prd12d(6)*prd21d(1) + prd11d(1)*prd22d(6) + &
                                    2.0_dp*(prd12d(3)*prd21d(3) + prd11d(3)*prd22d(3)))*ptdelth + &
                                   (prd12d(6)*prd2 + prd1*prd22d(6) + &
                                    2.0_dp*prd11d(3)*prd21d(3))*delthm1*cos1d1 + &
                                   2.0_dp*(prd12d(3)*prd2 + prd11d(1)*prd21d(3) + &
                                           prd1*prd22d(3) + prd11d(3)*prd21d(1))*delthm1*cos1d3 + &
                                   2.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*cos1d1*cos1d3 + delthm1*cos2d(3)) + &
                                   (prd11d(1)*prd2 + prd1*prd21d(1))*(delthm2*cos1d3*cos1d3 + delthm1*cos2d(6)))
          e3d(7) = e3d(7) + rkthb*((prd13d(7)*prd2 + prd1*prd23d(7) + &
                                    3.0_dp*(prd12d(4)*prd21d(2) + prd11d(2)*prd22d(4)))*ptdelth + &
                                   3.0_dp*(prd12d(4)*prd2 + prd1*prd22d(4) + &
                                    2.0_dp*prd11d(2)*prd21d(2))*delthm1*cos1d2 + &
                                   3.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*cos1d2*cos1d2 + delthm1*cos2d(4)))
          e3d(8) = e3d(8) + rkthb*((prd13d(8)*prd2 + prd1*prd23d(8) + &
                                    prd12d(4)*prd21d(3) + prd11d(3)*prd22d(4) + &
                                    2.0_dp*(prd12d(5)*prd21d(2) + prd11d(2)*prd22d(5)))*ptdelth + &
                                   (prd12d(4)*prd2 + prd1*prd22d(4) + &
                                    2.0_dp*prd11d(2)*prd21d(2))*delthm1*cos1d3 + &
                                   2.0_dp*(prd12d(5)*prd2 + prd11d(2)*prd21d(3) + &
                                           prd1*prd22d(5) + prd11d(3)*prd21d(2))*delthm1*cos1d2 + &
                                   2.0_dp*(prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*cos1d2*cos1d3 + delthm1*cos2d(5)) + &
                                   (prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*cos1d2*cos1d2 + delthm1*cos2d(4)))
          e3d(9) = e3d(9) + rkthb*((prd13d(9)*prd2 + prd1*prd23d(9) + &
                                    prd12d(6)*prd21d(2) + prd11d(2)*prd22d(6) + &
                                    2.0_dp*(prd12d(5)*prd21d(3) + prd11d(3)*prd22d(5)))*ptdelth + &
                                   (prd12d(6)*prd2 + prd1*prd22d(6) + &
                                    2.0_dp*prd11d(3)*prd21d(3))*delthm1*cos1d2 + &
                                   2.0_dp*(prd12d(5)*prd2 + prd11d(2)*prd21d(3) + &
                                           prd1*prd22d(5) + prd11d(3)*prd21d(2))*delthm1*cos1d3 + &
                                   2.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*cos1d2*cos1d3 + delthm1*cos2d(5)) + &
                                   (prd11d(2)*prd2 + prd1*prd21d(2))*(delthm2*cos1d3*cos1d3 + delthm1*cos2d(6)))
          e3d(10) = e3d(10) + rkthb*((prd13d(10)*prd2 + prd1*prd23d(10) + &
                                    3.0_dp*(prd12d(6)*prd21d(3) + prd11d(3)*prd22d(6)))*ptdelth + &
                                   3.0_dp*(prd12d(6)*prd2 + prd1*prd22d(6) + &
                                    2.0_dp*prd11d(3)*prd21d(3))*delthm1*cos1d3 + &
                                   3.0_dp*(prd11d(3)*prd2 + prd1*prd21d(3))*(delthm2*cos1d3*cos1d3 + delthm1*cos2d(6)))
        endif
      endif
    endif
...
!$$$$$$$$$$$$$$$$$$$$$$
    ...
    delth2 = delth*delth
!
!  Set up local force constants
!
    rkf2 = rkthb*threepoly(1,nptr3)
    rkf3 = - rkf2*threepoly(2,nptr3)
    rkf4 = rkf2*threepoly(3,nptr3)*1.0d-5
    rkf5 = - rkf2*threepoly(4,nptr3)*1.0d-7
    rkf6 = rkf2*threepoly(5,nptr3)*1.0d-10
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + &
          delth2*(rkf2 + rkf3*delth + rkf4*delth2 + rkf5*delth2*delth + rkf6*delth2*delth2)
        rkf2 = rkf2*lambda
        rkf3 = rkf3*lambda
        rkf4 = rkf4*lambda
        rkf5 = rkf5*lambda
      ...
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - &
          delth2*(rkf2 + rkf3*delth + rkf4*delth2 + rkf5*delth2*delth + rkf6*delth2*delth2)
        rkf2 = rkf2*(1.0_dp - lambda)
        rkf3 = rkf3*(1.0_dp - lambda)
        rkf4 = rkf4*(1.0_dp - lambda)
        rkf5 = rkf5*(1.0_dp - lambda)
        rkf6 = rkf6*(1.0_dp - lambda)
      endif
    endif
!
    ethb = delth2*(rkf2 + rkf3*delth + rkf4*delth2 + rkf5*delth2*delth + rkf6*delth2*delth2)
    if (lgrad1) then
      if (l180) then
!
!  For angles approaching 180 degrees take series expansion of
...
!  derivatives
!
        e1 = (2.0_dp*rkf2 + 3.0_dp*rkf3*delth + 4.0_dp*rkf4*delth2 + 5.0_dp*rkf5*delth2*delth + 6.0_dp*rkf6*delth2*delth2)
        e1d1 = e1*cos1d1
        e1d2 = e1*cos1d2
        e1d3 = e1*cos1d3
        if (lgrad2) then
          e2 = (8.0_dp*rkf4 + 15.0_dp*rkf5*delth + 24.0_dp*rkf6*delth2)
!
!  Second derivatives of energy
!
          e2d(1) = e1*cos2d(1) + e2*cos1d1*cos1d1
...
!
        ...
        e1 = delth*(2.0_dp*rkf2 + 3.0_dp*rkf3*delth + 4.0_dp*rkf4*delth2 + 5.0_dp*rkf5*delth2*delth + 6.0_dp*rkf6*delth2*delth2)
!
!  First derivatives of energy
!
        e1d1 = e1*the1d1
        ...
        e1d3 = e1*the1d3
        if (lgrad2) then
          e2 = delth*(6.0_dp*rkf3 + 12.0_dp*rkf4*delth + 20.0_dp*rkf5*delth2 + 30.0_dp*rkf6*delth2*delth)
!
!  Second derivatives of energy
!
          e2d(1) = e1*the2d(1) + e2*the1d1*the1d1
          ...
          e2d(6) = e1*the2d(6) + e2*the1d3*the1d3
          if (lgrad3) then
            e3 = delth*(24.0_dp*rkf4 + 60.0_dp*rkf5*delth + 120.0_dp*rkf6*delth2)
!
!  Third derivatives of energy
!
            e3d(1) = e3*the1d1*the1d1*the1d1 + e1*the3d(1)
...
!
  ...
  elseif (n3ty.eq.25) then
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!  Stillinger-Weber 3-body - Garofalini form  $
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!
!  Construct angle based terms
!
    e0 = rkthb*((dot - theta0)*dot*sinth)**2
    if (lgrad1) then
      e1 = 2.0_dp*rkthb*((dot - theta0)*dot*sinth)
!
!  First derivatives of energy w.r.t. to angle
!
      e1_1 = (dot*sinth + (dot - theta0)*sinth)
      e1_2 = (dot - theta0)*dot
      t1d1 = e1_1*cos1d1 + e1_2*sin1d1
      t1d2 = e1_1*cos1d2 + e1_2*sin1d2
      t1d3 = e1_1*cos1d3 + e1_2*sin1d3
      a1d1 = e1*t1d1
      a1d2 = e1*t1d2
      a1d3 = e1*t1d3
      if (lgrad2) then
        ...
        e2_2 = dot + (dot - theta0)
!
        t2d(1) = e1_1*cos2d(1) + e1_2*sin2d(1) + e2_1*cos1d1*cos1d1 + &
                 e2_2*(cos1d1*sin1d1 + cos1d1*sin1d1)
        t2d(2) = e1_1*cos2d(2) + e1_2*sin2d(2) + e2_1*cos1d1*cos1d2 + &
                 e2_2*(cos1d1*sin1d2 + cos1d2*sin1d1)
        t2d(3) = e1_1*cos2d(3) + e1_2*sin2d(3) + e2_1*cos1d1*cos1d3 + &
                 e2_2*(cos1d1*sin1d3 + cos1d3*sin1d1)
        t2d(4) = e1_1*cos2d(4) + e1_2*sin2d(4) + e2_1*cos1d2*cos1d2 + &
                 e2_2*(cos1d2*sin1d2 + cos1d2*sin1d2)
        t2d(5) = e1_1*cos2d(5) + e1_2*sin2d(5) + e2_1*cos1d2*cos1d3 + &
                 e2_2*(cos1d2*sin1d3 + cos1d3*sin1d2)
        t2d(6) = e1_1*cos2d(6) + e1_2*sin2d(6) + e2_1*cos1d3*cos1d3 + &
                 e2_2*(cos1d3*sin1d3 + cos1d3*sin1d3)
!
!  Second derivatives of energy w.r.t. to angle
!
        a2d(1) = e1*t2d(1) + e2*t1d1*t1d1
        a2d(2) = e1*t2d(2) + e2*t1d1*t1d2
        a2d(3) = e1*t2d(3) + e2*t1d1*t1d3
        a2d(4) = e1*t2d(4) + e2*t1d2*t1d2
        a2d(5) = e1*t2d(5) + e2*t1d2*t1d3
        a2d(6) = e1*t2d(6) + e2*t1d3*t1d3
        if (lgrad3) then
          t3d(1)  = e1_1*cos3d(1)  + e1_2*sin3d(1) + &
                    e2_1*(3.0_dp*cos2d(1)*cos1d1) + &
                    e2_2*(3.0_dp*sin2d(1)*cos1d1) + &
                    e2_2*(3.0_dp*cos2d(1)*sin1d1) + &
                    2.0_dp*(3.0_dp*cos1d1*cos1d1*sin1d1)
          t3d(2)  = e1_1*cos3d(2)  + e1_2*sin3d(2) + &
                    e2_1*(2.0_dp*cos2d(2)*cos1d1 + cos2d(1)*cos1d2) + &
                    e2_2*(2.0_dp*sin2d(2)*cos1d1 + sin2d(1)*cos1d2) + &
                    e2_2*(2.0_dp*cos2d(2)*sin1d1 + cos2d(1)*sin1d2) + &
                    2.0_dp*(2.0_dp*cos1d1*cos1d2*sin1d1 + cos1d1*cos1d1*sin1d2)
          t3d(3)  = e1_1*cos3d(3)  + e1_2*sin3d(3) + &
                    e2_1*(2.0_dp*cos2d(3)*cos1d1 + cos2d(1)*cos1d3) + &
                    e2_2*(2.0_dp*sin2d(3)*cos1d1 + sin2d(1)*cos1d3) + &
                    e2_2*(2.0_dp*cos2d(3)*sin1d1 + cos2d(1)*sin1d3) + &
                    2.0_dp*(2.0_dp*cos1d1*cos1d3*sin1d1 + cos1d1*cos1d1*sin1d3)
          t3d(4)  = e1_1*cos3d(4)  + e1_2*sin3d(4) + &
                    e2_1*(2.0_dp*cos2d(2)*cos1d2 + cos2d(4)*cos1d1) + &
                    e2_2*(2.0_dp*sin2d(2)*cos1d2 + sin2d(4)*cos1d1) + &
                    e2_2*(2.0_dp*cos2d(2)*sin1d2 + cos2d(4)*sin1d1) + &
                    2.0_dp*(2.0_dp*cos1d1*cos1d2*sin1d2 + cos1d2*cos1d2*sin1d1)
          t3d(5)  = e1_1*cos3d(5)  + e1_2*sin3d(5) + &
                    e2_1*(cos2d(2)*cos1d3 + cos2d(3)*cos1d2 + cos2d(5)*cos1d1) + &
                    e2_2*(sin2d(2)*cos1d3 + sin2d(3)*cos1d2 + sin2d(5)*cos1d1) + &
                    e2_2*(cos2d(2)*sin1d3 + cos2d(3)*sin1d2 + cos2d(5)*sin1d1) + &
                    2.0_dp*(cos1d1*cos1d2*sin1d3 + cos1d1*cos1d3*sin1d2 + cos1d2*cos1d3*sin1d1)
          t3d(6)  = e1_1*cos3d(6)  + e1_2*sin3d(6) + &
                    e2_1*(2.0_dp*cos2d(3)*cos1d3 + cos2d(6)*cos1d1) + &
                    e2_2*(2.0_dp*sin2d(3)*cos1d3 + sin2d(6)*cos1d1) + &
                    e2_2*(2.0_dp*cos2d(3)*sin1d3 + cos2d(6)*sin1d1) + &
                    2.0_dp*(2.0_dp*cos1d1*cos1d3*sin1d3 + cos1d3*cos1d3*sin1d1)
          t3d(7)  = e1_1*cos3d(7)  + e1_2*sin3d(7) + &
                    e2_1*(3.0_dp*cos2d(4)*cos1d2) + &
                    e2_2*(3.0_dp*sin2d(4)*cos1d2) + &
                    e2_2*(3.0_dp*cos2d(4)*sin1d2) + &
                    2.0_dp*(3.0_dp*cos1d2*cos1d2*sin1d2)
          t3d(8)  = e1_1*cos3d(8)  + e1_2*sin3d(8) + &
                    e2_1*(2.0_dp*cos2d(5)*cos1d2 + cos2d(4)*cos1d3) + &
                    e2_2*(2.0_dp*sin2d(5)*cos1d2 + sin2d(4)*cos1d3) + &
                    e2_2*(2.0_dp*cos2d(5)*sin1d2 + cos2d(4)*sin1d3) + &
                    2.0_dp*(2.0_dp*cos1d2*cos1d3*sin1d2 + cos1d2*cos1d2*sin1d3)
          t3d(9)  = e1_1*cos3d(9)  + e1_2*sin3d(9) + &
                    e2_1*(2.0_dp*cos2d(5)*cos1d3 + cos2d(6)*cos1d2) + &
                    e2_2*(2.0_dp*sin2d(5)*cos1d3 + sin2d(6)*cos1d2) + &
                    e2_2*(2.0_dp*cos2d(5)*sin1d3 + cos2d(6)*sin1d2) + &
                    2.0_dp*(2.0_dp*cos1d2*cos1d3*sin1d3 + cos1d3*cos1d3*sin1d2)
          t3d(10) = e1_1*cos3d(10) + e1_2*sin3d(10) + &
                    e2_1*(3.0_dp*cos2d(6)*cos1d3) + &
                    e2_2*(3.0_dp*sin2d(6)*cos1d3) + &
                    e2_2*(3.0_dp*cos2d(6)*sin1d3) + &
                    2.0_dp*(3.0_dp*cos1d3*cos1d3*sin1d3)
!
!  Third derivatives of energy w.r.t. to angle
!
          a3d(1)  = e1*t3d(1) + 3.0_dp*e2*t2d(1)*t1d1
          a3d(2)  = e1*t3d(2) + e2*(2.0_dp*t2d(2)*t1d1 + t2d(1)*t1d2)
          a3d(3)  = e1*t3d(3) + e2*(2.0_dp*t2d(3)*t1d1 + t2d(1)*t1d3)
          a3d(4)  = e1*t3d(4) + e2*(2.0_dp*t2d(2)*t1d2 + t2d(4)*t1d1)
          a3d(5)  = e1*t3d(5) + e2*(t2d(2)*t1d3 + t2d(3)*t1d2 + t2d(5)*t1d1)
          a3d(6)  = e1*t3d(6) + e2*(2.0_dp*t2d(3)*t1d3 + t2d(6)*t1d1)
          a3d(7)  = e1*t3d(7) + 3.0_dp*e2*t2d(4)*t1d2
          a3d(8)  = e1*t3d(8) + e2*(2.0_dp*t2d(5)*t1d2 + t2d(4)*t1d3)
          a3d(9)  = e1*t3d(9) + e2*(2.0_dp*t2d(5)*t1d3 + t2d(6)*t1d2)
          a3d(10) = e1*t3d(10) + 3.0_dp*e2*t2d(6)*t1d3
        endif
      endif
    endif
!
...
!$$$$$$$$$$$$$$$$$
!
!  For this potential the product of the 3 spins for i, j and k are passed as rkthb3 - the second parameter of the potential
!
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - rkthb*rkthb3
        rkthbl = rkthb*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + rkthb*rkthb3
        rkthbl = rkthb*(1.0_dp - lambda)
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!  PPP exponential 3 - body  $
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!
!  Set up polynomial terms
!
    rc12 = 1.0_dp/(cut12 - rho1)
    rc13 = 1.0_dp/(cut13 - rho2)
    fr12 = (r12 - rho1)*rc12
    fr13 = (r13 - rho2)*rc13
    p12 = 1.0_dp - 10.0_dp*fr12**3 + 15.0_dp*fr12**4 - 6.0_dp*fr12**5
    p13 = 1.0_dp - 10.0_dp*fr13**3 + 15.0_dp*fr13**4 - 6.0_dp*fr13**5
!
!  Compute energy
!
    e0 = rkthb*exp(-r23*rho3)
    if (lti) then
      if (ltif3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) + e0*p12*p13
        e0 = e0*lambda
      elseif (ltib3body(nptr3)) then
        dUdlambda(nlambdanow) = dUdlambda(nlambdanow) - e0*p12*p13
        e0 = e0*(1.0_dp - lambda)
...
!  First derivatives
!
      d1p12 = (- 30.0_dp*fr12**2 + 60.0_dp*fr12**3 - 30.0_dp*fr12**4)*rc12
      d1p13 = (- 30.0_dp*fr13**2 + 60.0_dp*fr13**3 - 30.0_dp*fr13**4)*rc13
      t23 = rho3*rr23
!
      e1d1 =  e0*p13*d1p12*rr12
      e1d2 =  e0*p12*d1p13*rr13
      e1d3 =  - t23*e0*p12*p13
      if (lgrad2) then
!
!  Second derivatives
!
        d2p12 = (- 60.0_dp*fr12 + 180.0_dp*fr12**2 - 120.0_dp*fr12**3)*rc12**2
        d2p13 = (- 60.0_dp*fr13 + 180.0_dp*fr13**2 - 120.0_dp*fr13**3)*rc13**2
!
        e2d(1) = e0*p13*rr12*rr12*(d2p12 - d1p12*rr12)
        e2d(2) = e0*d1p12*d1p13*rr12*rr13
        e2d(3) = - e0*p13*d1p12*rr12*t23
        e2d(4) = e0*p12*rr13*rr13*(d2p13 - d1p13*rr13)
        e2d(5) = - e0*p12*d1p13*rr13*t23
        e2d(6) = t23*e0*(t23 + rr23*rr23)*p12*p13
        if (lgrad3) then
!
!  Third derivatives
!
          d3p12 = (- 60.0_dp + 360.0_dp*fr12 - 360.0_dp*fr12**2)*rc12**3
          d3p13 = (- 60.0_dp + 360.0_dp*fr13 - 360.0_dp*fr13**2)*rc13**3
!
          e3d(1) = e0*p13*rr12*rr12*rr12*(d3p12 - 3.0_dp*rr12*d2p12 + 3.0_dp*d1p12*rr12**2)
          e3d(2) = e0*d1p13*rr13*rr12*rr12*(d2p12 - d1p12*rr12)
          e3d(3) = - t23*e2d(1)
          e3d(4) = e0*d1p12*rr12*rr13*rr13*(d2p13 - d1p13*rr13)
          e3d(5) = - t23*e2d(2)
          e3d(6) = t23*e0*(t23 + rr23*rr23)*p13*d1p12*rr12
          e3d(7) = e0*p12*rr13*rr13*rr13*(d3p13 - 3.0_dp*rr13*d2p13 + 3.0_dp*d1p13*rr13**2)
          e3d(8) = - t23*e2d(4)
          e3d(9) = t23*e0*(t23 + rr23*rr23)*p12*d1p13*rr13 
          e3d(10) = - t23*t23*t23*e0*p12*p13 - 3.0_dp*rr23*rr23*e2d(6)
        endif
      endif
    endif
  endif
#ifdef TRACE
  call trace_out('threebody')
#endif
!
  return
  end
