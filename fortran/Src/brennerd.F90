...
!
          if (lgrad1) then
            ...
            if (lgrad2) then
              if (ldophonon) then
                call d2addpdm(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nREBOatomRptr,d1j,d2j,xkv,ykv,zkv, &
                              .true.,.false.)
              else
                call d2adddm(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,d1j,d2j, &
                             .true.,.false.)
              endif
            endif
          endif
...
!
    if (lgrad1) then
      ...
      if (lgrad2) then
        if (ldophonon) then
          call d2addpdm(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nREBOatomRptr,d1i,d2i,xkv,ykv,zkv,.true.,.false.)
        else
          call d2adddm(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,d1i,d2i,.true.,.false.)
        endif
      endif
    endif
  enddo
