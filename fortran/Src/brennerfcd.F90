...
!
        call d2addfcd(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,nREBOatomRptr,d1j,d2j,.true.)
!
...
!
    call d2addfcd(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,nREBOatomRptr,d1i,d2i,.true.)
  enddo
!
!  Free local memory
!
