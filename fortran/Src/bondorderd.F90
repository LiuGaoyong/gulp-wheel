...
!   5/23 lextended argument added to d2adddm calls
...
!
    if (lgrad1) then
      ...
      if (lgrad2) then
        if (ldophonon) then
          call d2addpdm(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nboatomRptr,d1i,d2i,xkv,ykv,zkv,.false.,.false.)
        else
          call d2adddm(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nboatomRptr,d1i,d2i,.false.,.false.)
        endif
      endif
    endif
  enddo
