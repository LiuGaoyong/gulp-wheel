...
!   7/21 Use of asymmetric matrix used in charge solve for QEq case
...
!   9/23 Check atomic number to exclude shells
!
!  Conditions of use:
!
...
!
      if (lsymopt) then
        call dbcgsolve(neem+1_i4,neem+1_i4,nlocptr,emat,nmax,z,qf,qitertol,nqitermax,iter,err)
      else
        call dcgsolve(neem+1_i4,neem+1_i4,nlocptr,emat,nmax,z,qf,qitertol,nqitermax,iter,err)
      endif
!
      if (ioproc) then
...
!******************
      ...
      call matrix_inversion_library(n,1_i4,nmax,nblocksize,emat,0_i4,lsymmetric,ifail)
!
