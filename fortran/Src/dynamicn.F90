...
!   2/18 Trace added
!   7/23 inbox coordinates changed when finite differencing
!   7/23 lupdateinbox turned off during finite differencing
!
!  Conditions of use:
!
...
#endif
!
!  Turn off updating of inbox coordinates
!
  lsaveupdateinbox = lupdateinbox
  lupdateinbox = .false.
!*****************************
...
!
!  Restore updating of inbox coordinates
!
  lupdateinbox = lsaveupdateinbox
#ifdef TRACE
