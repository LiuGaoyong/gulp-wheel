...
!  12/17 Symmetrisation of reciprocal space second derivatives added
!   2/18 Trace added
...
!
          ...
          rk2 = xxk2 + yyk2
!
!  Test for zero wavevector and exclude vectors outside the search region, given by rradmx.
!
...
!
  ...
  if (lgroupvelocity) then
    ...
    if (status/=0) call outofmemory('recip2Dp','ktrmdk')
  endif
!
...
!
  if (lgroupvelocity) then
    ...
    if (status/=0) call deallocate_error('recip2Dp','ktrmdk')
  endif
