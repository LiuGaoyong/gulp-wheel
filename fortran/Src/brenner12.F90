...
!       
    ...
    if (status/=0) call deallocate_error('brenner12','natneighno')
...
!
  ...
  if (status/=0) call outofmemory('brenner12','natneighno')
      ...
      if (lgrad1) then
        ...
        if (lgrad2) then
          if (ldsl) then
            ...
            call d2addd(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,nr1,d1j,d2j,.true.)
          endif
        endif
      endif
!
    ...
    if (lgrad1) then
      ...
      if (lgrad2) then
        if (ldsl) then
          ...
          call d2addd(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,nr1,d1i,d2i,.true.)
        endif
      endif
    endif
  enddo
