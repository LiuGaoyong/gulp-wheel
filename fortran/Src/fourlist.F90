  subroutine fourlist(efor,eoop,eimp,lgrad1)
!
...
!   3/16 eimp added to argument list
...
!*****************************
  do mm = procid+1,nlist4md,nprocs
    ...
    elseif (nfortype.eq.15) then
      ...
      fpoly(2) = forpoly(2,n)
      fpoly(3) = forpoly(3,n)
    elseif (nfortype.eq.14.or.nfortype.eq.16) then
