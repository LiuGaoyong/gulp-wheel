...
!
    do i = 1,nreg1
      ...
      zdefe(i) = zperf(i)
      qdefe(i) = qp(i)
      radefe(i) = radcfg(nrelf2a(npsite(i)) + nsft)
      occdefe(i) = occp(i)
      natdefe(i) = natp(i)
      ntypdefe(i) = ntypep(i)
      ldefbsmat(i) = lbsmat(nrelf2a(npsite(i)))
      ldqmatom(nreg1) = .false.
      if (lmol) then
...
!
    ...
    do i = 1,nreg1cfg(ncf)
      ...
      idoptindex(ind+1) = idoptcfg(1,ndind+i)
      idoptindex(ind+2) = idoptcfg(2,ndind+i)
      idoptindex(ind+3) = idoptcfg(3,ndind+i)
      ind = ind + 3
