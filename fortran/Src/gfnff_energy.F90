  subroutine gfnff_energy(egfnff,lgrad1,lgrad2)
!
...
!   2/21 Cutoff no longer passed to coordination number routines
!   3/21 Second derivatives for long-range repulsion corrected
!   4/21 Energy format for output changed
!   4/21 Tapering of angle approach to linear added
...
!   9/23 gfnff_cn called with lgrad1 true if ldcharge is true
!
!  Conditions of use:
!
...
!
  use datatypes
  use configurations, only : nregions, lsliceatom, lregionrigid
  use control,        only : keyword, lseok, ldcharge
  use current
  use derivatives
  use EDIPdata
...
!****************************************
  call gfnff_cn(numat,gfnff_cnthr,cn,dcn,d2cn,lgrad1.or.ldcharge,lgrad2)
!*********************************************************
...
!
            call gfnff_drv2_dcn(i,j,xji,yji,zji,deijdcni,deijdcnj,d2eijdcni2,d2eijdcnj2,d2eijdcnidcnj, &
...
!
            derv2(jx,ix) = derv2(jx,ix) - d2eijddr2*d2r2dx2(1)
            derv2(jy,ix) = derv2(jy,ix) - d2eijddr2*d2r2dx2(6)
            derv2(jz,ix) = derv2(jz,ix) - d2eijddr2*d2r2dx2(5)
            derv2(jx,iy) = derv2(jx,iy) - d2eijddr2*d2r2dx2(6)
            derv2(jy,iy) = derv2(jy,iy) - d2eijddr2*d2r2dx2(2)
            derv2(jz,iy) = derv2(jz,iy) - d2eijddr2*d2r2dx2(4)
            derv2(jx,iz) = derv2(jx,iz) - d2eijddr2*d2r2dx2(5)
            derv2(jy,iz) = derv2(jy,iz) - d2eijddr2*d2r2dx2(4)
            derv2(jz,iz) = derv2(jz,iz) - d2eijddr2*d2r2dx2(3)
...
!
          ...
          if (lgrad2) then
            ...
            d2eijdcnhdr = dtrm/r
            call gfnff_drv2_dcn_hb(hbH,i,j,xji,yji,zji,deijdcnh,d2eijdcnh2,d2eijdcnhdr,d2eijdcnhdcni, &
...
!
              derv2(ix,jx) = derv2(ix,jx) - d2eijdr2*d2r2dx2(1)
              derv2(iy,jx) = derv2(iy,jx) - d2eijdr2*d2r2dx2(6)
              derv2(iz,jx) = derv2(iz,jx) - d2eijdr2*d2r2dx2(5)
              derv2(ix,jy) = derv2(ix,jy) - d2eijdr2*d2r2dx2(6)
              derv2(iy,jy) = derv2(iy,jy) - d2eijdr2*d2r2dx2(2)
              derv2(iz,jy) = derv2(iz,jy) - d2eijdr2*d2r2dx2(4)
              derv2(ix,jz) = derv2(ix,jz) - d2eijdr2*d2r2dx2(5)
              derv2(iy,jz) = derv2(iy,jz) - d2eijdr2*d2r2dx2(4)
              derv2(iz,jz) = derv2(iz,jz) - d2eijdr2*d2r2dx2(3)
...
!
            ...
            if (lgrad2) then
              ...
              if (abs(d2eijdcnidrij).gt.gfnff_cnc6tol.or.abs(d2eijdcnjdrij).gt.gfnff_cnc6tol) then
                call gfnff_drv2_dcn_x(i,j,xji,yji,zji,d2eijdcnidrij,d2eijdcnjdrij,dcn,lgrad2)
              endif
            endif
          endif
        endif
...
!
      ...
      enddo
!
!  Collective derivatives over sum
!
!  Coordination number derivatives of c6
!
      if (lgrad2) then
...
!
        if (abs(d2eijdcni2).gt.gfnff_cnc6tol.or.abs(d2eijdcnj2).gt.gfnff_cnc6tol) then
          call gfnff_drv2_dcn_nox(i,j,deijdcni,deijdcnj,d2eijdcni2,d2eijdcnj2,d2eijdcnidcnj, &
                                  dcn,d2cn,lgrad2)
        else
          call gfnff_drv_dcn(i,deijdcni,cn,dcn)
          call gfnff_drv_dcn(j,deijdcnj,cn,dcn)
...
!
        d2trm = dampik*(dampij*(d2eijkdcos2*dcosdrij**2 + deijkdcos*d2cosdrij2) + 2.0_dp*ddampij*deijkdcos*dcosdrij + &
                d2dampij*eijknodamp)
        call add_drv2_1(ix,iy,iz,jx,jy,jz,vij(1),vij(2),vij(3),deijkdrij,d2trm,dr2ds6(1,1),d2r2dx26(1,1), &
                        d2r2ds26(1,1,1),d2r2dsdx6(1,1,1))
!
!  i-j / i-k
!
        ...
        call add_drv2_2(ix,iy,iz,jx,jy,jz,ix,iy,iz,kx,ky,kz,vij(1),vij(2),vij(3),vik(1),vik(2),vik(3),d2trm, &
                        dr2ds6(1,1),dr2ds6(1,2))
!
!  i-j / j-k
!
        d2trm = dampij*dampik*(d2eijkdcos2*dcosdrij*dcosdrjk + deijkdcos*d2cosdrijdrjk) + &
                dampik*ddampij*deijkdcos*dcosdrjk
        call add_drv2_2(ix,iy,iz,jx,jy,jz,jx,jy,jz,kx,ky,kz,vij(1),vij(2),vij(3),vjk(1),vjk(2),vjk(3),d2trm, &
                        dr2ds6(1,1),dr2ds6(1,3))
!
!  i-k / i-k
!
        d2trm = dampij*(dampik*(d2eijkdcos2*dcosdrik**2 + deijkdcos*d2cosdrik2) + 2.0_dp*ddampik*deijkdcos*dcosdrik + &
                d2dampik*eijknodamp)
        call add_drv2_1(ix,iy,iz,kx,ky,kz,vik(1),vik(2),vik(3),deijkdrik,d2trm,dr2ds6(1,2),d2r2dx26(1,2), &
                        d2r2ds26(1,1,2),d2r2dsdx6(1,1,2))
!
!  i-k / j-k
!
        d2trm = dampij*dampik*(d2eijkdcos2*dcosdrik*dcosdrjk + deijkdcos*d2cosdrikdrjk) + &
                dampij*ddampik*deijkdcos*dcosdrjk
        call add_drv2_2(ix,iy,iz,kx,ky,kz,jx,jy,jz,kx,ky,kz,vik(1),vik(2),vik(3),vjk(1),vjk(2),vjk(3),d2trm, &
                        dr2ds6(1,2),dr2ds6(1,3))
!
!  j-k / j-k
!
        d2trm = dampij*dampik*d2eijkdcos2*dcosdrjk**2
        call add_drv2_1(jx,jy,jz,kx,ky,kz,vjk(1),vjk(2),vjk(3),deijkdrjk,d2trm,dr2ds6(1,3),d2r2dx26(1,3), &
                        d2r2ds26(1,1,3),d2r2dsdx6(1,1,3))
      endif
    endif
  enddo
!
      ...
      if (lgrad2) then
        ...
        do ii = 1,6
          do jj = ii,6
            ind = ind + 1
            if (ii.eq.jj) then
              call add_drv2_1(indx(1,ii),indy(1,ii),indz(1,ii),indx(2,ii),indy(2,ii),indz(2,ii),xv4(ii),yv4(ii),zv4(ii), &
                              e1d(ii),e2d(ind),dr2ds6(1,ii),d2r2dx26(1,ii),d2r2ds26(1,1,ii),d2r2dsdx6(1,1,ii))
            else
              call add_drv2_2(indx(1,ii),indy(1,ii),indz(1,ii),indx(2,ii),indy(2,ii),indz(2,ii), &
                              indx(1,jj),indy(1,jj),indz(1,jj),indx(2,jj),indy(2,jj),indz(2,jj), &
                              xv4(ii),yv4(ii),zv4(ii),xv4(jj),yv4(jj),zv4(jj),e2d(ind),dr2ds6(1,ii),dr2ds6(1,jj))
            endif
          enddo
        enddo
      endif
...
!  i-j / i-j
!
        call add_drv2_1b(ix,iy,iz,jx,jy,jz,d1trm,d2trm,phi1dx(1,1),phi1ds,phi2dx(1,1,1),phi2dsdx(1,1,1))
!
!  i-j / j-k
!
        call add_drv2_2b(ix,iy,iz,jx,jy,jz,jx,jy,jz,kx,ky,kz,d1trm,d2trm,phi1dx(1,1),phi1dx(1,2),phi2dx(1,1,2))
!
!  i-j / i-l
!
        call add_drv2_2b(ix,iy,iz,jx,jy,jz,ix,iy,iz,lx,ly,lz,d1trm,d2trm,phi1dx(1,1),phi1dx(1,3),phi2dx(1,1,3))
!
!  j-k / j-k
!
        call add_drv2_1b(jx,jy,jz,kx,ky,kz,d1trm,d2trm,phi1dx(1,2),phi1ds,phi2dx(1,1,4),phi2dsdx(1,1,2))
!
!  j-k / i-l
!
        call add_drv2_2b(jx,jy,jz,kx,ky,kz,ix,iy,iz,lx,ly,lz,d1trm,d2trm,phi1dx(1,2),phi1dx(1,3),phi2dx(1,1,5))
!
!  i-l / i-l
!
        call add_drv2_1b(ix,iy,iz,lx,ly,lz,d1trm,d2trm,phi1dx(1,3),phi1ds,phi2dx(1,1,6),phi2dsdx(1,1,3))
!
        if (lstr) then
!
!  Strain-strain
...
!
        ...
        call add_drv2_1(ix,iy,iz,jx,jy,jz,vij(1),vij(2),vij(3),deijkldrij,d2trm,dr2ds6(1,1),d2r2dx26(1,1), &
                        d2r2ds26(1,1,1),d2r2dsdx6(1,1,1))
!
!  i-j / j-k
!
...
!
        ...
        call add_drv2_2(ix,iy,iz,jx,jy,jz,jx,jy,jz,lx,ly,lz,vij(1),vij(2),vij(3),vjl(1),vjl(2),vjl(3),d2trm, &
                        dr2ds6(1,1),dr2ds6(1,3))
!
!  j-k / j-k
!
        d2trm = eijklnod*dampij*d2dampjk*dampjl
        call add_drv2_1(jx,jy,jz,kx,ky,kz,vjk(1),vjk(2),vjk(3),deijkldrjk,d2trm,dr2ds6(1,2),d2r2dx26(1,2), &
                        d2r2ds26(1,1,2),d2r2dsdx6(1,1,2))
!
!  j-k / j-l
!
        d2trm = eijklnod*dampij*ddampjk*ddampjl
        call add_drv2_2(jx,jy,jz,kx,ky,kz,jx,jy,jz,lx,ly,lz,vjk(1),vjk(2),vjk(3),vjl(1),vjl(2),vjl(3),d2trm, &
                        dr2ds6(1,2),dr2ds6(1,3))
!
!  j-l / j-l
!
        d2trm = eijklnod*dampij*dampjk*d2dampjl
        call add_drv2_1(jx,jy,jz,lx,ly,lz,vjl(1),vjl(2),vjl(3),deijkldrjl,d2trm,dr2ds6(1,3),d2r2dx26(1,3), &
                        d2r2ds26(1,1,3),d2r2dsdx6(1,1,3))
!---------------------------------------------------------------
...
!
        ...
        enddo
        call add_drv2_1bx(ix,iy,iz,jx,jy,jz,d2trm,phi1dx(1,1),vij,dtmps2,dtmps)
!
!  j-k / i-j
!
        call add_drv2_2bx(jx,jy,jz,kx,ky,kz,ix,iy,iz,jx,jy,jz,d2trm,phi1dx(1,2),vij,dtmps2,dtmps)
!
!  i-l / i-j
!
        call add_drv2_2bx(ix,iy,iz,lx,ly,lz,ix,iy,iz,jx,jy,jz,d2trm,phi1dx(1,3),vij,dtmps2,dtmps)
!
!  i-j / j-k
!
        ...
        enddo
        call add_drv2_2bx(ix,iy,iz,jx,jy,jz,jx,jy,jz,kx,ky,kz,d2trm,phi1dx(1,1),vjk,dtmps2,dtmps)
!
!  j-k / j-k
!
        call add_drv2_1bx(jx,jy,jz,kx,ky,kz,d2trm,phi1dx(1,2),vjk,dtmps2,dtmps)
!
!  i-l / j-k
!
        call add_drv2_2bx(ix,iy,iz,lx,ly,lz,jx,jy,jz,kx,ky,kz,d2trm,phi1dx(1,3),vjk,dtmps2,dtmps)
!
!  i-j / j-l
!
        ...
        enddo
        call add_drv2_2bx(ix,iy,iz,jx,jy,jz,jx,jy,jz,lx,ly,lz,d2trm,phi1dx(1,1),vjl,dtmps2,dtmps)
!
!  j-k / j-l
!
        call add_drv2_2bx(jx,jy,jz,kx,ky,kz,jx,jy,jz,lx,ly,lz,d2trm,phi1dx(1,2),vjl,dtmps2,dtmps)
!
!  i-l / j-l
!
        call add_drv2_2bx(ix,iy,iz,lx,ly,lz,jx,jy,jz,lx,ly,lz,d2trm,phi1dx(1,3),vjl,dtmps2,dtmps)
      endif
    endif
  enddo
!
...
!
          call add_drv2_1(ix,iy,iz,jx,jy,jz,xbnbr(ni,i),ybnbr(ni,i),zbnbr(ni,i),deijkdrij,d2trm,dr2ds6(1,1),d2r2dx26(1,1), &
                          d2r2ds26(1,1,1),d2r2dsdx6(1,1,1))
!
!  i-j / i-l
!
...
!
          call add_drv2_2(ix,iy,iz,jx,jy,jz,ix,iy,iz,lx,ly,lz,xbnbr(ni,i),ybnbr(ni,i),zbnbr(ni,i),vil(1),vil(2),vil(3),d2trm, &
                          dr2ds6(1,1),dr2ds6(1,2))
!
!  i-j / j-l
!
...
!
          call add_drv2_2(ix,iy,iz,jx,jy,jz,jx,jy,jz,lx,ly,lz,xbnbr(ni,i),ybnbr(ni,i),zbnbr(ni,i),vjl(1),vjl(2),vjl(3),d2trm, &
                          dr2ds6(1,1),dr2ds6(1,3))
!
!  i-l / i-l
!
...
!
          call add_drv2_1(ix,iy,iz,lx,ly,lz,vil(1),vil(2),vil(3),deijkdril,d2trm,dr2ds6(1,2),d2r2dx26(1,2), &
                          d2r2ds26(1,1,2),d2r2dsdx6(1,1,2))
!
!  i-l / j-l
!
...
!
          call add_drv2_2(ix,iy,iz,lx,ly,lz,jx,jy,jz,lx,ly,lz,vil(1),vil(2),vil(3),vjl(1),vjl(2),vjl(3),d2trm, &
                          dr2ds6(1,2),dr2ds6(1,3))
!
!  j-l / j-l
!
...
!
          call add_drv2_1(jx,jy,jz,lx,ly,lz,vjl(1),vjl(2),vjl(3),deijkdrjl,d2trm,dr2ds6(1,3),d2r2dx26(1,3), &
                          d2r2ds26(1,1,3),d2r2dsdx6(1,1,3))
...
!
          d2trm = 9.0_dp*eijk*rij*ril*rrij3*rril3 &
                  ...
                  + (3.0_dp*c9*rrijk9)*(d2cos1(2)*cos2*cos3 + cos1*d2cos2(2)*cos3 + cos1*cos2*d2cos3(2) &
                                       ...
                                       + dcos3drij*(dcos1dril*cos2 + cos1*dcos2dril))
!
          call add_drv2_2(ix,iy,iz,jx,jy,jz,ix,iy,iz,lx,ly,lz,vij(1),vij(2),vij(3),vil(1),vil(2),vil(3),d2trm, &
                          dr2ds6(1,1),dr2ds6(1,2))
!
!  i-j / l-j
!
          d2trm = 9.0_dp*eijk*rij*rjl*rrij3*rrjl3 &
                  ...
                  + (3.0_dp*c9*rrijk9)*(d2cos1(3)*cos2*cos3 + cos1*d2cos2(3)*cos3 + cos1*cos2*d2cos3(3) &
                                       ...
                                       + dcos3drij*(dcos1drjl*cos2 + cos1*dcos2drjl))
!
          call add_drv2_2(ix,iy,iz,jx,jy,jz,lx,ly,lz,jx,jy,jz,vij(1),vij(2),vij(3),xbnbr(nl,l),ybnbr(nl,l),zbnbr(nl,l),d2trm, &
                          dr2ds6(1,1),dr2ds6(1,3))
!
!  i-l / i-l
!
...
!
          d2trm = 9.0_dp*eijk*ril*rjl*rril3*rrjl3 &
                  ...
                  + (3.0_dp*c9*rrijk9)*(d2cos1(5)*cos2*cos3 + cos1*d2cos2(5)*cos3 + cos1*cos2*d2cos3(5) &
                                       ...
                                       + dcos3dril*(dcos1drjl*cos2 + cos1*dcos2drjl))
!
          call add_drv2_2(ix,iy,iz,lx,ly,lz,lx,ly,lz,jx,jy,jz,vil(1),vil(2),vil(3),xbnbr(nl,l),ybnbr(nl,l),zbnbr(nl,l),d2trm, &
                          dr2ds6(1,2),dr2ds6(1,3))
!
!  j-l / j-l
!
          d2trm = eijk*rrjl3*(18.0_dp*rrjl3*rjl2 - 3.0_dp*rrjl) &
                  ...
                  + (3.0_dp*c9*rrijk9)*(d2cos1(6)*cos2*cos3 + cos1*d2cos2(6)*cos3 + cos1*cos2*d2cos3(6) &
                                       ...
                                       + dcos3drjl*(dcos1drjl*cos2 + cos1*dcos2drjl))
!
          call add_drv2_1(lx,ly,lz,jx,jy,jz,xbnbr(nl,l),ybnbr(nl,l),zbnbr(nl,l),deijkdrjl,d2trm,dr2ds6(1,3),d2r2dx26(1,3), &
                          d2r2ds26(1,1,3),d2r2dsdx6(1,1,3))
...
!*********************************
  call gfnff_ehb(ehb,exb,nnbr_bond,maxnbr,nbrno_bond,rbnbr,xbnbr,ybnbr,zbnbr,lgrad1,lgrad2)
!
  if (lverbose) then 
    time3 = g_cpu_time()
...
!
  ...
  if (lverbose) then
    if (ioproc) then
      ...
      write(ioout,'(''  TOTAL          '',1x,f14.6,'' eV '',1x,f16.8,'' au'',/)') egfnff,egfnff/gfnff_autoev
    endif
  endif
!
