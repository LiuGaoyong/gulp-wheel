...
!   1/22 Call to d2charge_finish moved to dynamic
!   1/22 lDoSelf added to d2chargep arguments
!  12/22 m_qderiv added
!   5/23 lupper argument added to d2chargep
...
!
        ...
        if (leem.or.lgfnff) then
          ...
          elseif (lgfnff) then
            ...
            call gfnffbody(eqeq,zetaij,.true.,.true.,nor,1_i4,fct,qli,qlj)
          endif
        endif
!
