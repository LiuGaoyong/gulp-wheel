...
!
    ...
    if (status/=0) call deallocate_error('brennersd2','ineigh')
...
!
  ...
  if (status/=0) call outofmemory('brennersd2','ineigh')
...
!
      if (lgrad1) then
        call d1adds(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,nauatom,neqv,d1j,.true.,.false.)
        if (lgrad2) then
          call d2adds(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nfreeatomau,nREBOatomRptr,nauatom, &
                      neqv,d1j,d2j,.true.)
        endif
      endif
!
...
!
    if (lgrad1) then
      call d1adds(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,nauatom,neqv,d1i,.true.,.false.)
      if (lgrad2) then
        call d2adds(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nfreeatomau,nREBOatomRptr,nauatom, &
                    neqv,d1i,d2i,.true.)
      endif
    endif
  enddo
