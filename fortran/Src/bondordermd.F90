...
!
        eregion2region(nregioni,nregioni) = eregion2region(nregioni,nregioni) + BOecoeffZ(nboZi)
!
        siteenergy(i) = siteenergy(i) + BOecoeffZ(nboZi)
      endif
    endif
!
