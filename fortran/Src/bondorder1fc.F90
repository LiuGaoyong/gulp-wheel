...
!   7/23 lextended added to d1addfc
              ...
              if (lBOgikR(nboRij)) then
                ...
                if (nBOtypeR(nboRij).ne.1) then
                  call GthetaBO(xji,yji,zji,xki,yki,zki,nBOtypeR(nboRij),BOccoeffR(1,nboRij), &
                    BOhcoeffR(nboRij),Gijk,dGijkdr,d2Gijkdr2,d3Gijkdr3,.true.,.false.,.false.)
                else
                  Gijk = 1.0_dp
                  dGijkdr = 0.0_dp
                  d2Gijkdr2 = 0.0_dp
              ...
              if (lBOgikA(nboAij)) then
                ...
                if (nBOtypeA(nboAij).ne.1) then
                  call GthetaBO(xji,yji,zji,xki,yki,zki,nBOtypeA(nboAij),BOccoeffA(1,nboAij), &
                    BOhcoeffA(nboAij),Gijk,dGijkdr,d2Gijkdr2,d3Gijkdr3,.true.,.false.,.false.)
                else
                  Gijk = 1.0_dp
                  dGijkdr = 0.0_dp
                  d2Gijkdr2 = 0.0_dp
...
!
    call d1addfc(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,maxlhs,d1cell,matom,nboatomRptr,d1i,.false.,.false.)
  enddo
  if (nboZ.gt.0) then
!**************************************
...
!
          call d1addfc(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh, &
                       maxlhs,d1cell,matom,nboatomRptr,d1i,.false.,.false.)
!
