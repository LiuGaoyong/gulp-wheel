  subroutine foursd(efor,eoop,eimp,lgrad1)
!
...
!   7/13 Impropers moved to a separate subroutine
!   2/18 Trace added
...
!  Improper potentials  *
!************************
  if (nimproper.gt.0) call fourimpsd(eimp,lgrad1)
!
!  Timing
!
  time2 = g_cpu_time()
