...
!   4/16 New non-lower half triangular algorithm implemented.
!   4/16 Error in referencing region 2 type fixed
...
!
  ...
  if (status/=0) call outofmemory('bondorder12','Zcn')
!
    ...
    if (lgrad1) then
      ...
      if (lgrad2) then
        if (ldsl) then
          ...
          call d2addd(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nboatomRptr,nr1,d1i,d2i,.false.)
        endif
      endif
    endif
  enddo
...
!
    if (lgrad2) then
      ...
      if (status/=0) call outofmemory('bondorder12','d1ZiCN')
    endif
!**************************************
...
!
          ...
          if (lgrad2) then
            if (ldsl) then
              ...
              call d2addd(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nboatomRptr,nr1,d1i,d2i, &
                .false.)
            endif
          endif
!
...
!
    if (lgrad2) then
      ...
      if (status/=0) call deallocate_error('bondorder12','d1ZiCN')
    endif
  endif
!
!  Free local memory
!
  ...
  if (status/=0) call deallocate_error('bondorder12','Zcn')
