  subroutine foursd2(efor,eoop,eimp,lgrad1,lgrad2)
!
...
!   3/15 Reference to lopi changed to lopj for lasu2
...
!  Improper potentials  *
!************************
  if (nimproper.gt.0) call fourimpsd2(eimp,lgrad1,lgrad2)
!
!  Timing
!
  time2 = g_cpu_time()
