  subroutine threepd(xkv,ykv,zkv)
!
...
!
  use g_constants
  use control,        only : lDoQDeriv2, lgroupvelocity, lrigid
  use current
  use derivatives
  use m_qderiv,       only : d2charge3p
  use m_three
  use molecule
  use parallel
  use times
...
!
  ...
  if (status/=0) call outofmemory('threepd','lijdone')
  allocate(nuniquejptr(numat),stat=status)
  if (status/=0) call outofmemory('threepd','nuniquejptr')
  allocate(xvec(maxvector),stat=status)
  if (status/=0) call outofmemory('threepd','xvec')
  allocate(yvec(maxvector),stat=status)
  if (status/=0) call outofmemory('threepd','yvec')
  allocate(zvec(maxvector),stat=status)
  if (status/=0) call outofmemory('threepd','zvec')
!
...
!
      ...
      if (status/=0) call deallocate_error('threepd','zvec')
      deallocate(yvec,stat=status)
      if (status/=0) call deallocate_error('threepd','yvec')
      deallocate(xvec,stat=status)
      if (status/=0) call deallocate_error('threepd','xvec')
...
!
              ...
              cos12 = xkv*x21c + ykv*y21c + zkv*z21c
              sin12 = sin(cos12)
              cos12 = cos(cos12) - oneij
              cos13 = xkv*x31c + ykv*y31c + zkv*z31c
              sin13 = sin(cos13)
              cos13 = cos(cos13) - oneik
              cos23 = xkv*x32c + ykv*y32c + zkv*z32c
              sin23 = sin(cos23)
...
!
                  d2k  = ed11*cos12
                  d2ks = ed11*sin12
                  cdk12(1) = dcmplx(d2k*x21c,d2ks*x21c)*dcmplx(0.0_dp,1.0_dp)
                  cdk12(2) = dcmplx(d2k*y21c,d2ks*y21c)*dcmplx(0.0_dp,1.0_dp)
                  cdk12(3) = dcmplx(d2k*z21c,d2ks*z21c)*dcmplx(0.0_dp,1.0_dp)
!
                  d2k  = ed12*cos13
                  d2ks = ed12*sin13
                  cdk13(1) = dcmplx(d2k*x31c,d2ks*x31c)*dcmplx(0.0_dp,1.0_dp)
                  cdk13(2) = dcmplx(d2k*y31c,d2ks*y31c)*dcmplx(0.0_dp,1.0_dp)
                  cdk13(3) = dcmplx(d2k*z31c,d2ks*z31c)*dcmplx(0.0_dp,1.0_dp)
!
                  derv2dk(1:3,n21,n11) = derv2dk(1:3,n21,n11) - cdk12(1:3)
                  derv2dk(1:3,n31,n11) = derv2dk(1:3,n31,n11) - cdk13(1:3)
                endif
!
...
!
                    ...
                    cdk12(3) = dcmplx(d2k*z21c,d2ks*z21c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n22,n11) = derv2dk(1:3,n22,n11) + cdk12(1:3)
!
                    d2k  = trm11*cos12
                    d2ks = trm11*sin12
                    cdk12(1) = dcmplx(d2k*x21c,d2ks*x21c)*dcmplx(0.0_dp,1.0_dp)
                    ...
                    cdk12(3) = dcmplx(d2k*z21c,d2ks*z21c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n21,n12) = derv2dk(1:3,n21,n12) - cdk12(1:3)
                  endif
!
...
!
                    ...
                    cdk13(3) = dcmplx(d2k*z31c,d2ks*z31c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n32,n11) = derv2dk(1:3,n32,n11) + cdk13(1:3)
                  endif
                enddo
              enddo
!
...
!
                  d2k  = ed13*cos23
                  d2ks = ed13*sin23
                  cdk23(1) = dcmplx(d2k*x32c,d2ks*x32c)*dcmplx(0.0_dp,1.0_dp)
                  cdk23(2) = dcmplx(d2k*y32c,d2ks*y32c)*dcmplx(0.0_dp,1.0_dp)
                  cdk23(3) = dcmplx(d2k*z32c,d2ks*z32c)*dcmplx(0.0_dp,1.0_dp)
!
                  derv2dk(1:3,n11,n21) = derv2dk(1:3,n11,n21) - conjg(cdk12(1:3))
                  derv2dk(1:3,n31,n21) = derv2dk(1:3,n31,n21) - cdk23(1:3)
                endif
!
!  Inner loop over cartesian coordinates
!
...
!
                    ...
                    cdk12(3) = dcmplx(d2k*z21c,d2ks*z21c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n11,n22) = derv2dk(1:3,n11,n22) + conjg(cdk12(1:3))
!
                    d2k  = trm11*cos12
                    d2ks = trm11*sin12
                    cdk12(1) = dcmplx(d2k*x21c,d2ks*x21c)*dcmplx(0.0_dp,1.0_dp)
                    ...
                    cdk12(3) = dcmplx(d2k*z21c,d2ks*z21c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n12,n21) = derv2dk(1:3,n12,n21) - conjg(cdk12(1:3))
                  endif
!
...
!
                    ...
                    cdk23(3) = dcmplx(d2k*z32c,d2ks*z32c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n32,n21) = derv2dk(1:3,n32,n21) + cdk23(1:3)
!
                    d2k  = trm13*cos23
                    d2ks = trm13*sin23
                    cdk23(1) = dcmplx(d2k*x32c,d2ks*x32c)*dcmplx(0.0_dp,1.0_dp)
                    ...
                    cdk23(3) = dcmplx(d2k*z32c,d2ks*z32c)*dcmplx(0.0_dp,1.0_dp)
!
                    derv2dk(1:3,n31,n22) = derv2dk(1:3,n31,n22) - cdk23(1:3)
                  endif
                enddo
              enddo
!
...
!
  ...
  if (status/=0) call deallocate_error('threepd','nuniquejptr')
  deallocate(lijdone,stat=status)
  if (status/=0) call deallocate_error('threepd','lijdone')
!
!  Timing
!
  time2 = g_cpu_time()
