...
!   7/13 Parallelisation made more efficient by screening for out of plane potentials
!        before loop
!   7/13 Bug in parallelisation change fixed
...
!
  ...
  if (status/=0) call outofmemory('fouroopmd','nptrnforoop')
!
...
!
  ...
  if (status/=0) call deallocate_error('fouroopmd','nptrnforoop')
