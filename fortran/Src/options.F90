...
!   2/22 lsync added
!   5/23 EHT added
!   6/23 Output of GFNFF charges added
          ...
          if (n.ne.ntr) then
            ...
            do i = 1,nasym
              if (ltranat(i+nsft)) then
                ...
                ii = ii + 1
                if (ltrannoise(ncf).and..not.lregionrigid(nregionnocfg(nsft+i),ncf)) then
!
...
!
              ...
              if (ltrantherm(ncf).and..not.lregionrigid(nregionnocfg(nsft+i),ncf)) then
!
