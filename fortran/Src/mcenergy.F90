...
!
!  Julian Gale, Curtin University, November 2023
!
...
!*****************************
  if ((ldipole.or.lzdipole).and.(lewald.or.lwolf).and.ndim.gt.0) then
