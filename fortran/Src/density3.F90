...
!
  use configurations, only : lsliceatom, nregiontype, QMMMmode, nregions
  use control
  use current
  use datatypes
...
!***********************
      if (ndim.eq.3) then
        call rsearch3D(xcrd,ycrd,zcrd,.false.,lcspair,i,j,0_i4,0_i4,0_i4,0_i4,nor,nmolonly,lself,cut2,0.0_dp)
      elseif (ndim.eq.2) then
        call rsearch2D(xcrd,ycrd,zcrd,.false.,lcspair,i,j,0_i4,0_i4,0_i4,0_i4,nor,nmolonly,lself,cut2,0.0_dp)
      elseif (ndim.eq.1) then
        call rsearch1D(xcrd,ycrd,zcrd,.false.,lcspair,i,j,0_i4,0_i4,0_i4,0_i4,nor,nmolonly,lself,cut2,0.0_dp)
      endif
!
...
!***********************
    if (ndim.eq.3) then
      call rsearch3D(0.0_dp,0.0_dp,0.0_dp,.false.,lcspair,i,i,0_i4,0_i4,0_i4,0_i4,nor,nmolonly,lself,cut2,0.0_dp)
    elseif (ndim.eq.2) then
      call rsearch2D(0.0_dp,0.0_dp,0.0_dp,.false.,lcspair,i,i,0_i4,0_i4,0_i4,0_i4,nor,nmolonly,lself,cut2,0.0_dp)
    elseif (ndim.eq.1) then
      call rsearch1D(0.0_dp,0.0_dp,0.0_dp,.false.,lcspair,i,i,0_i4,0_i4,0_i4,0_i4,nor,nmolonly,lself,cut2,0.0_dp)
    endif
!
