...
!
  ...
  if (lgrad2) then
    ...
    if (status/=0) call outofmemory('pireal0d','d2k')
  endif
!
...
!
    if (dpolar(i).eq.0.0_dp) cycle iloop
!
    xal = xclat(i)
    yal = yclat(i)
    zal = zclat(i)
...
!*************************************************
      ...
      call twobody1(eatom,ereal,ec6,.true.,.true.,lgrad2,nor,1_i4,dist,xcrd,ycrd,zcrd,d0i,d0j, &
                    ...
                    l3bonds,nbtypeij,nbtypeij2,.false.,.false.,d1iq,d1jq,d2i2q,d2ijq,d2j2q)
!**************************
...
!
        if (lopi.and.lopj) then
          if (j.lt.i) then
            ...
            derv2(ix,jx) = derv2(ix,jx) - poli*(vx(i)*d3loc(1,1,1) + vy(i)*d3loc(1,1,2) + vz(i)*d3loc(1,1,3)) &
                                        + poli*qlj*(d2loc(1,1)*d2loc(1,1) + d2loc(1,2)*d2loc(1,2) + d2loc(1,3)*d2loc(1,3))
            derv2(iy,jx) = derv2(iy,jx) - poli*(vx(i)*d3loc(2,1,1) + vy(i)*d3loc(2,1,2) + vz(i)*d3loc(2,1,3)) &
                                        + poli*qlj*(d2loc(2,1)*d2loc(1,1) + d2loc(2,2)*d2loc(1,2) + d2loc(2,3)*d2loc(1,3))
            derv2(iz,jx) = derv2(iz,jx) - poli*(vx(i)*d3loc(3,1,1) + vy(i)*d3loc(3,1,2) + vz(i)*d3loc(3,1,3)) &
                                        + poli*qlj*(d2loc(3,1)*d2loc(1,1) + d2loc(3,2)*d2loc(1,2) + d2loc(3,3)*d2loc(1,3))
            derv2(ix,jy) = derv2(ix,jy) - poli*(vx(i)*d3loc(1,2,1) + vy(i)*d3loc(1,2,2) + vz(i)*d3loc(1,2,3)) &
                                        + poli*qlj*(d2loc(1,1)*d2loc(2,1) + d2loc(1,2)*d2loc(2,2) + d2loc(1,3)*d2loc(2,3))
            derv2(iy,jy) = derv2(iy,jy) - poli*(vx(i)*d3loc(2,2,1) + vy(i)*d3loc(2,2,2) + vz(i)*d3loc(2,2,3)) &
                                        + poli*qlj*(d2loc(2,1)*d2loc(2,1) + d2loc(2,2)*d2loc(2,2) + d2loc(2,3)*d2loc(2,3))
            derv2(iz,jy) = derv2(iz,jy) - poli*(vx(i)*d3loc(3,2,1) + vy(i)*d3loc(3,2,2) + vz(i)*d3loc(3,2,3)) &
                                        + poli*qlj*(d2loc(3,1)*d2loc(2,1) + d2loc(3,2)*d2loc(2,2) + d2loc(3,3)*d2loc(2,3))
            derv2(ix,jz) = derv2(ix,jz) - poli*(vx(i)*d3loc(1,3,1) + vy(i)*d3loc(1,3,2) + vz(i)*d3loc(1,3,3)) &
                                        + poli*qlj*(d2loc(1,1)*d2loc(3,1) + d2loc(1,2)*d2loc(3,2) + d2loc(1,3)*d2loc(3,3))
            derv2(iy,jz) = derv2(iy,jz) - poli*(vx(i)*d3loc(2,3,1) + vy(i)*d3loc(2,3,2) + vz(i)*d3loc(2,3,3)) &
                                        + poli*qlj*(d2loc(2,1)*d2loc(3,1) + d2loc(2,2)*d2loc(3,2) + d2loc(2,3)*d2loc(3,3))
            derv2(iz,jz) = derv2(iz,jz) - poli*(vx(i)*d3loc(3,3,1) + vy(i)*d3loc(3,3,2) + vz(i)*d3loc(3,3,3)) &
                                        + poli*qlj*(d2loc(3,1)*d2loc(3,1) + d2loc(3,2)*d2loc(3,2) + d2loc(3,3)*d2loc(3,3))
            if (lpollangevin) then
              derv2(ix,jx) = derv2(ix,jx) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                  (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
              derv2(iy,jx) = derv2(iy,jx) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                  (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
              derv2(iz,jx) = derv2(iz,jx) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                  (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
              derv2(ix,jy) = derv2(ix,jy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                  (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
              derv2(iy,jy) = derv2(iy,jy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                  (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
              derv2(iz,jy) = derv2(iz,jy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                  (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
              derv2(ix,jz) = derv2(ix,jz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                  (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
              derv2(iy,jz) = derv2(iy,jz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                  (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
              derv2(iz,jz) = derv2(iz,jz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                  (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
            endif
          endif
        elseif (lopi) then
          derv2(ix,ix) = derv2(ix,ix) - poli*(vx(i)*d3loc(1,1,1) + vy(i)*d3loc(1,1,2) + vz(i)*d3loc(1,1,3)) &
                                      - poli*qlj*(d2loc(1,1)*d2loc(1,1) + d2loc(1,2)*d2loc(1,2) + d2loc(1,3)*d2loc(1,3))
          derv2(iy,ix) = derv2(iy,ix) - poli*(vx(i)*d3loc(2,1,1) + vy(i)*d3loc(2,1,2) + vz(i)*d3loc(2,1,3)) &
                                      - poli*qlj*(d2loc(2,1)*d2loc(1,1) + d2loc(2,2)*d2loc(1,2) + d2loc(2,3)*d2loc(1,3))
          derv2(iz,ix) = derv2(iz,ix) - poli*(vx(i)*d3loc(3,1,1) + vy(i)*d3loc(3,1,2) + vz(i)*d3loc(3,1,3)) &
                                      - poli*qlj*(d2loc(3,1)*d2loc(1,1) + d2loc(3,2)*d2loc(1,2) + d2loc(3,3)*d2loc(1,3))
          derv2(ix,iy) = derv2(ix,iy) - poli*(vx(i)*d3loc(1,2,1) + vy(i)*d3loc(1,2,2) + vz(i)*d3loc(1,2,3)) &
                                      - poli*qlj*(d2loc(1,1)*d2loc(2,1) + d2loc(1,2)*d2loc(2,2) + d2loc(1,3)*d2loc(2,3))
          derv2(iy,iy) = derv2(iy,iy) - poli*(vx(i)*d3loc(2,2,1) + vy(i)*d3loc(2,2,2) + vz(i)*d3loc(2,2,3)) &
                                      - poli*qlj*(d2loc(2,1)*d2loc(2,1) + d2loc(2,2)*d2loc(2,2) + d2loc(2,3)*d2loc(2,3))
          derv2(iz,iy) = derv2(iz,iy) - poli*(vx(i)*d3loc(3,2,1) + vy(i)*d3loc(3,2,2) + vz(i)*d3loc(3,2,3)) &
                                      - poli*qlj*(d2loc(3,1)*d2loc(2,1) + d2loc(3,2)*d2loc(2,2) + d2loc(3,3)*d2loc(2,3))
          derv2(ix,iz) = derv2(ix,iz) - poli*(vx(i)*d3loc(1,3,1) + vy(i)*d3loc(1,3,2) + vz(i)*d3loc(1,3,3)) &
                                      - poli*qlj*(d2loc(1,1)*d2loc(3,1) + d2loc(1,2)*d2loc(3,2) + d2loc(1,3)*d2loc(3,3))
          derv2(iy,iz) = derv2(iy,iz) - poli*(vx(i)*d3loc(2,3,1) + vy(i)*d3loc(2,3,2) + vz(i)*d3loc(2,3,3)) &
                                      - poli*qlj*(d2loc(2,1)*d2loc(3,1) + d2loc(2,2)*d2loc(3,2) + d2loc(2,3)*d2loc(3,3))
          derv2(iz,iz) = derv2(iz,iz) - poli*(vx(i)*d3loc(3,3,1) + vy(i)*d3loc(3,3,2) + vz(i)*d3loc(3,3,3)) &
                                      - poli*qlj*(d2loc(3,1)*d2loc(3,1) + d2loc(3,2)*d2loc(3,2) + d2loc(3,3)*d2loc(3,3))
          if (lpollangevin) then
            derv2(ix,ix) = derv2(ix,ix) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
            derv2(iy,ix) = derv2(iy,ix) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
            derv2(iz,ix) = derv2(iz,ix) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
            derv2(ix,iy) = derv2(ix,iy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
            derv2(iy,iy) = derv2(iy,iy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
            derv2(iz,iy) = derv2(iz,iy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
            derv2(ix,iz) = derv2(ix,iz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
            derv2(iy,iz) = derv2(iy,iz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
            derv2(iz,iz) = derv2(iz,iz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
          endif
        elseif (lopj) then
          derv2(jx,jx) = derv2(jx,jx) - poli*(vx(i)*d3loc(1,1,1) + vy(i)*d3loc(1,1,2) + vz(i)*d3loc(1,1,3)) &
                                      - poli*qlj*(d2loc(1,1)*d2loc(1,1) + d2loc(1,2)*d2loc(1,2) + d2loc(1,3)*d2loc(1,3))
          derv2(jy,jx) = derv2(jy,jx) - poli*(vx(i)*d3loc(2,1,1) + vy(i)*d3loc(2,1,2) + vz(i)*d3loc(2,1,3)) &
                                      - poli*qlj*(d2loc(2,1)*d2loc(1,1) + d2loc(2,2)*d2loc(1,2) + d2loc(2,3)*d2loc(1,3))
          derv2(jz,jx) = derv2(jz,jx) - poli*(vx(i)*d3loc(3,1,1) + vy(i)*d3loc(3,1,2) + vz(i)*d3loc(3,1,3)) &
                                      - poli*qlj*(d2loc(3,1)*d2loc(1,1) + d2loc(3,2)*d2loc(1,2) + d2loc(3,3)*d2loc(1,3))
          derv2(jx,jy) = derv2(jx,jy) - poli*(vx(i)*d3loc(1,2,1) + vy(i)*d3loc(1,2,2) + vz(i)*d3loc(1,2,3)) &
                                      - poli*qlj*(d2loc(1,1)*d2loc(2,1) + d2loc(1,2)*d2loc(2,2) + d2loc(1,3)*d2loc(2,3))
          derv2(jy,jy) = derv2(jy,jy) - poli*(vx(i)*d3loc(2,2,1) + vy(i)*d3loc(2,2,2) + vz(i)*d3loc(2,2,3)) &
                                      - poli*qlj*(d2loc(2,1)*d2loc(2,1) + d2loc(2,2)*d2loc(2,2) + d2loc(2,3)*d2loc(2,3))
          derv2(jz,jy) = derv2(jz,jy) - poli*(vx(i)*d3loc(3,2,1) + vy(i)*d3loc(3,2,2) + vz(i)*d3loc(3,2,3)) &
                                      - poli*qlj*(d2loc(3,1)*d2loc(2,1) + d2loc(3,2)*d2loc(2,2) + d2loc(3,3)*d2loc(2,3))
          derv2(jx,jz) = derv2(jx,jz) - poli*(vx(i)*d3loc(1,3,1) + vy(i)*d3loc(1,3,2) + vz(i)*d3loc(1,3,3)) &
                                      - poli*qlj*(d2loc(1,1)*d2loc(3,1) + d2loc(1,2)*d2loc(3,2) + d2loc(1,3)*d2loc(3,3))
          derv2(jy,jz) = derv2(jy,jz) - poli*(vx(i)*d3loc(2,3,1) + vy(i)*d3loc(2,3,2) + vz(i)*d3loc(2,3,3)) &
                                      - poli*qlj*(d2loc(2,1)*d2loc(3,1) + d2loc(2,2)*d2loc(3,2) + d2loc(2,3)*d2loc(3,3))
          derv2(jz,jz) = derv2(jz,jz) - poli*(vx(i)*d3loc(3,3,1) + vy(i)*d3loc(3,3,2) + vz(i)*d3loc(3,3,3)) &
                                      - poli*qlj*(d2loc(3,1)*d2loc(3,1) + d2loc(3,2)*d2loc(3,2) + d2loc(3,3)*d2loc(3,3))
          if (lpollangevin) then
            derv2(jx,jx) = derv2(jx,jx) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
            derv2(jy,jx) = derv2(jy,jx) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
            derv2(jz,jx) = derv2(jz,jx) + pol2i*(vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))* &
                                                (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
            derv2(jx,jy) = derv2(jx,jy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
            derv2(jy,jy) = derv2(jy,jy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
            derv2(jz,jy) = derv2(jz,jy) + pol2i*(vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))* &
                                                (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
            derv2(jx,jz) = derv2(jx,jz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                (vx(i)*d2loc(1,1) + vy(i)*d2loc(2,1) + vz(i)*d2loc(3,1))
            derv2(jy,jz) = derv2(jy,jz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                (vx(i)*d2loc(1,2) + vy(i)*d2loc(2,2) + vz(i)*d2loc(3,2))
            derv2(jz,jz) = derv2(jz,jz) + pol2i*(vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))* &
                                                (vx(i)*d2loc(1,3) + vy(i)*d2loc(2,3) + vz(i)*d2loc(3,3))
          endif
        endif
      endif
...
!
          ...
          if (lpollangevin) then
            Es = sqrt(vx(i)**2 + vy(i)**2 + vz(i)**2)
            if (Es.gt.1.0d-8) then
              call langevinpol(Es,dpolarmax(i),dpolar(i),Ep,dEpdEs,d2EpdEs2,.true.,.true.)
...
!
          ...
          elseif (lopi) then
            derv2(ix,ix) = derv2(ix,ix) + polk*(d2k(1,1,j)*d2k(1,1,k) + d2k(1,2,j)*d2k(1,2,k) + d2k(1,3,j)*d2k(1,3,k))
            derv2(iy,ix) = derv2(iy,ix) + polk*(d2k(2,1,j)*d2k(1,1,k) + d2k(2,2,j)*d2k(1,2,k) + d2k(2,3,j)*d2k(1,3,k))
            derv2(iz,ix) = derv2(iz,ix) + polk*(d2k(3,1,j)*d2k(1,1,k) + d2k(3,2,j)*d2k(1,2,k) + d2k(3,3,j)*d2k(1,3,k))
            derv2(ix,iy) = derv2(ix,iy) + polk*(d2k(1,1,j)*d2k(2,1,k) + d2k(1,2,j)*d2k(2,2,k) + d2k(1,3,j)*d2k(2,3,k))
            derv2(iy,iy) = derv2(iy,iy) + polk*(d2k(2,1,j)*d2k(2,1,k) + d2k(2,2,j)*d2k(2,2,k) + d2k(2,3,j)*d2k(2,3,k))
            derv2(iz,iy) = derv2(iz,iy) + polk*(d2k(3,1,j)*d2k(2,1,k) + d2k(3,2,j)*d2k(2,2,k) + d2k(3,3,j)*d2k(2,3,k))
            derv2(ix,iz) = derv2(ix,iz) + polk*(d2k(1,1,j)*d2k(3,1,k) + d2k(1,2,j)*d2k(3,2,k) + d2k(1,3,j)*d2k(3,3,k))
            derv2(iy,iz) = derv2(iy,iz) + polk*(d2k(2,1,j)*d2k(3,1,k) + d2k(2,2,j)*d2k(3,2,k) + d2k(2,3,j)*d2k(3,3,k))
            derv2(iz,iz) = derv2(iz,iz) + polk*(d2k(3,1,j)*d2k(3,1,k) + d2k(3,2,j)*d2k(3,2,k) + d2k(3,3,j)*d2k(3,3,k))
!
            if (lpollangevin) then
              derv2(ix,ix) = derv2(ix,ix) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(ix,iy) = derv2(ix,iy) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(ix,iz) = derv2(ix,iz) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              derv2(iy,ix) = derv2(iy,ix) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(iy,iy) = derv2(iy,iy) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(iy,iz) = derv2(iy,iz) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              derv2(iz,ix) = derv2(iz,ix) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(iz,iy) = derv2(iz,iy) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(iz,iz) = derv2(iz,iz) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
            endif
          elseif (lopj) then
            derv2(jx,jx) = derv2(jx,jx) + polk*(d2k(1,1,j)*d2k(1,1,k) + d2k(1,2,j)*d2k(1,2,k) + d2k(1,3,j)*d2k(1,3,k))
            derv2(jy,jx) = derv2(jy,jx) + polk*(d2k(2,1,j)*d2k(1,1,k) + d2k(2,2,j)*d2k(1,2,k) + d2k(2,3,j)*d2k(1,3,k))
            derv2(jz,jx) = derv2(jz,jx) + polk*(d2k(3,1,j)*d2k(1,1,k) + d2k(3,2,j)*d2k(1,2,k) + d2k(3,3,j)*d2k(1,3,k))
            derv2(jx,jy) = derv2(jx,jy) + polk*(d2k(1,1,j)*d2k(2,1,k) + d2k(1,2,j)*d2k(2,2,k) + d2k(1,3,j)*d2k(2,3,k))
            derv2(jy,jy) = derv2(jy,jy) + polk*(d2k(2,1,j)*d2k(2,1,k) + d2k(2,2,j)*d2k(2,2,k) + d2k(2,3,j)*d2k(2,3,k))
            derv2(jz,jy) = derv2(jz,jy) + polk*(d2k(3,1,j)*d2k(2,1,k) + d2k(3,2,j)*d2k(2,2,k) + d2k(3,3,j)*d2k(2,3,k))
            derv2(jx,jz) = derv2(jx,jz) + polk*(d2k(1,1,j)*d2k(3,1,k) + d2k(1,2,j)*d2k(3,2,k) + d2k(1,3,j)*d2k(3,3,k))
            derv2(jy,jz) = derv2(jy,jz) + polk*(d2k(2,1,j)*d2k(3,1,k) + d2k(2,2,j)*d2k(3,2,k) + d2k(2,3,j)*d2k(3,3,k))
            derv2(jz,jz) = derv2(jz,jz) + polk*(d2k(3,1,j)*d2k(3,1,k) + d2k(3,2,j)*d2k(3,2,k) + d2k(3,3,j)*d2k(3,3,k))
!           
            if (lpollangevin) then
              derv2(jx,jx) = derv2(jx,jx) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(jx,jy) = derv2(jx,jy) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(jx,jz) = derv2(jx,jz) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              derv2(jy,jx) = derv2(jy,jx) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(jy,jy) = derv2(jy,jy) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(jy,jz) = derv2(jy,jz) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* & 
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              derv2(jz,jx) = derv2(jz,jx) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* & 
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(jz,jy) = derv2(jz,jy) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* & 
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(jz,jz) = derv2(jz,jz) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* & 
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
            endif
          endif
!
...
!
              ...
              derv2(ix,kx) = derv2(ix,kx) + polk*(d2k(1,1,j)*d2k(1,1,k) + d2k(1,2,j)*d2k(1,2,k) + d2k(1,3,j)*d2k(1,3,k))
              derv2(iy,kx) = derv2(iy,kx) + polk*(d2k(2,1,j)*d2k(1,1,k) + d2k(2,2,j)*d2k(1,2,k) + d2k(2,3,j)*d2k(1,3,k))
              derv2(iz,kx) = derv2(iz,kx) + polk*(d2k(3,1,j)*d2k(1,1,k) + d2k(3,2,j)*d2k(1,2,k) + d2k(3,3,j)*d2k(1,3,k))
              derv2(ix,ky) = derv2(ix,ky) + polk*(d2k(1,1,j)*d2k(2,1,k) + d2k(1,2,j)*d2k(2,2,k) + d2k(1,3,j)*d2k(2,3,k))
              derv2(iy,ky) = derv2(iy,ky) + polk*(d2k(2,1,j)*d2k(2,1,k) + d2k(2,2,j)*d2k(2,2,k) + d2k(2,3,j)*d2k(2,3,k))
              derv2(iz,ky) = derv2(iz,ky) + polk*(d2k(3,1,j)*d2k(2,1,k) + d2k(3,2,j)*d2k(2,2,k) + d2k(3,3,j)*d2k(2,3,k))
              derv2(ix,kz) = derv2(ix,kz) + polk*(d2k(1,1,j)*d2k(3,1,k) + d2k(1,2,j)*d2k(3,2,k) + d2k(1,3,j)*d2k(3,3,k))
              derv2(iy,kz) = derv2(iy,kz) + polk*(d2k(2,1,j)*d2k(3,1,k) + d2k(2,2,j)*d2k(3,2,k) + d2k(2,3,j)*d2k(3,3,k))
              derv2(iz,kz) = derv2(iz,kz) + polk*(d2k(3,1,j)*d2k(3,1,k) + d2k(3,2,j)*d2k(3,2,k) + d2k(3,3,j)*d2k(3,3,k))
!
              if (lpollangevin) then
                derv2(ix,kx) = derv2(ix,kx) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                    (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
                derv2(ix,ky) = derv2(ix,ky) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                    (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
                derv2(ix,kz) = derv2(ix,kz) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                    (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
                derv2(iy,kx) = derv2(iy,kx) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                    (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
                derv2(iy,ky) = derv2(iy,ky) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                    (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
                derv2(iy,kz) = derv2(iy,kz) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                    (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
                derv2(iz,kx) = derv2(iz,kx) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                    (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
                derv2(iz,ky) = derv2(iz,ky) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                    (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
                derv2(iz,kz) = derv2(iz,kz) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                    (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              endif
            endif
          elseif (lopi) then
...
!
          ...
          elseif (lopk) then
            derv2(kx,kx) = derv2(kx,kx) + polk*(d2k(1,1,j)*d2k(1,1,k) + d2k(1,2,j)*d2k(1,2,k) + d2k(1,3,j)*d2k(1,3,k))
            derv2(ky,kx) = derv2(ky,kx) + polk*(d2k(2,1,j)*d2k(1,1,k) + d2k(2,2,j)*d2k(1,2,k) + d2k(2,3,j)*d2k(1,3,k))
            derv2(kz,kx) = derv2(kz,kx) + polk*(d2k(3,1,j)*d2k(1,1,k) + d2k(3,2,j)*d2k(1,2,k) + d2k(3,3,j)*d2k(1,3,k))
            derv2(kx,ky) = derv2(kx,ky) + polk*(d2k(1,1,j)*d2k(2,1,k) + d2k(1,2,j)*d2k(2,2,k) + d2k(1,3,j)*d2k(2,3,k))
            derv2(ky,ky) = derv2(ky,ky) + polk*(d2k(2,1,j)*d2k(2,1,k) + d2k(2,2,j)*d2k(2,2,k) + d2k(2,3,j)*d2k(2,3,k))
            derv2(kz,ky) = derv2(kz,ky) + polk*(d2k(3,1,j)*d2k(2,1,k) + d2k(3,2,j)*d2k(2,2,k) + d2k(3,3,j)*d2k(2,3,k))
            derv2(kx,kz) = derv2(kx,kz) + polk*(d2k(1,1,j)*d2k(3,1,k) + d2k(1,2,j)*d2k(3,2,k) + d2k(1,3,j)*d2k(3,3,k))
            derv2(ky,kz) = derv2(ky,kz) + polk*(d2k(2,1,j)*d2k(3,1,k) + d2k(2,2,j)*d2k(3,2,k) + d2k(2,3,j)*d2k(3,3,k))
            derv2(kz,kz) = derv2(kz,kz) + polk*(d2k(3,1,j)*d2k(3,1,k) + d2k(3,2,j)*d2k(3,2,k) + d2k(3,3,j)*d2k(3,3,k))
!
            if (lpollangevin) then
              derv2(kx,kx) = derv2(kx,kx) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* & 
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(kx,ky) = derv2(kx,ky) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* & 
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(kx,kz) = derv2(kx,kz) + pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* & 
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              derv2(ky,kx) = derv2(ky,kx) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* & 
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(ky,ky) = derv2(ky,ky) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* & 
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(ky,kz) = derv2(ky,kz) + pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* & 
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              derv2(kz,kx) = derv2(kz,kx) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* & 
                                                  (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
              derv2(kz,ky) = derv2(kz,ky) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* & 
                                                  (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
              derv2(kz,kz) = derv2(kz,kz) + pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* & 
                                                  (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
            endif
          endif
!
...
!
              ...
              derv2(jx,kx) = derv2(jx,kx) - polk*(d2k(1,1,j)*d2k(1,1,k) + d2k(1,2,j)*d2k(1,2,k) + d2k(1,3,j)*d2k(1,3,k))
              derv2(jy,kx) = derv2(jy,kx) - polk*(d2k(2,1,j)*d2k(1,1,k) + d2k(2,2,j)*d2k(1,2,k) + d2k(2,3,j)*d2k(1,3,k))
              derv2(jz,kx) = derv2(jz,kx) - polk*(d2k(3,1,j)*d2k(1,1,k) + d2k(3,2,j)*d2k(1,2,k) + d2k(3,3,j)*d2k(1,3,k))
              derv2(jx,ky) = derv2(jx,ky) - polk*(d2k(1,1,j)*d2k(2,1,k) + d2k(1,2,j)*d2k(2,2,k) + d2k(1,3,j)*d2k(2,3,k))
              derv2(jy,ky) = derv2(jy,ky) - polk*(d2k(2,1,j)*d2k(2,1,k) + d2k(2,2,j)*d2k(2,2,k) + d2k(2,3,j)*d2k(2,3,k))
              derv2(jz,ky) = derv2(jz,ky) - polk*(d2k(3,1,j)*d2k(2,1,k) + d2k(3,2,j)*d2k(2,2,k) + d2k(3,3,j)*d2k(2,3,k))
              derv2(jx,kz) = derv2(jx,kz) - polk*(d2k(1,1,j)*d2k(3,1,k) + d2k(1,2,j)*d2k(3,2,k) + d2k(1,3,j)*d2k(3,3,k))
              derv2(jy,kz) = derv2(jy,kz) - polk*(d2k(2,1,j)*d2k(3,1,k) + d2k(2,2,j)*d2k(3,2,k) + d2k(2,3,j)*d2k(3,3,k))
              derv2(jz,kz) = derv2(jz,kz) - polk*(d2k(3,1,j)*d2k(3,1,k) + d2k(3,2,j)*d2k(3,2,k) + d2k(3,3,j)*d2k(3,3,k))
!
              if (lpollangevin) then
                derv2(jx,kx) = derv2(jx,kx) - pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                    (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
                derv2(jx,ky) = derv2(jx,ky) - pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                    (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
                derv2(jx,kz) = derv2(jx,kz) - pol2k*(vx(i)*d2k(1,1,j) + vy(i)*d2k(2,1,j) + vz(i)*d2k(3,1,j))* &
                                                    (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
                derv2(jy,kx) = derv2(jy,kx) - pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                    (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
                derv2(jy,ky) = derv2(jy,ky) - pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                    (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
                derv2(jy,kz) = derv2(jy,kz) - pol2k*(vx(i)*d2k(1,2,j) + vy(i)*d2k(2,2,j) + vz(i)*d2k(3,2,j))* &
                                                    (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
                derv2(jz,kx) = derv2(jz,kx) - pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                    (vx(i)*d2k(1,1,k) + vy(i)*d2k(2,1,k) + vz(i)*d2k(3,1,k))
                derv2(jz,ky) = derv2(jz,ky) - pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                    (vx(i)*d2k(1,2,k) + vy(i)*d2k(2,2,k) + vz(i)*d2k(3,2,k))
                derv2(jz,kz) = derv2(jz,kz) - pol2k*(vx(i)*d2k(1,3,j) + vy(i)*d2k(2,3,j) + vz(i)*d2k(3,3,j))* &
                                                    (vx(i)*d2k(1,3,k) + vy(i)*d2k(2,3,k) + vz(i)*d2k(3,3,k))
              endif
            endif
          elseif (lopj) then
...
!
  if (lgrad2) then
    ...
    if (status/=0) call deallocate_error('pireal0d','d2k')
  endif
