...
!   9/19 nrel2 / nrelf2a changed to nrela2f / nrelf2a
...
!
                      derv3(n3x,kk) = derv3(n3x,kk) + ed12*d2r2dsdx(ks,1,2) + ed13*d2r2dsdx(ks,1,3)
                      derv3(n3y,kk) = derv3(n3y,kk) + ed12*d2r2dsdx(ks,2,2) + ed13*d2r2dsdx(ks,2,3)
                      derv3(n3z,kk) = derv3(n3z,kk) + ed12*d2r2dsdx(ks,3,2) + ed13*d2r2dsdx(ks,3,3)
                    enddo
                  endif
                endif
              endif
