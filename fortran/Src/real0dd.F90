...
!   9/23 Call to gfnffbody1 corrected
!
!  Conditions of use:
!
...
!*************************************************
      ...
      call twobody1(eatoml,ereall,ec6l,lgrad1p,lgrad2,.false.,nor,1_i4,dist,xcrd,ycrd,zcrd,d0i,d0j, &
                    ...
                    sctrm2,qli,qlj,nspeci,nspecj,lcspair,.false.,.false.,lbonded,l2bonds,l3bonds,nbtypeij, &
...
!
      ...
      if (leem.or.lgfnff) then
        ...
        elseif (lgfnff) then
          ...
          call gfnffbody1(eqeql,zetaij,lgrad1,lgrad2,nor,1_i4,dist,deriv,deriv2, &
...
!*******************************************************
        if (lDoQDeriv2) then
          ...
          d1jy = d1j*ycrd
          d1jz = d1j*zcrd
          call d2charged(ii,i,j,1_i4,ix,iy,iz,jx,jy,jz,d0i,d0j,d1ix,d1iy,d1iz,d1jx,d1jy,d1jz, &
