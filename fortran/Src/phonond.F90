...
!   4/22 Traps added for case where casfile or eigfile are blank
!   8/22 Calculation of atomic phases added
!  10/22 Initialisation of fphase changed to dpc
!  10/22 Correction to logic of setting fphase
!   2/23 Correction to aphase referencing with rigid molecules
!
!  Conditions of use:
!
