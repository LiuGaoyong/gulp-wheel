...
!*******************************************************
              if (lDoQDeriv2) then
                if (i.ne.j) then
                  ...
                  d0i(1)  = 0.5_dp*qj*rr*angstoev
                  d0j(1)  = 0.5_dp*qi*rr*angstoev
                  d2ij(1) = 0.5_dp*rr*angstoev
                endif
!
                d1i  = - d0i(1)*rr*rr
                d1j  = - d0j(1)*rr*rr
                ...
                d1is(1) = d1i*dr2ds(1)
                d1js(1) = d1j*dr2ds(1)
                call d2charged(ii,i,j,1_i4,ix,iy,iz,jx,jy,jz,d0i,d0j,d1ix,d1iy,d1iz, &
...
!
            ...
            sderv2(1,1) = sderv2(1,1) + 0.5_dp*qij*d2s
          endif
          if (lDoQDeriv2) then
!
...
!*******************************************************
          if (lDoQDeriv2) then
            if (i.eq.j) then
              d0i(1) = 0.5_dp*qj*d0term
              d2i2(1) = 0.0_dp
              d2ij(1) = 0.5_dp*d0term
              d2j2(1) = 0.0_dp
              if (lstr) then
                d1is(1) = d1is(1) + dh1s*qj*angstoev
              endif
              call d2charged(ii,i,j,1_i4,ix,iy,iz,jx,jy,jz,d0i,d0i,d1ix,d1iy,d1iz, &
