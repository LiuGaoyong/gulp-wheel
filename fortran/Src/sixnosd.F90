  subroutine sixnosd(esix,esregion12,esregion2,eattach,lgrad1,lgrad2)
!
!  Subroutine for six-body potentials
!  Distributed memory parallel version
!
!   1/17 Created from sixnos
!   2/18 Trace added
...
!
  ...
  if (status/=0) call outofmemory('sixnosd','xderv')
  allocate(yderv(numat),stat=status)                       
  if (status/=0) call outofmemory('sixnosd','yderv')
  allocate(zderv(numat),stat=status)
  if (status/=0) call outofmemory('sixnosd','zderv')
!
...
!
      isatom(1) = i
      isxyz(1,1) = 3*(noptatrptr(i) - 1) + 1
      isxyz(2,1) = 3*(noptatrptr(i) - 1) + 2
      isxyz(3,1) = 3*(noptatrptr(i) - 1) + 3
!
      isxyzl(1) = 3*(noptatlocrptr(i) - 1) + 1
      isxyzl(2) = 3*(noptatlocrptr(i) - 1) + 2
      isxyzl(3) = 3*(noptatlocrptr(i) - 1) + 3
!
      lopis(1)  = lopi
      sxyz(1,1) = xclat(i)
      sxyz(2,1) = yclat(i)
...
!
          isatom(2) = j
          isxyz(1,2) = 3*(noptatrptr(j) - 1) + 1
          isxyz(2,2) = 3*(noptatrptr(j) - 1) + 2
          isxyz(3,2) = 3*(noptatrptr(j) - 1) + 3
          lopis(2)  = lopj
...
!
              isatom(3) = k
              isxyz(1,3) = 3*(noptatrptr(k) - 1) + 1
              isxyz(2,3) = 3*(noptatrptr(k) - 1) + 2
              isxyz(3,3) = 3*(noptatrptr(k) - 1) + 3
              lopis(3)  = lopk
...
!
                  isatom(4) = l
                  isxyz(1,4) = 3*(noptatrptr(l) - 1) + 1
                  isxyz(2,4) = 3*(noptatrptr(l) - 1) + 2
                  isxyz(3,4) = 3*(noptatrptr(l) - 1) + 3
                  lopis(4)  = lopl
...
!
                      isatom(5) = m
                      isxyz(1,5) = 3*(noptatrptr(m) - 1) + 1
                      isxyz(2,5) = 3*(noptatrptr(m) - 1) + 2
                      isxyz(3,5) = 3*(noptatrptr(m) - 1) + 3
                      lopis(5)  = lopm
...
!
                          isatom(6) = n
                          isxyz(1,6) = 3*(noptatrptr(n) - 1) + 1
                          isxyz(2,6) = 3*(noptatrptr(n) - 1) + 2
                          isxyz(3,6) = 3*(noptatrptr(n) - 1) + 3
                          lopis(6)  = lopn
...
!
!  For energy and gradients we need to ensure that i/j are not duplicated
!
                          if (j.le.i) then
                            if (lreg2stet) then
                            ...
                            if (lgrad2) then
                              do kk = 1,nstrains
                                ...
                                do ivec = 1,15
                                  temp(ivec) = 0.0_dp
                                  do jvec = 1,15
                                    temp(ivec) = temp(ivec) + e2d(kb3(jvec,ivec))*dr2ds(ks,jvec)
                                  enddo
                                enddo
!
!  For energy and gradients we need to ensure that i/j are not duplicated
...
!
                                  do ivec = 1,15
                                    do kl = 1,nstrains
                                      kt = nstrptr(kl)
                                      sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,ivec)*temp(ivec)
                                      sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,ivec)*e1d(ivec)
                                    enddo
                                  enddo
                                endif
!
...
!
                                ...
                                do jvec = 2,6
                                  indvec = indvec + 1
                                  derv3(isxyzl(1),kk) = derv3(isxyzl(1),kk) + svec(1,jvec,1)*temp(indvec)
                                  derv3(isxyzl(2),kk) = derv3(isxyzl(2),kk) + svec(2,jvec,1)*temp(indvec)
                                  derv3(isxyzl(3),kk) = derv3(isxyzl(3),kk) + svec(3,jvec,1)*temp(indvec)
!
                                  derv3(isxyzl(1),kk) = derv3(isxyzl(1),kk) + d2r2dsdx(ks,1,indvec)*e1d(indvec)
                                  derv3(isxyzl(2),kk) = derv3(isxyzl(2),kk) + d2r2dsdx(ks,2,indvec)*e1d(indvec)
                                  derv3(isxyzl(3),kk) = derv3(isxyzl(3),kk) + d2r2dsdx(ks,3,indvec)*e1d(indvec)
                                enddo
                              enddo
                            endif
                          endif
...
!
                              if (lopis(ia).or.lopis(ja).and.ia.ne.ja) then
                                if (ia1.eq.1) then
                                  derv2(isxyz(1,ja1),isxyzl(1)) = derv2(isxyz(1,ja1),isxyzl(1)) - e1d(ivec)
                                  derv2(isxyz(2,ja1),isxyzl(2)) = derv2(isxyz(2,ja1),isxyzl(2)) - e1d(ivec)
                                  derv2(isxyz(3,ja1),isxyzl(3)) = derv2(isxyz(3,ja1),isxyzl(3)) - e1d(ivec)
                                endif
!
                                if (.not.lopone.and.ja1.eq.1) then
                                  derv2(isxyz(1,ia1),isxyzl(1)) = derv2(isxyz(1,ia1),isxyzl(1)) - e1d(ivec)
                                  derv2(isxyz(2,ia1),isxyzl(2)) = derv2(isxyz(2,ia1),isxyzl(2)) - e1d(ivec)
                                  derv2(isxyz(3,ia1),isxyzl(3)) = derv2(isxyz(3,ia1),isxyzl(3)) - e1d(ivec)
                                endif
                              endif
                              do jvec = ivec,15
                                indvec = indvec + 1 
                                    ...
                                    if (ia1.eq.1) then
                                      if (lopis(ia).or.lopis(ib).and.ia.ne.ib) then
                                        if ((ia1.eq.ib1.and.ia.gt.ib).or.ia1.ne.ib1) then
                                          derv2(isxyz(ibet,ib1),isxyzl(ialp)) = derv2(isxyz(ibet,ib1),isxyzl(ialp)) + d2trm
                                        endif
                                      endif
                                    endif
                                    if (ia2.eq.1) then
                                      if (lopis(ia).or.lopis(jb).and.ia.ne.jb) then
                                        if ((ia2.eq.jb2.and.ia.gt.jb).or.ia2.ne.jb2) then
                                          derv2(isxyz(ibet,jb2),isxyzl(ialp)) = derv2(isxyz(ibet,jb2),isxyzl(ialp)) - d2trm
                                        endif
                                      endif
                                    endif
                                    if (ja3.eq.1) then
                                      if (lopis(ja).or.lopis(jb).and.ja.ne.jb) then
                                        if ((ja3.eq.jb3.and.ja.gt.jb).or.ja3.ne.jb3) then
                                          derv2(isxyz(ibet,jb3),isxyzl(ialp)) = derv2(isxyz(ibet,jb3),isxyzl(ialp)) + d2trm
                                        endif
                                      endif
                                    endif
                                    if (ja4.eq.1) then
                                      if (lopis(ja).or.lopis(ib).and.ja.ne.ib) then
                                        if ((ja4.eq.ib4.and.ja.gt.ib).or.ja4.ne.ib4) then
                                          derv2(isxyz(ibet,ib4),isxyzl(ialp)) = derv2(isxyz(ibet,ib4),isxyzl(ialp)) - d2trm
                                        endif
                                      endif
                                    endif
!
                                      ...
                                      if (ib1.eq.1) then
                                        if (lopis(ia).or.lopis(ib).and.ia.ne.ib) then
                                          if ((ib1.eq.ia1.and.ib.gt.ia).or.ib1.ne.ia1) then
                                            derv2(isxyz(ialp,ia1),isxyzl(ibet)) = derv2(isxyz(ialp,ia1),isxyzl(ibet))+d2trm
                                          endif
                                        endif
                                      endif
                                      if (jb2.eq.1) then
                                        if (lopis(ia).or.lopis(jb).and.ia.ne.jb) then
                                          if ((jb2.eq.ia2.and.jb.gt.ia).or.jb2.ne.ia2) then
                                            derv2(isxyz(ialp,ia2),isxyzl(ibet)) = derv2(isxyz(ialp,ia2),isxyzl(ibet))-d2trm
                                          endif
                                        endif
                                      endif
                                      if (jb3.eq.1) then
                                        if (lopis(ja).or.lopis(jb).and.ja.ne.jb) then
                                          if ((jb3.eq.ja3.and.jb.gt.ja).or.jb3.ne.ja3) then
                                            derv2(isxyz(ialp,ja3),isxyzl(ibet)) = derv2(isxyz(ialp,ja3),isxyzl(ibet))+d2trm
                                          endif
                                        endif
                                      endif
                                      if (ib4.eq.1) then
                                        if (lopis(ja).or.lopis(ib).and.ja.ne.ib) then
                                          if ((ib4.eq.ja4.and.ib.gt.ja).or.ib4.ne.ja4) then
                                            derv2(isxyz(ialp,ja4),isxyzl(ibet)) = derv2(isxyz(ialp,ja4),isxyzl(ibet))-d2trm
                                          endif
                                        endif
                                      endif
!
...
!
        if (QMMMmode(ncf).gt.0) then
          if (nregiontypi.eq.1.and.nregiontypj.eq.1.and.lbtyp) cycle jloop2
        endif
        if (lmol.and.lneedmol) then
!
!  Molecule handling
...
!
            jjloop2: do jj = 1,iimax
              ...
              z31 = z31t + zvec1cell(jj)
              r312 = x31*x31 + y31*y31 + z31*z31
              if (r312.lt.1d-12) cycle jjloop2
!
!  Prevent atoms i and k being the same atom
!
...
!
              ...
              isxyz(3,3) = 3*(noptatrptr(k) - 1) + 3
!
              isxyzl(1) = 3*(noptatlocrptr(k) - 1) + 1
              isxyzl(2) = 3*(noptatlocrptr(k) - 1) + 2
              isxyzl(3) = 3*(noptatlocrptr(k) - 1) + 3
!
              lopis(3)  = lopk
              sxyz(1,3) = x31 + sxyz(1,1)
              sxyz(2,3) = y31 + sxyz(2,1)
...
!
                llloop2: do ll = 1,liimax
                  ...
                  z41 = z41t + zvec1cell(ll)
                  r412 = x41*x41 + y41*y41 + z41*z41
                  if (r412.lt.1d-12) cycle llloop2
!
!  Prevent atoms i and l being the same atom
!
...
!
                    mmloop2: do mm = 1,iimax
                      ...
                      z52 = z52t + zvec1cell(mm)
                      r522 = x52*x52 + y52*y52 + z52*z52
                      if (r522.lt.1d-12) cycle mmloop2
!
!  Prevent atoms i and m being the same atom
!
...
!  If lfreeze=.true. and no atoms have any variables then skip this four body term
!
                        if (.not.lopi.and..not.lopj.and..not.lopk.and..not.lopl.and..not.lopm.and..not.lopn) cycle nloop2
!
!  QM/MM handling : i, j, k, l, m and n are all QM atoms => exclude
!
                        if (QMMMmode(ncf).gt.0) then
                          if (nregiontypi.eq.1.and.nregiontypj.eq.1.and.nregiontypk.eq.1.and.nregiontypl.eq.1.and. &
                              nregiontypm.eq.1.and.nregiontypn.eq.1) cycle nloop2
                        endif
!
!  Molecule handling
!
...
!
                        mnloop2: do mn = 1,niimax
                          ...
                          z62 = z62t + zvec1cell(mn)
                          r622 = x62*x62 + y62*y62 + z62*z62
                          if (r622.lt.1d-12) cycle mnloop2
!
!  Prevent atoms i and n being the same atom
!
...
!
                                ...
                                do ivec = 1,5
                                  do jvec = ivec+1,6
                                    ...
                                    ia = iveca(2,indvec)
                                    if (ia.eq.3) then
                                      derv3(isxyzl(1),kk) = derv3(isxyzl(1),kk) + svec(1,jvec,ivec)*temp(indvec)
                                      derv3(isxyzl(2),kk) = derv3(isxyzl(2),kk) + svec(2,jvec,ivec)*temp(indvec)
                                      derv3(isxyzl(3),kk) = derv3(isxyzl(3),kk) + svec(3,jvec,ivec)*temp(indvec)
!
                                      derv3(isxyzl(1),kk) = derv3(isxyzl(1),kk) + d2r2dsdx(ks,1,indvec)*e1d(indvec)
                                      derv3(isxyzl(2),kk) = derv3(isxyzl(2),kk) + d2r2dsdx(ks,2,indvec)*e1d(indvec)
                                      derv3(isxyzl(3),kk) = derv3(isxyzl(3),kk) + d2r2dsdx(ks,3,indvec)*e1d(indvec)
...
!
  ...
  if (status/=0) call deallocate_error('sixnosd','zderv')
  deallocate(yderv,stat=status)
  if (status/=0) call deallocate_error('sixnosd','yderv')
  deallocate(xderv,stat=status)
  if (status/=0) call deallocate_error('sixnosd','xderv')
!
!  Timing
!
  time2 = g_cpu_time()
